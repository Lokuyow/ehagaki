...
import {
    mockAuthStoreModule,
    mockPostUIStoreModule,
    mockProfileStoreModule,
    mockRelayStoreModule,
...
// グローバルモックを設定
vi.mock('../stores/authStore.svelte', () => mockAuthStoreModule);
...
vi.mock('../stores/sharedContentStore.svelte', () => mockSharedContentStoreModule);
vi.mock('../stores/swStore.svelte', () => mockSwStoreModule);
vi.mock('../stores/profileStore.svelte', () => mockProfileStoreModule);
vi.mock('../stores/relayStore.svelte', () => mockRelayStoreModule);
vi.mock('../stores/postUIStore.svelte', () => mockPostUIStoreModule);
