...
const $ = 2, ke = 4, Pe = 8, bt = 1 << 24, z = 16, B = 32, K = 64, lt = 128, O = 512, k = 1024, x = 2048, V = 4096, N = 8192, q = 16384, ie = 32768, Ot = 1 << 25, Ie = 65536, Ke = 1 << 17, Wr = 1 << 18, pe = 1 << 19, Vt = 1 << 20, Mo = 1 << 25, de = 65536, Xe = 1 << 21, we = 1 << 22, re = 1 << 23, ce = Symbol("$state"), Ur = Symbol("legacy props"), Po = Symbol(""), Yr = Symbol("attributes"), Gr = Symbol("class"), Kr = Symbol("style"), ct = Symbol("text"), zo = Symbol("form reset"), et = new class extends Error {
...
const qo = 1, Bo = 2, Vo = 4, Wo = 8, Uo = 16, Yo = 1, Go = 4, Ko = 8, Xo = 16, ln = 1, cn = 2, Wt = "[", Ut = "[!", Nt = "[?", Yt = "]", Ee = {}, E = Symbol(), un = "http://www.w3.org/1999/xhtml", Zo = "http://www.w3.org/2000/svg", Jo = "http://www.w3.org/1998/Math/MathML", Qo = "@attach";
function fn() {
...
let it = null, ve = null, b = null, ut = null, L = null, ft = null, Oe = !1, st = !1, _e = null, Be = null;
var It = 0;
let kn = 1;
class X {
  id = kn++;
  ...
  #v() {
    ...
    if (b = null, o.length > 0) {
      var i = X.ensure();
      for (const a of o)
        i.schedule(a);
    }
    if (_e = null, Be = null, this.#y()) {
      this.#g(n), this.#g(r);
  ...
  #k(t, r, n) {
    ...
    for (var o = t.first; o !== null; ) {
      var i = o.f, s = (i & (B | K)) !== 0, l = s && (i & k) !== 0, a = l || (i & N) !== 0 || this.#f.has(o);
      if (!a && o.fn !== null) {
  ...
  #_(t) {
    ...
    for (const n of this.current.keys())
      r(n);
    this.oncommit(() => t.discard()), t.#w(), b = this, this.#v();
  }
  /**
   * @param {Effect[]} effects
   */
  ...
  flush() {
    try {
      ...
      It = 0, ft = null, _e = null, Be = null, st = !1, b = null, L = null, fe.clear();
    }
  }
  discard() {
        ...
        if (o.length === 0)
          ...
          if (a.length > 0)
            for (const f of this.#p)
              (f.f & (q | N | Ke)) === 0 && wt(f, a, s) && ((f.f & (we | z)) !== 0 ? (w(f, x), u.schedule(f)) : u.#d.add(f));
          if (u.#i.length > 0) {
            u.apply();
            for (var c of u.#i)
              u.#k(c, [], []);
   ...
   */
  schedule(t) {
    if (ft = t, t.b?.is_pending && (t.f & (ke | Pe | bt)) !== 0 && (t.f & ie) === 0) {
      t.b.defer_effect(t);
      return;
    }
  ...
  #m() {
    ve === null ? it = ve = this : (ve.#r = this, this.#t = ve), ve = this;
  }
  #w() {
    var t = this.#t, r = this.#r;
    t === null ? it = r : t.#r = r, r === null ? ve = t : r.#t = t, this.linked = !1;
  }
}
function tr(e) {
  var t = Oe;
  ...
  if (t !== 0) {
    for (var r = 0; r < t; ) {
      ...
      if ((n.f & (q | N)) === 0 && je(n) && (Y = /* @__PURE__ */ new Set(), Ae(n), n.deps === null && n.first === null && n.nodes === null && n.teardown === null && n.ac === null && mr(n), Y?.size > 0)) {
        fe.clear();
        for (const o of Y) {
          if ((o.f & (q | N)) !== 0) continue;
          const i = [o];
          let s = o.parent;
          for (; s !== null; )
            Y.has(s) && (Y.delete(s), i.push(s)), s = s.parent;
...
class Sn {
  ...
  #g(t) {
    var r = g, n = v, o = A;
    W(this.#s), M(this.#s), xe(this.#s.ctx);
    try {
      return X.ensure(), t();
    } catch (i) {
      return Jt(i), null;
  ...
  error(t) {
    if (!this.#r.onerror && !this.#r.failed)
      throw t;
    b?.is_fork ? (this.#a && b.skip_effect(this.#a), this.#n && b.skip_effect(this.#n), this.#o && b.skip_effect(this.#o), b.on_fork_commit(() => {
      this.#m(t);
    })) : this.#m(t);
  }
  /**
...
function Cn() {
  ...
  return function(i = !0) {
    W(e), M(t), xe(r), i && (e.f & q) === 0 && (n?.activate(), n?.apply());
  };
}
function Ze(e = !0) {
  W(null), M(null), xe(null), e && b?.deactivate();
}
function ir() {
  var e = (
    /** @type {Effect} */
...
function Rn(e, t, r) {
  ...
  return jn(() => {
    ...
    const h = (d, p = void 0) => {
      f?.(), l.delete(c), p !== Fe && (u.activate(), p ? (i.f |= re, Qe(i, p)) : ((i.f & re) !== 0 && (i.f ^= re), Qe(i, d)), u.deactivate());
    };
...
function sr(e) {
  var t = Et(e);
  if (!e.equals(t) && (e.wv = xr(), (!b?.is_fork || e.deps === null) && (b !== null ? (b.capture(e, t, !0), ut?.capture(e, t, !0)) : e.v = t, e.deps === null))) {
    w(e, k);
    return;
  }
  oe || (L !== null ? ($t() || b?.is_fork) && L.set(e, t) : mt(e));
}
function Nn(e) {
  if (e.effects !== null)
...
function ee(e, t, r = !1) {
  ...
  (!D || (v.f & Ke) !== 0) && Xt() && (v.f & ($ | z | we | Ke)) !== 0 && (I === null || !ye.call(I, e)) && sn();
  let n = r ? Te(t) : t;
  return Qe(e, n, Be);
}
  ...
  if (n !== null)
    for (var o = n.length, i = 0; i < o; i++) {
      ...
      if (a && w(s, t), (l & Ke) !== 0)
        ...
        (l & z) !== 0 && Y !== null && Y.add(u), r !== null ? r.push(u) : yt(u);
      }
    }
}
function Te(e) {
...
function P(e, t) {
  ...
  if (o !== null && (o.parent = r, r !== null && zn(o, r), v !== null && (v.f & $) !== 0 && (e & K) === 0)) {
    var i = (
      /** @type {Derived} */
      v
    );
...
function j(e, t = !0) {
  var r = !1;
  (t || (e.f & Wr) !== 0) && e.nodes !== null && e.nodes.end !== null && (qn(
    e.nodes.start,
    /** @type {TemplateNode} */
    e.nodes.end
...
function yr(e, t) {
  if ((e.f & N) !== 0) {
    ...
    for (var r = e.first; r !== null; ) {
      var n = r.next, o = (r.f & Ie) !== 0 || (r.f & B) !== 0;
      yr(r, o ? t : !1), r = n;
    }
...
function Ar(e) {
  var t = S, r = C, n = R, o = v, i = I, s = A, l = D, a = he, c = e.f;
  S = /** @type {null | Value[]} */
  null, C = 0, R = null, v = (c & (B | K)) === 0 ? e : null, I = null, xe(e.ctx), D = !1, he = ++le, e.ac !== null && (xt(() => {
    e.ac.abort(et);
  }), e.ac = null);
  try {
    e.f |= Xe;
    ...
    e.f ^= Xe, S = t, C = r, R = n, v = o, I = i, xe(s), D = l, he = a;
  }
}
function Wn(e, t) {
  let r = t.reactions;
...
function G(e) {
  ...
  if (r) {
    ...
    var a = (s.f & O) === 0 && !D && v !== null && (We || (v.f & O) !== 0), c = (s.f & ie) === 0;
...
function gt(e) {
  ...
  o[s] || e.target, i !== t) {
    ...
    try {
      ...
      e[Ce] = t, delete e.currentTarget, M(u), W(f);
    }
  }
}
const Jn = (
      ...
      for (var p = 0; p < d.length; p++) {
        ...
        if (!f.has(m)) {
          ...
          for (const ot of [t, document]) {
            var U = qe.get(ot);
            U === void 0 && (U = /* @__PURE__ */ new Map(), qe.set(ot, U));
            var ge = U.get(m);
            ge === void 0 ? (ot.addEventListener(m, gt, { passive: T }), U.set(m, 1)) : U.set(m, ge + 1);
          }
        }
      }
    };
    return h(jr(Cr)), pt.add(h), () => {
      for (var d of f)
        for (const T of [t, document]) {
          ...
          --m == 0 ? (T.removeEventListener(d, gt), p.delete(d), p.size === 0 && qe.delete(T)) : p.set(d, m);
        }
  ...
  constructor(t) {
    ...
    const o = new Proxy(
      { ...t.props || {}, $$events: {} },
      {
        ...
        has(i, s) {
          return s === Ur ? !0 : (G(r.get(s) ?? n(s, Reflect.get(i, s))), Reflect.has(i, s));
        },
        set(i, s, l) {
...
let Mr;
const so = "ehagaki.web-component.v1:", be = /* @__PURE__ */ new Map(), ao = {
  get length() {
    return be.size;
  },
  clear() {
...
class So extends HTMLElement {
  ...
  disconnectedCallback() {
    this.#l += 1, this.onDisconnected(), this.#i?.disconnect(), this.#i = null, Se === this && (Se = null), this.#t && (Nr(this.#t), this.#t = null), this.#e = null, this.#r = null, this.#n === "pending" && (this.#n = "rejected", this.#s?.(F("disconnected", "Component was disconnected before it became ready.")));
  }
  whenReady() {
    return this.#a;
  }
...
class Oo extends So {
  ...
  loadApp() {
    return import("./HostOwnedComposerLiteApp-DX3PHYHc.js").then((t) => t.H);
  }
  onConnectionAttempt() {
    this.#c = !0;
  }
