const St = "ehagaki-composer", Lo = 1, Tt = Symbol.for("ehagaki-composer.distribution");
function Pr(e, t) {
  ...
  r[Tt] = e;
  const o = customElements.get(St);
  if (!o) {
    customElements.define(St, t);
    return;
  }
  if (o !== t)
    ...
    e,
    {
      ...
      get(l, a, c) {
        ...
        if (u === void 0 && (!f || me(l, a)?.writable) && (u = s(() => {
          var d = Se(f ? l[a] : E), p = /* @__PURE__ */ Q(d);
          return p;
        }), r.set(a, u)), u !== void 0) {
          var h = Y(u);
          return h === E ? void 0 : h;
      ...
      has(l, a) {
        ...
        if (c !== void 0 || g !== null && (!u || me(l, a)?.writable)) {
          c === void 0 && (c = s(() => {
            var h = u ? Se(l[a]) : E, d = /* @__PURE__ */ Q(h);
            return d;
          }), r.set(a, c));
          var f = Y(c);
          if (f === E)
      ...
      set(l, a, c, u) {
        ...
        if (f === void 0)
          (!h || me(l, a)?.writable) && (f = s(() => /* @__PURE__ */ Q(void 0)), ee(f, Se(c)), r.set(a, f));
        else {
          h = f.v !== E;
          var m = s(() => Se(c));
          ee(f, m);
...
function Cr(e) {
  var t = C, r = T, n = M, o = b, i = O, s = A, l = j, a = he, c = e.f;
  C = /** @type {null | Value[]} */
  ...
  try {
    ...
    if (C !== null) {
      ...
      if (d || Le(e, T), h !== null && T > 0)
        for (h.length = T + C.length, p = 0; p < C.length; p++)
          h[T + p] = C[p];
      else
        e.deps = h = C;
      if ($t() && (e.f & R) !== 0)
    ...
    e.f ^= Xe, C = t, T = r, M = n, b = o, O = i, xe(s), j = l, he = a;
  }
}
function Kn(e, t) {
  let r = t.reactions;
...
function Y(e) {
  ...
  if (b !== null && !j) {
    ...
    if (!n && (O === null || !ye.call(O, e))) {
      var o = b.deps;
      if ((b.f & Xe) !== 0)
        e.rv < le && (e.rv = le, C === null && o !== null && o[T] === e ? T++ : C === null ? C = [e] : C.push(e));
      else {
        (b.deps ??= []).push(e);
        var i = e.reactions;
  ...
  if (r) {
    ...
    De(s) && (a && (s.f |= R), ar(s)), a && !c && (lr(s), Sr(s));
  }
  if (z?.has(e))
    return z.get(e);
  if ((e.f & re) !== 0)
...
`).some((l) => l.startsWith("https://svelte.dev/e/")))
      throw s;
    return s !== Ee && console.warn("Failed to hydrate: ", s), t.recover === !1 && rn(), ht(), Nn(r), He(!1), Ct(e, t);
  } finally {
    He(n), H(o);
  }
}
      ...
      for (var p = 0; p < d.length; p++) {
        ...
        if (!f.has(m)) {
          ...
          for (const ot of [t, document]) {
            ...
            var ge = W.get(m);
            ge === void 0 ? (ot.addEventListener(m, gt, { passive: S }), W.set(m, 1)) : W.set(m, ge + 1);
          }
        }
      }
    };
    return h(Dr(Mr)), pt.add(h), () => {
      for (var d of f)
        for (const S of [t, document]) {
          ...
          --m == 0 ? (S.removeEventListener(d, gt), p.delete(d), p.size === 0 && Fe.delete(S)) : p.set(d, m);
        }
...
class oo {
  ...
  constructor(t) {
    ...
    this.#t = (t.hydrate ? ro : Ct)(t.component, {
      target: t.target,
      anchor: t.anchor,
      props: o,
      context: t.context,
...
class Co extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.#n !== "pending" && (this.#i = this.createReadyPromise(), this.#n = "pending"), Ce = this, this.#o = this.mountApp();
  }
  disconnectedCallback() {
    this.#l += 1, this.#c = null, this.#s = !1, this.onDisconnected(), this.#f?.disconnect(), this.#f = null, Ce === this && (Ce = null), this.#t && (Or(this.#t), this.#t = null), this.#e = null, this.#o = null, this.#n === "pending" && (this.#n = "rejected", this.#r?.(B("disconnected", "Component was disconnected before it became ready.")));
  }
  whenReady() {
    return this.#i;
  }
...
${Ao()}`;
      ...
      if (!this.isConnected || t !== this.#l || (this.#t = Ct(a, {
        target: i,
        props: {
...
function To(e) {
  if (!So(e) || typeof e.submit != "function")
...
class Oo extends Co {
  ...
  loadApp() {
    return import("./HostOwnedComposerLiteApp-Ckd5UBLX.js").then((t) => t.H);
  }
  onConnectionAttempt() {
