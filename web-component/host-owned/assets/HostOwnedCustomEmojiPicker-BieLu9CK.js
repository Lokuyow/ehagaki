import { a as j, p as d, e as w, s as a, b as k, $ as y, c as S } from "./HostOwnedComposerLiteApp-D0xcGBao.js";
import { aX as B, b4 as q, b5 as h, _ as m, a as r, ap as C, a_ as u, a$ as E, b0 as g, b3 as b, aq as H, b1 as K } from "./host-owned-entry-BElPnyYu.js";
...
function z(l, i) {
  ...
  w(s, 21, n, (e) => e.identityKey, (e, o) => {
    ...
    }), C("click", t, () => c()(r(o))), u(e, t);
  }), h(s), m((e) => a(s, "aria-label", e), [() => v()("keyboardButtonBar.custom_emoji")]), u(l, s);
  var x = E($);
  return f(), x;
}
H(["click"]);
K(z, { items: {}, onSelect: {} }, [], [], { mode: "open" });
export {
  z as default
};
