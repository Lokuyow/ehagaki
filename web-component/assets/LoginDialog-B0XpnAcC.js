import { aD as mr, aE as Nt, aF as Cn, aG as Nn, aH as Cr, aI as Nr, aJ as wn, aK as wr, aL as pn, aM as kr, aN as Dr, I as d, aO as Z, K as V, aP as fn, aQ as Ke, aR as Oe, aS as wt, aT as kt, aU as Dt, H as kn, aV as Pr, N as Fe, aW as Lr, aX as Sr, aY as Tr, aZ as ve, a_ as Be, aB as qr, Q as Rr, a$ as hn, b0 as Er, b1 as $r, b2 as _n, V as Vr, $ as Ir, b3 as Ar, S as qe, W as Mr, b4 as jt, b5 as Kr, L as bn, M as yn, b6 as mt, b7 as Or, b8 as xn, b9 as Ur, ba as Ct } from "./App-2yO7FIhW.js";
import { aP as l, a as e, b as s, aQ as Q, aN as Re, aJ as Dn, b5 as Pt, a_ as et, a$ as ne, b0 as R, b1 as i, b2 as tt, b3 as c, b4 as nt, b6 as o, n as Lt, b7 as a, b8 as _, Z as D, bd as u, bf as Pe, bg as w, ap as Bt, bj as mn, aq as zr, bh as Ze } from "./entry-tn6az_XN.js";
import { b as Hr } from "./input-MkVV3LeH.js";
import { D as Wr, a as jr } from "./DialogWrapper-DqB9O7tX.js";
import { I as Br } from "./InfoPopoverButton-BT529VEw.js";
const ct = Dr({
  component: "tabs",
...
function Si(ee, t) {
  ...
  let en = l(f), qn = l(ue);
  const gt = new Tr();
  let Rn = l(() => gt.isValid), Tt = l(() => gt.npub), qt = l(() => gt.nprofile), tn = l(() => n()("clearInput") === "clearInput" ? "入力内容を消去" : n()("clearInput")), A = Q(null), $e = Q(""), ge = Q("qr"), Rt = Q(!1), pt = Q(null), xe = Q(Dn([""])), B = Q(null), Ge = Q(""), Ue = Q(""), pe = Q(""), ft = Q(!1), ht = Q(!1), Ve = Q(!1), ze, Et = Q(null);
  const En = 1200, $n = 6e3;
  function Qe() {
  ...
  Re(() => {
    if (b() && !e(Rt)) {
      s(Rt, !0), y(""), s($e, ""), s(Ge, ""), s(Ue, ""), s(pe, ""), s(ft, !1), In(), queueMicrotask(() => {
        !b() || e(ge) !== "qr" || nn();
      });
      return;
    }
  ...
  let He = l(() => Ar(e(xe))), _t = l(() => e(He).errorKey === null ? e(He).relays.join(`
`) : null), An = l(() => e(ge) === "qr" && e(He).errorKey ? n()(e(He).errorKey) : ""), Ie = l(re), We = l(p), $t = l(() => e(Ie) || ye()), Mn = l(() => e(Ie) || e(He).errorKey !== null || !e(_t) || !!P() && e(_t) === e(pt));
  Re(() => {
    e(We) && (s(Ve, !1), Qe());
  }), Re(() => {
    ...
    y() !== void 0 && e(A) && !y() && e(A).setCustomValidity("");
  });
  function Kn(r) {
  ...
  function Un() {
    y() && (y(""), e(A)?.setCustomValidity(""), e(A)?.focus({ preventScroll: !0 }));
  }
  function zn() {
    if (me(), e(A)) {
      const r = e(A).validity, J = e(A).value ?? "";
      if (r.valueMissing) {
        e(A).setCustomValidity(n()("loginDialog.secret_key_required")), e(A).reportValidity();
        return;
      }
      if (!J.startsWith("nsec1")) {
        e(A).setCustomValidity(n()("loginDialog.secret_must_start_nsec1")), e(A).reportValidity();
        return;
      }
      if (J.length !== 63) {
        J.length < 63 ? e(A).setCustomValidity(n()("loginDialog.secret_too_short")) : e(A).setCustomValidity(n()("loginDialog.secret_too_long")), e(A).reportValidity();
        return;
      }
      if (!e(Rn)) {
        e(A).setCustomValidity(n()("loginDialog.invalid_secret")), e(A).reportValidity();
        return;
      }
      e(A).setCustomValidity("");
    }
    j()?.();
  }
  function Hn(r) {
  ...
  let rr = l(() => Ee() ? jn(Ee()) : ""), rn = l(() => e(ge) === "qr" ? e(rr) || e(An) : "");
  function ir(r) {
  ...
  }, an = Pi(), on = R(an);
  {
    var or = (r) => {
      ...
      {
        var Ce = (fe) => {
          var oe = ti(), se = o(oe), Ae = o(se, !0);
          a(se), a(oe), D(() => w(Ae, e(Tt))), i(fe, oe);
        };
        V(K, (fe) => {
          e(Tt) && fe(Ce);
        });
      ...
      {
        var Ye = (fe) => {
          var oe = ni(), se = o(oe), Ae = o(se, !0);
          a(se), a(oe), D(() => w(Ae, e(qt))), i(fe, oe);
        };
        V(je, (fe) => {
          e(qt) && fe(Ye);
        });
  ...
  var sn = u(on, 2);
  {
    ...
    Wr(sn, {
      ...
      children: (Ce, je) => {
          ...
          var oe = (O) => {
            var U = oi(), F = R(U), Ne = o(F);
            {
              ...
              ve(Ne, {
                ...
                shape: "square",
                get className() {
                  return `parent-client-login-button u-control ${e(I) ?? ""}`;
                },
                onClick: Gn,
                get disabled() {
                  return N();
                ...
                children: (z, T) => {
                  ...
                  {
                    var be = (k) => {
                      qe(k, { text: !0, showLoader: !0 });
                    }, Le = (k) => {
                      var H = ai(), W = u(R(H), 2), X = o(W, !0);
            ...
            a(we), a(_e), D(
              (I, z) => {
                yn(le, 1, `parent-client-feedback ${e(Ge) ? "error" : "info"}`, "svelte-1vy8d2x"), Fe(le, "role", e(Ge) ? "alert" : "status"), w(he, I), w(ie, z);
              },
              [
        ...
        var se = u(fe, 2), Ae = o(se);
        {
          ...
          ve(Ae, {
            ...
            children: (F, Ne) => {
              ...
              {
                var _e = (ie) => {
                  qe(ie, { text: !0, showLoader: !0 });
                }, we = (ie) => {
                  var I = si(), z = u(R(I), 2), T = o(z, !0);
                  a(z), D((q) => w(T, q), [() => n()("loginDialog.login_with_extension")]), i(ie, I);
                };
                V(he, (ie) => {
                  $() ? ie(_e) : ie(we, -1);
                });
        ...
        a(yt), a(bt);
        var At = u(bt, 2), ln = o(At);
        {
          let O = l(() => e(We) ? n()("loginDialog.nostrconnect_handshake_started") : e(Ve) ? n()("loginDialog.nostrconnect_opening_signer") : n()("loginDialog.nostrconnect_open")), U = l(() => e(Ie) || !P() || e(Ve) || e(We)), F = l(() => e(Ie) && !P() || e(Ve) || e(We) ? "loading" : "");
          ve(ln, {
            type: "button",
            variant: "primary",
            shape: "square",
            ...
            children: (Ne, le) => {
              var he = ne(), _e = R(he);
              {
                var we = (T) => {
                  {
                    let q = l(() => n()("loginDialog.nostrconnect_preparing"));
                    qe(T, {
                      get text() {
                        return e(q);
                      },
                  ...
                  {
                    let q = l(() => n()("loginDialog.nostrconnect_handshake_started"));
                    qe(T, {
                      get text() {
                        return e(q);
                      },
                  ...
                  {
                    let q = l(() => n()("loginDialog.nostrconnect_opening_signer"));
                    qe(T, {
                      get text() {
                        return e(q);
                      },
                  ...
                  var q = di(), de = u(R(q), 2), be = o(de, !0);
                  a(de), D((Le) => w(be, Le), [() => n()("loginDialog.remote_signer_title")]), i(T, q);
                };
                V(_e, (T) => {
                  e(Ie) && !P() ? T(we) : e(We) ? T(ie, 1) : e(Ve) ? T(I, 2) : T(z, -1);
                });
              }
              i(Ne, he);
            },
                      ...
                      children: (be, Le) => {
                        var k = bi(), H = R(k);
                        {
                          var W = (v) => {
                            ...
                            var h = ui(), S = o(h);
                            qe(S, { text: !0, showLoader: !0 }), a(h), i(v, h);
                          };
                          V(H, (v) => {
                            P() ? v(W) : e(Ie) && v(X, 1);
                          });
                        ...
                        var Kt = u(Je, 2);
                        {
                          let v = l(() => n()("common.copySuccess")), h = l(() => e(Ie) || !P()), S = l(() => e(ft) ? n()("loginDialog.nostrconnect_copied") : n()("loginDialog.nostrconnect_copy"));
                          ve(Kt, {
                            type: "button",
                            variant: "copy",
                            shape: "circle",
                        ...
                        var it = u(ce, 2), te = o(it);
                        {
                          ...
                          V(te, (v) => {
                            e(Ie) ? v(Se) : e(Ve) ? v(at, 1) : e(We) ? v(Xe, 2) : ye() ? v(Ot, 3) : v(Ut, -1);
                          });
                        }
                        a(it);
        ...
        {
          var gr = (O) => {
            var U = wi(), F = R(U), Ne = o(F), le = o(Ne, !0);
            a(Ne), a(F);
            var he = u(F, 2), _e = o(he), we = u(o(_e), 2), ie = o(we, !0);
            a(we), a(_e);
            var I = u(_e, 2), z = o(I), T = o(z), q = o(T);
            Ct(q), bn(q, (k) => s(A, k), () => e(A));
            var de = u(q, 2);
            {
              var be = (k) => {
                ve(k, {
            ...
            ), mn("submit", I, ir), Bt("input", q, () => e(A)?.setCustomValidity("")), Hr(q, y), i(O, U);
          };
          V(ur, (O) => {
            rt() && O(gr);
          });
