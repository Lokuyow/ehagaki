import { a$ as mr, b0 as Nt, b1 as Cn, b2 as Nn, b3 as Cr, b4 as Nr, b5 as kn, b6 as kr, b7 as pn, b8 as wr, b9 as Dr, a8 as d, ba as X, aa as V, bb as fn, bc as Oe, bd as Ke, be as kt, bf as wt, bg as Dt, a7 as wn, bh as Pr, ae as Fe, bi as Lr, bj as Sr, bk as qr, bl as ve, bm as Be, aZ as Tr, ac as Rr, bn as hn, bo as Er, bp as $r, bq as _n, aj as Vr, ak as Ar, br as Ir, ag as Te, bs as mt, al as Mr, bt as Wt, bu as Or, ab as bn, ad as yn, bv as Ct, bw as Kr, bx as xn, by as Ur } from "./App-1qWol-Cs.js";
import { aP as l, a as e, b as s, aQ as Q, aN as Re, aJ as Dn, b5 as Pt, a_ as et, a$ as ne, b0 as R, b1 as i, b2 as tt, b3 as c, b4 as nt, b6 as o, n as Lt, b7 as a, b8 as _, Z as D, bd as u, bg as Pe, bh as k, aq as zr, bf as Xe, ap as Bt, bj as mn } from "./entry-De5pG27L.js";
import { b as Hr } from "./input-C3JkTJyC.js";
import { D as jr, a as Wr } from "./DialogWrapper-DhZEVMtT.js";
import { I as Br } from "./InfoPopoverButton-BgGPXuZK.js";
const ct = Dr({
  component: "tabs",
...
function Ln(ee, t) {
  const n = Pt();
  et(t, !0);
  let x = d(t, "id", 23, () => Oe(n)), m = d(t, "ref", 15, null), b = d(t, "value", 15, ""), y = d(t, "onValueChange", 7, fn), E = d(t, "orientation", 7, "horizontal"), W = d(t, "loop", 7, !0), M = d(t, "activationMode", 7, "automatic"), Y = d(t, "disabled", 7, !1), C = d(t, "children", 7), L = d(t, "child", 7), ae = Dt(t, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
...
function Ft(ee, t) {
  const n = Pt();
  et(t, !0);
  let x = d(t, "children", 7), m = d(t, "child", 7), b = d(t, "id", 23, () => Oe(n)), y = d(t, "ref", 15, null), E = d(t, "value", 7), W = Dt(t, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
...
function Gt(ee, t) {
  const n = Pt();
  et(t, !0);
  let x = d(t, "child", 7), m = d(t, "children", 7), b = d(t, "disabled", 7, !1), y = d(t, "id", 23, () => Oe(n)), E = d(t, "type", 7, "button"), W = d(t, "value", 7), M = d(t, "ref", 15, null), Y = Dt(t, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
...
var Zr = _('<div class="qr-code-svg svelte-1pb586e" role="img"></div>'), Jr = _('<div class="qr-code-placeholder svelte-1pb586e" aria-hidden="true"></div>'), Xr = _('<div class="qr-code-frame"><!></div>');
const ei = {
  hash: "svelte-1pb586e",
...
`) : null), In = l(() => e(ge) === "qr" && e(He).errorKey ? n()(e(He).errorKey) : ""), Ae = l(re), je = l(p), $t = l(() => e(Ae) || ye()), Mn = l(() => e(Ae) || e(He).errorKey !== null || !e(_t) || !!P() && e(_t) === e(pt));
  Re(() => {
    e(je) && (s(Ve, !1), Qe());
  }), Re(() => {
  ...
  function zn() {
    if (me(), e(I)) {
      const r = e(I).validity, Z = e(I).value ?? "";
      if (r.valueMissing) {
        e(I).setCustomValidity(n()("loginDialog.secret_key_required")), e(I).reportValidity();
        return;
      }
      if (!Z.startsWith("nsec1")) {
        e(I).setCustomValidity(n()("loginDialog.secret_must_start_nsec1")), e(I).reportValidity();
        return;
      }
      if (Z.length !== 63) {
        Z.length < 63 ? e(I).setCustomValidity(n()("loginDialog.secret_too_short")) : e(I).setCustomValidity(n()("loginDialog.secret_too_long")), e(I).reportValidity();
        return;
      }
      if (!e(Rn)) {
  ...
  function tr() {
    ...
    Qe(), s(Et, r, !0), s(Ve, !0), Er(r), ze = setTimeout(
      () => {
        ...
        if (b() && e(ge) === "qr" && (re() || ye()) && !e(je) && P() === r && e(Et) === r) {
  ...
  let rr = l(() => Ee() ? Wn(Ee()) : ""), rn = l(() => e(ge) === "qr" ? e(rr) || e(In) : "");
  function ir(r) {
  ...
  var sn = u(on, 2);
  {
    ...
    let Z = l(() => ut() ? n()("loginDialog.add_account_title") : rt() ? n()("loginDialog.input_secret") : n()("common.login")), O = l(() => ut() ? n()("loginDialog.add_account_hint") : rt() ? n()("loginDialog.hint_input_secret") : n()("loginDialog.login_methods_hint"));
    jr(sn, {
      onOpenChange: (Ce) => !Ce && Xt(),
      get title() {
        return e(Z);
      },
      get description() {
      ...
      children: (Ce, We) => {
                ...
                children: (z, q) => {
                  var T = ne(), de = R(T);
                  {
                    var be = (w) => {
                      ...
                      var H = ai(), j = u(R(H), 2), J = o(j, !0);
                      a(j), D((ce) => k(J, ce), [() => n()("loginDialog.login_with_parent_client")]), i(w, H);
                    };
                    V(de, (w) => {
                      N() ? w(be) : w(Le, -1);
                    });
        ...
        {
          let K = l(() => e(je) ? n()("loginDialog.nostrconnect_handshake_started") : e(Ve) ? n()("loginDialog.nostrconnect_opening_signer") : n()("loginDialog.nostrconnect_open")), U = l(() => e(Ae) || !P() || e(Ve) || e(je)), F = l(() => e(Ae) && !P() || e(Ve) || e(je) ? "loading" : "");
          ve(ln, {
            type: "button",
            variant: "primary",
            shape: "square",
            ...
            children: (Ne, le) => {
              var he = ne(), _e = R(he);
              {
                ...
                V(_e, (q) => {
                  e(Ae) && !P() ? q(ke) : e(je) ? q(ie, 1) : e(Ve) ? q(A, 2) : q(z, -1);
                });
              }
              i(Ne, he);
            },
                    ...
                    Be(be, () => Gt, (w, H) => {
                      H(w, {
                        ...
                        children: (j, J) => {
                          Xe();
                          var ce = Pe();
                          D((Me) => k(ce, Me), [() => n()("loginDialog.nostrconnect_qr_tab")]), i(j, ce);
                        },
                        $$slots: { default: !0 }
                      });
                    });
                    ...
                    Be(Le, () => Gt, (w, H) => {
                      H(w, {
                        ...
                        children: (j, J) => {
                          Xe();
                          var ce = Pe();
                          D((Me) => k(ce, Me), [() => n()("loginDialog.nostrconnect_bunker_tab")]), i(j, ce);
                        },
                        $$slots: { default: !0 }
                      });
                    }), i(q, de);
                ...
                var ke = (A) => {
                    ...
                    de(T, {
                      ...
                      children: (be, Le) => {
                        ...
                        var it = u(ce, 2), te = o(it);
                        {
                          ...
                          V(te, (v) => {
                            e(Ae) ? v(Se) : e(Ve) ? v(at, 1) : e(je) ? v(Je, 2) : ye() ? v(Kt, 3) : v(Ut, -1);
                          });
                        }
                        a(it);
                        ...
                        Mr(zt, 21, () => e(xe), Or, (v, h, S) => {
                          ...
                          a(G), D(
                            (qe) => {
                              Wt(De, e(h)), Fe(De, "placeholder", qe);
                            },
                            [() => n()("loginDialog.nostrconnect_relay_placeholder")]
                          ), Bt("input", De, (qe) => Zn(S, qe.currentTarget.value)), i(v, G);
                        }), a(zt);
                  ...
                  Be(q, () => Ft, (T, de) => {
                    de(T, {
                      ...
                      children: (be, Le) => {
                        var w = mi(), H = o(w), j = o(H), J = o(j);
                        mt(J), bn(J, (te) => s(B, te), () => e(B));
                        var ce = u(J, 2);
                        {
                          var Me = (te) => {
                            ve(te, {
                        ...
                        a(w), D(() => {
                          Wt(J, e($e)), J.disabled = g();
                        }), mn("submit", w, (te) => {
                          te.preventDefault(), Qn();
                        }), Bt("input", J, On), i(be, w);
                      },
                      $$slots: { default: !0 }
                    });
                  }), i(A, z);
          ...
          var gr = (K) => {
            ...
            ve(Le, {
              ...
              children: (w, H) => {
                Xe();
                var j = Pe();
                D((J) => k(j, J), [() => n()("loginDialog.save")]), i(w, j);
              },
              $$slots: { default: !0 }
            }), a(z), a(A), a(he), D(
              (w, H, j) => {
                k(le, w), k(ie, H), Fe(T, "title", j);
              },
              [
                () => n()("common.or"),
  ...
  Tr(sr, {
    ...
    children: (r, Z) => {
      var O = Di(), Ce = o(O, !0);
      a(O), D((We) => k(Ce, We), [() => n()("loginDialog.nostrconnect_direct_open_hint")]), i(r, O);
    },
    $$slots: { default: !0 }
  }), i(ee, an);
  var lr = tt(ar);
