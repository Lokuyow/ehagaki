import { aD as sd, aE as mo, aG as Dp, aH as id, bd as od, aF as Hs, aM as Op, aK as za, aN as ad, K as mt, b1 as yo, I as Me, aO as qt, aP as lo, aQ as ds, aR as Br, aS as wo, aT as xo, aU as _o, aI as Np, be as Mp, aJ as Rp, bf as _c, H as Eo, aZ as Mt, Q as $o, N as br, V as is, $ as ko, R as Ec, W as Lr, M as Ha, b5 as Dr, b7 as Bp, a_ as Jt, bg as Rs, bh as xa, bi as _a, bj as Ea, ai as ld, bk as tr, a as rs, bl as cd, ba as os, L as Up, bm as dd, bn as Pp, bo as zp, bp as Hp, bq as qp, br as jp, bs as $c, bt as Fp, b6 as kc, aX as Zp, s as rt, bu as ro, bv as Dn, bw as Ac, bx as $a, by as Sc, bz as Vp, bA as Gp, bB as Wp, bC as Cc, bD as Kp, bE as Qp, S as Yp, bF as bi, b4 as mi, bG as Ic, bH as Xp, bI as Jp, bJ as eg, bK as tg, bL as Tc, bM as ng, bN as rg, bO as sg } from "./App-BnEIDDep.js";
import { aP as Ee, a as y, b as me, aQ as Rt, aN as On, a_ as rr, a$ as Bt, b0 as at, b1 as he, b2 as sr, b4 as ir, b5 as Ao, bd as se, b3 as Re, b8 as je, b6 as R, n as Di, b7 as N, Z as Ve, bg as ge, bf as Lt, bh as Ht, aJ as vr, aq as ud, ap as mr, aZ as ig, bj as Lc } from "./entry-YqIkvCgN.js";
import { D as og, a as ag } from "./DialogWrapper-BfJdLSbG.js";
import { I as Ir } from "./InfoPopoverButton-4yDDG91V.js";
import { H as hd } from "./hidden-input-C-0YZBFL.js";
import { b as lg, a as Dc } from "./input-DEkvKG8H.js";
...
function u1() {
    ...
    (function() {
      ...
      l.prototype = {
        ...
        for (var I = 0, Z = 0, X = 0, le = new Array(M.length), we = new Array(M.length), ae = 0; ae < M.length; ae++) {
          ...
          I += z;
          var Gt = _e.getErrorCorrectPolynomial(wt), qe = new f(le[ae], Gt.getLength() - 1), In = qe.mod(Gt);
          we[ae] = new Array(Gt.getLength() - 1);
          for (var et = 0; et < we[ae].length; et++) {
            var En = et + In.getLength() - we[ae].length;
            we[ae][et] = En >= 0 ? In.get(En) : 0;
          }
        }
      ...
      var Oe = [
        ...
        if (B._android && B._android <= 2.1) {
          ...
          CanvasRenderingContext2D.prototype.drawImage = function(le, we, ae, z, wt, et, Gt, qe, In) {
        ...
        return X.prototype.draw = function(le) {
          function we() {
            z.quietZone > 0 && z.quietZoneColor && (qe.lineWidth = 0, qe.fillStyle = z.quietZoneColor, qe.fillRect(0, 0, In._elCanvas.width, z.quietZone), qe.fillRect(0, z.quietZone, z.quietZone, In._elCanvas.height - 2 * z.quietZone), qe.fillRect(In._elCanvas.width - z.quietZone, z.quietZone, z.quietZone, In._elCanvas.height - 2 * z.quietZone), qe.fillRect(0, In._elCanvas.height - z.quietZone, In._elCanvas.width, z.quietZone));
          }
          function ae(Ar) {
            function Pn(er) {
              var dn = Math.round(z.width / 3.5), Ln = Math.round(z.height / 3.5);
              dn !== Ln && (dn = Ln), z.logoMaxWidth ? dn = Math.round(z.logoMaxWidth) : z.logoWidth && (dn = Math.round(z.logoWidth)), z.logoMaxHeight ? Ln = Math.round(z.logoMaxHeight) : z.logoHeight && (Ln = Math.round(z.logoHeight));
              var Kr, Qr;
              er.naturalWidth === void 0 ? (Kr = er.width, Qr = er.height) : (Kr = er.naturalWidth, Qr = er.naturalHeight), (z.logoMaxWidth || z.logoMaxHeight) && (z.logoMaxWidth && Kr <= dn && (dn = Kr), z.logoMaxHeight && Qr <= Ln && (Ln = Qr), Kr <= dn && Qr <= Ln && (dn = Kr, Ln = Qr));
              var ba = (z.width + 2 * z.quietZone - dn) / 2, ma = (z.height + z.titleHeight + 2 * z.quietZone - Ln) / 2, xc = Math.min(dn / Kr, Ln / Qr), ya = Kr * xc, wa = Qr * xc;
              (z.logoMaxWidth || z.logoMaxHeight) && (dn = ya, Ln = wa, ba = (z.width + 2 * z.quietZone - dn) / 2, ma = (z.height + z.titleHeight + 2 * z.quietZone - Ln) / 2), z.logoBackgroundTransparent || (qe.fillStyle = z.logoBackgroundColor, qe.fillRect(ba, ma, dn, Ln));
              var Tp = qe.imageSmoothingQuality, Lp = qe.imageSmoothingEnabled;
              qe.imageSmoothingEnabled = !0, qe.imageSmoothingQuality = "high", qe.drawImage(er, ba + (dn - ya) / 2, ma + (Ln - wa) / 2, ya, wa), qe.imageSmoothingEnabled = Lp, qe.imageSmoothingQuality = Tp, we(), Ms._bIsPainted = !0, Ms.makeImage();
            }
            z.onRenderingStart && z.onRenderingStart(z);
            for (var cn = 0; cn < wt; cn++) for (var Tn = 0; Tn < wt; Tn++) {
              var Wr = Tn * et + z.quietZone, ms = cn * Gt + z.quietZone, vi = Ar.isDark(cn, Tn), bn = Ar.getEye(cn, Tn), zt = z.dotScale;
              qe.lineWidth = 0;
              var Xt, mn;
              bn ? (Xt = z[bn.type] || z[bn.type.substring(0, 2)] || z.colorDark, mn = z.colorLight) : z.backgroundImage ? (mn = "rgba(0,0,0,0)", cn == 6 ? z.autoColor ? (Xt = z.timing_H || z.timing || z.autoColorDark, mn = z.autoColorLight) : Xt = z.timing_H || z.timing || z.colorDark : Tn == 6 ? z.autoColor ? (Xt = z.timing_V || z.timing || z.autoColorDark, mn = z.autoColorLight) : Xt = z.timing_V || z.timing || z.colorDark : z.autoColor ? (Xt = z.autoColorDark, mn = z.autoColorLight) : Xt = z.colorDark) : (Xt = cn == 6 ? z.timing_H || z.timing || z.colorDark : Tn == 6 && (z.timing_V || z.timing) || z.colorDark, mn = z.colorLight), qe.strokeStyle = vi ? Xt : mn, qe.fillStyle = vi ? Xt : mn, bn ? (zt = bn.type == "AO" ? z.dotScaleAO : bn.type == "AI" ? z.dotScaleAI : 1, z.backgroundImage && z.autoColor ? (Xt = (bn.type == "AO" ? z.AI : z.AO) || z.autoColorDark, mn = z.autoColorLight) : Xt = (bn.type == "AO" ? z.AI : z.AO) || Xt, vi = bn.isDark, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)) : cn == 6 ? (zt = z.dotScaleTiming_H, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)) : Tn == 6 ? (zt = z.dotScaleTiming_V, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)) : (z.backgroundImage, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)), z.dotScale == 1 || bn || (qe.strokeStyle = z.colorLight);
            }
          ...
          if (z.backgroundImage) {
            ...
            En.onload = function() {
              ...
              qe.imageSmoothingEnabled = !0, qe.imageSmoothingQuality = "high", qe.drawImage(En, 0, z.titleHeight, z.width + 2 * z.quietZone, z.height + 2 * z.quietZone - z.titleHeight), qe.imageSmoothingEnabled = Pn, qe.imageSmoothingQuality = Ar, qe.globalAlpha = 1, ae.call(In, le);
        ...
        return D.prototype.draw = function(M) {
          ...
          for (var Pn = 0; Pn < X; Pn++) {
            ...
            for (var cn = 0; cn < X; cn++) {
              var Tn = M.isDark(Pn, cn), Wr = M.getEye(Pn, cn);
              if (Wr) {
                Tn = Wr.isDark;
                var ms = Wr.type, vi = I[ms] || I[ms.substring(0, 2)] || Gt;
                ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + 'px;"><span style="width:' + le + "px;height:" + we + "px;background-color:" + (Tn ? vi : qe) + ';display:inline-block"></span></td>');
              } else {
                var bn = I.colorDark;
                Pn == 6 ? (bn = I.timing_H || I.timing || Gt, ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + "px;background-color:" + (Tn ? bn : qe) + ';"></td>')) : cn == 6 ? (bn = I.timing_V || I.timing || Gt, ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + "px;background-color:" + (Tn ? bn : qe) + ';"></td>')) : ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + 'px;"><div style="display:inline-block;width:' + wt + "px;height:" + et + "px;background-color:" + (Tn ? bn : I.colorLight) + ';"></div></td>');
              }
            }
            ae.push("</tr>");
          }
  ...
  function At(o, s, l = {}) {
    const { seed: u, m: f, d: p } = $n(o, s, l.extraEntropy), _ = new Be(U, L);
    _.reseedSync(u);
    let w;
  ...
  const zr = {
    ...
    join: Sn,
    padding: ps
  }, li = _n(Xn(4), Un("0123456789ABCDEF"), Sn("")), ci = _n(Xn(5), Un("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), ps(5), Sn(""));
  _n(Xn(5), Un("0123456789ABCDEFGHIJKLMNOPQRSTUV"), ps(5), Sn("")), _n(Xn(5), Un("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), Sn(""), Hi((o) => o.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1")));
  const Hr = _n(Xn(6), Un("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), ps(6), Sn("")), di = _n(Xn(6), Un("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), ps(6), Sn("")), ui = (o) => _n(Ts(58), Un(o), Sn("")), Ls = ui("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz");
  ...
  }, Zo = (o) => _n(ji(4, (s) => o(o(s))), Ls), hi = _n(Un("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), Sn("")), Zi = [
    996825010,
    642813549,
    513874426,
    1027748829,
  ...
  }, ut = _n(Xn(4), Un("0123456789abcdef"), Sn(""), Hi((o) => {
...
`);
  ...
  var cf = Object.defineProperty, Cn = (o, s) => {
  ...
  var P = se(L, 2);
  {
    ...
    Ir(P, {
      ...
      children: (V, Y) => {
        ...
        N(Dt), Ve(
          (Ot, $n, Ct, At, Yt, Nt, $t, an, kn, gn) => {
            ge(Ie, Ot), ge(Ce, $n), ge(We, Ct), ge(pe, At), ge(fn, `${Rs.high.maxWidthOrHeight}px`), ge(zn, `${Yt ?? ""}%`), ge(pn, Nt), ge(Be, `${Rs.medium.maxWidthOrHeight}px`), ge(lt, `${$t ?? ""}%`), ge(ht, an), ge(Et, `${Rs.low.maxWidthOrHeight}px`), ge(Qt, `${kn ?? ""}%`), ge(rn, gn);
          },
          [
...
function Nh(n, e) {
  ...
  const t = () => is(ko, "$_", r), [r, i] = $o(), a = (ve) => {
    ...
    N(Yt);
    var Hn = se(Yt, 2), Bn = R(Hn), An = R(Bn);
    os(An);
    var qn = se(An, 2), jn = R(qn, !0);
    N(qn), N(Bn);
    ...
    ), mr("change", Je, (nt) => re(nt.currentTarget.value)), mr("change", Ot, () => me(A, null)), Pp(Ot, () => y(v).protocol, (nt) => y(v).protocol = nt), mr("input", $t, () => me(A, null)), lg($t, () => y(v).serverUrl, (nt) => y(v).serverUrl = nt), Dc(An, () => y(v).enabled, (nt) => y(v).enabled = nt), Dc(ln, () => y(v).isDefault, (nt) => y(v).isDefault = nt), he(ve, Be);
  };
  ...
  var tn = se(ke, 2);
  {
    var nn = (ve) => {
      ...
      Lr(Ye, 17, () => y(L).destinations, Dr, (ht, Ue) => {
        var Et = q1(), Ut = at(Et), Qt = R(Ut), Dt = R(Qt), rn = R(Dt), Ot = R(rn), $n = R(Ot, !0);
        N(Ot);
        var Ct = se(Ot, 2);
        {
          var At = (He) => {
        ...
        N($t);
        var kn = se($t, 2), gn = R(kn), Qn = R(gn, !0);
        N(gn);
        var ar = se(gn, 2);
        {
          var Hn = (He) => {
        ...
        Ve(
          (He, ot) => {
            ge($n, y(Ue).name), ge(an, `${y(Ue).protocol ?? ""} / ${He ?? ""}`), ge(Qn, ot);
          },
          [
          ...
          var rn = se(Dt, 2);
          {
            ...
            Ir(rn, {
              ...
              children: (At, Yt) => {
                ...
                N($t);
                var kn = se($t, 2), gn = R(kn, !0);
                N(kn);
                var Qn = se(kn, 2), ar = R(Qn, !0);
                N(Qn), N(Nt), Ve(
                  (Hn, Bn, An) => {
                    ge(an, Hn), ge(gn, Bn), ge(ar, An);
                  },
                  [
...
function dm(n, e) {
  ...
  let j = Rt(vr(Dn.accentColor ?? $)), V = Rt(vr(Dn.baseColor ?? "")), Y = Rt(null), W = Rt(null), re = Rt(!rt.showMascot), de = Rt(!rt.showFlavorText), be = Ee(() => y(re) || y(de)), fe = Ee(() => Gp.value), Ie = Ee(() => Kp.value), $e = Ee(() => $a.value), Ce = Ee(() => Tc.value), Ge = Ee(() => r() === "installing"), We = Ee(i), ke = Ee(() => Jp.required), Ze = Ee(() => y(ke) || r() === "ready" && !y(We));
  On(() => {
  ...
  ld(() => {
    rt.reload(), me(J, rt.clientTagEnabled, !0), me(ie, rt.externalNostrClient, !0), me(te, rt.externalNostrClientCustomUrl, !0), me(F, rt.quoteNotificationEnabled, !0), me(O, rt.replyNotificationEnabled, !0), me(k, ro.value, !0), Dn.reload(), me(j, Dn.accentColor ?? $, !0), me(V, Dn.baseColor ?? "", !0), me(re, !rt.showMascot), me(de, !rt.showFlavorText), Vp(), rs.value?.pubkey && rs.value?.isAuthenticated && Sc(rs.value.pubkey);
  }), On(() => {
  ...
  function fn(ve, Be) {
    ...
    const Ye = bi(Be);
    Ye && (ve === "accent" ? (me(j, Dn.setAccentColor(Ye) ?? Be, !0), me(Y, null)) : (me(V, Dn.setBaseColor(Ye) ?? Be, !0), me(W, null)));
  }
  function Kt(ve) {
    const Be = ve === "accent" ? y(j) : y(V), Ye = ve === "accent" ? Dn.accentColor : Dn.baseColor, tt = ve === "base" && !Be && !Ye || bi(Be) ? null : t()("settingsDialog.invalid_hex_color");
    ve === "accent" ? me(Y, tt, !0) : me(W, tt, !0);
  }
  function zn(ve, Be) {
    const Ye = bi(Be);
    Ye && (ve === "accent" ? (me(j, Dn.setAccentColor(Ye) ?? Ye, !0), me(Y, null)) : (me(V, Dn.setBaseColor(Ye) ?? Ye, !0), me(W, null)));
  }
  function tn() {
    Dn.reset(), me(j, $), me(V, ""), me(Y, null), me(W, null);
  }
  var nn = {
    get show() {
      return g();
  ...
  };
  {
    ...
    og(n, {
      ...
      children: (lt, tt) => {
        ...
        var qn = se(An, 2), jn = R(qn), It = R(jn), ln = R(It, !0);
        N(It);
        var Fn = se(It, 2);
        Jt(Fn, () => co, (Le, Pe) => {
          Pe(Le, {
        ...
        var zi = se(ri, 2), cr = R(zi), _n = R(cr), Un = R(_n), Sn = R(Un), ps = R(Sn, !0);
        N(Sn);
        var Hi = se(Sn, 2);
        {
