...
function po(we, m) {
  ...
  let I = y(m, "show", 15, !1), re = y(m, "onClose", 7), le = y(m, "onLogout", 7), U = y(m, "fallbackRecoveryPubkeyHex", 7, ""), se = y(m, "onSwitchAccount", 7), ce = y(m, "onAddAccount", 7), ve = y(m, "onCheckNip46Connection", 7), T = y(m, "accounts", 23, () => []), de = y(m, "accountProfiles", 23, () => /* @__PURE__ */ new Map()), F = y(m, "isLoggingOut", 7, !1), O = y(m, "isSwitchingAccount", 7, !1), V = y(m, "nip46ConnectionOperationState", 7, "idle"), Y = y(m, "nip46ConnectionStatus", 7, "idle");
  function pe() {
    I(!1), re()?.();
  }
  wt(() => I(), pe, !0);
  let ye = r(() => Oe.value), ue = r(() => Lt.value), k = Ot(Rt(Oe.value)), ee = r(() => e(ue)?.pubkey || U() || ""), fe = r(() => e(k).npub || (e(ee) ? Je(e(ee)) : "")), Qe = r(() => e(k).displayName || e(k).name ? e(k).displayName || e(k).name : a()("profileDialog.profile_image_alt")), qe = r(() => a()("profileDialog.profile_image_fallback")), Te = r(() => T().length === 0 && !!e(ee));
  jt(() => {
    !F() && e(ye) && Mt(k, e(ye), !0);
  });
  function ke(t) {
  ...
  };
  {
    const t = (R) => {
      var ge = It(), W = ne(ge);
      {
        ...
        qt(W, () => Wt, (j, J) => {
          J(j, { child: X, $$slots: { child: !0 } });
        });
      }
      c(R, ge);
    };
    let S = r(() => a()("profileDialog.title")), Ee = r(() => a()("profileDialog.npub"));
    Vt(we, {
      onOpenChange: (R) => !R && pe(),
      get title() {
        return e(S);
      ...
      children: (R, ge) => {
        ...
        o(te), o(j);
        var oe = l(j, 2), ie = i(oe), ze = i(ie, !0);
        o(ie);
        var De = l(ie, 2), Ae = i(De);
        {
          var Ge = (u) => {
            var f = Et(), _ = i(f), D = i(_), A = i(D, !0);
            o(D);
            var M = l(D, 2);
            {
        ...
        var Ke = l(Ae, 2);
        {
          var Ue = (u) => {
            ...
            o(_), o(f), p(() => v(A, e(k).nprofile)), c(u, f);
          };
          H(Ke, (u) => {
            e(k).nprofile && u(Ue);
          });
          ...
          var Ye = (u) => {
            ...
            var w = l(A, 2);
            {
              ...
              Q(w, {
                ...
                children: ($, C) => {
                  var N = Ut(), Z = l(ne(N), 2), E = i(Z, !0);
                  o(Z), p((B) => v(E, B), [() => a()("profileDialog.recovery_logout_current")]), c($, N);
                },
                $$slots: { default: !0 }
              });
            }
        ...
        var et = l(Ne, 2);
        {
          var tt = (u) => {
            ...
            At(A, 21, T, (w) => w.pubkeyHex, (w, d) => {
              ...
              o(N), p(
                (n, s, z) => {
                  Z = Nt(N, 1, "account-item svelte-1qzltz2", null, Z, { active: e(h) }), B.disabled = e(h) || O(), v(ot, n), v(it, s), _e.disabled = F() || O(), Pt(_e, "aria-label", z);
                },
                [
              ...
              }), Me("click", _e, () => ke(e(d).pubkeyHex)), c(w, N);
            }), o(A);
            var M = l(A, 2);
            Q(M, {
              onClick: () => ce()?.(),
              ...
              children: (w, d) => {
                ...
                o($), p((N) => v(C, N), [() => a()("profileDialog.add_account")]), c(w, h);
              },
              $$slots: { default: !0 }
