import { I as o, dM as Xe, aU as j, K as ie, aV as G, aW as ae, aX as q, aY as ue, aZ as he, a_ as we, dN as et, dO as tt, dP as rt, c2 as nt, dQ as ot, dI as st, b6 as _e, dJ as it, dK as He, dR as at, H as Pe, b3 as z, c3 as Re, cC as je, cz as ze, cA as Le, cB as Ke, cD as lt, M as dt, Q as qe, aF as $e, N as ct, V as Ue, $ as Be, bY as ut, cx as pt, w as Je, i as vt, k as gt, a as ft, ag as ht, ah as mt, y as yt, z as bt, A as _t, P as Ve, x as wt, G as xt } from "./App-BBD-wmht.js";
import { b7 as ke, b0 as te, b1 as $, b2 as O, b3 as b, b4 as re, b5 as s, b6 as ne, a as x, b8 as T, n as ee, b9 as H, aR as K, ba as U, bl as We, bf as oe, bh as De, Z as pe, bi as ve, bj as Ie, aS as be, aJ as Fe, b as Q, aN as Ee, a$ as Ne, bk as Ae } from "./entry-BhDgNuDQ.js";
import { F as Ct } from "./floating-layer-anchor-DqH77l2m.js";
import { D as St, a as Pt } from "./DialogWrapper-EHZBMRpS.js";
var kt = U("<div><!></div>");
function Ot(l, e) {
  const t = ke();
  te(e, !0);
  let a = o(e, "child", 7), n = o(e, "children", 7), i = o(e, "ref", 15, null), p = o(e, "id", 23, () => ae(t)), h = o(e, "disabled", 7, !1), _ = o(e, "onSelect", 7, G), f = o(e, "closeOnSelect", 7, !0), w = we(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
...
function Ye(l, e) {
  te(e, !0);
  let t = o(e, "open", 15, !1), a = o(e, "dir", 7, "ltr"), n = o(e, "onOpenChange", 7, G), i = o(e, "onOpenChangeComplete", 7, G), p = o(e, "_internal_variant", 7, "dropdown-menu"), h = o(e, "_internal_should_skip_exit_animation", 7, void 0), _ = o(e, "children", 7);
  const f = tt.create({
    variant: j(() => p()),
    dir: j(() => a()),
  ...
  var w = {
    ...
    set onOpenChange(r = G) {
      n(r), s();
    },
    get onOpenChangeComplete() {
      return i();
    },
    set onOpenChangeComplete(r = G) {
      i(r), s();
    },
...
function Ze(l, e) {
  const t = ke();
  te(e, !0);
  let a = o(e, "id", 23, () => ae(t)), n = o(e, "child", 7), i = o(e, "children", 7), p = o(e, "ref", 15, null), h = o(e, "loop", 7, !0), _ = o(e, "onInteractOutside", 7, G), f = o(e, "onEscapeKeydown", 7, G), w = o(e, "onCloseAutoFocus", 7, G), r = o(e, "forceMount", 7, !1), v = o(e, "trapFocus", 7, !1), y = o(e, "style", 7), S = we(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
  ...
  var E = {
    ...
    set onInteractOutside(u = G) {
      _(u), s();
    },
    get onEscapeKeydown() {
      return f();
    },
    set onEscapeKeydown(u = G) {
      f(u), s();
    },
    get onCloseAutoFocus() {
      return w();
    },
    set onCloseAutoFocus(u = G) {
      w(u), s();
    },
    get forceMount() {
      return r();
...
var $t = U('<div class="more-icon svg-icon"></div>'), Dt = U("<!> <!>", 1), It = U('<div class="more-icon svg-icon"></div>'), At = U('<div class="post-history-menu-timestamp"> </div> <!>', 1), Tt = U('<div class="post-history-menu-body"><!> <!></div>'), Ht = U("<!> <!>", 1);
const Nt = {
  hash: "svelte-ea4c9b",
...
function Jt(l, e) {
  ...
  };
  {
        ...
        const c = (E, R) => {
          let N = () => R?.().props;
          {
            ...
            $e(E, _e(N, {
              ...
              children: (X, u) => {
                var g = qt();
                pe((C) => ct(g, "aria-label", C), [() => t()("global.close")]), b(X, g);
              },
              $$slots: { default: !0 }
            }));
          }
    ...
    let y = K(() => t()("postHistory.rawJsonTitle")), S = K(() => t()("postHistory.rawJsonDescription"));
    St(l, {
      onOpenChange: f,
      get title() {
        return x(y);
      ...
      footer: v,
      children: (d, m) => {
        var M = Ut(), c = O(M), E = T(c), R = T(E, !0);
        H(E), H(c);
        var N = oe(c, 2), W = T(N), X = T(W, !0);
        H(W), H(N), pe(
          (u) => {
            ve(R, u), ve(X, x(_));
          },
...
ne(Zt, { expanded: {}, controls: {}, onToggle: {} }, [], [], { mode: "open" });
function pr() {
...
function vr({ getShow: l, getPosts: e, getContainer: t, maxLines: a = 5 }) {
  ...
  function v(g) {
    const C = getComputedStyle(g), F = parseFloat(C.lineHeight);
    if (!F || Number.isNaN(F)) {
      const k = parseFloat(C.fontSize);
  ...
  function S(g) {
    const C = Object.keys(x(n)), F = Object.keys(g);
    C.length === F.length && C.every((k) => x(n)[k] === g[k]) || Q(n, g, !0);
  }
  function d() {
    if (!l()) {
      f.clear(), w = !1, S({});
    ...
    for (const P of g) {
      if (P.forceCollapsible)
        continue;
      if (!F && !C.has(P.eventId)) {
        const Y = x(n)[P.eventId];
        Y !== void 0 && (k[P.eventId] = Y);
        continue;
      }
      const D = p[P.eventId];
      if (!D)
...
`).length > a;
  ...
  function N() {
    S({}), Q(i, {}, !0), p = {}, _.clear(), f.clear(), w = !1, R();
  }
  function W(g) {
  ...
  return Ee(() => {
    ...
    if (!l())
      return;
    const g = e(), C = /* @__PURE__ */ new Map();
    for (const F of g) {
      const k = {
        content: F.content,
        forceCollapsible: F.forceCollapsible
      }, P = _.get(F.eventId);
      (P?.content !== k.content || P.forceCollapsible !== k.forceCollapsible) && f.add(F.eventId), C.set(F.eventId, k);
    }
    _ = C, m();
  }), Ee(() => {
    if (!(!l() || !t()))
...
function er(l, e) {
  return !e || l.pubkeyHex !== e || typeof l.deletedAt == "number" ? !1 : Gt.includes(l.kind) && typeof l.eventId == "string" && l.eventId.length > 0;
}
...
function rr(l, e) {
  return Ae.sanitizeExternalRelayUrls([
    ...l.acceptedRelays ?? [],
    ...l.fetchedRelays ?? [],
    ...l.relayHints ?? [],
...
class nr {
  ...
  async requestDeletion(e) {
    ...
    if (xt() && Ae.sanitizeExternalRelayUrls(
    ...
    if (t.type === "nip46")
      try {
        ...
        if (!i || !S.isAuthenticated || S.type !== "nip46" || S.pubkey !== a)
    ...
    try {
      n();
      const S = yt(h);
      _ = await p.signEvent(S.signerTemplate), n(), _ = bt(
        S.expectedTemplate,
        _,
        a
      ), n();
...
class ir {
  ...
  async broadcast(e) {
    ...
    const n = Ae.sanitizeExternalRelayUrls(
      this.deps.writeRelaysStore.value
    );
