import { I as l, aR as Y, dY as Rr, aP as I, K as se, aS as X, aT as Ge, aU as qe, aV as We, dZ as Hr, d_ as zr, aE as Or, aF as Zt, aN as Tr, aK as Ur, aG as Nr, aO as Dr, H as Fr, d$ as Ar, ai as Kr, e0 as Wt, a_ as $, L as Vr, Q as Br, e1 as Gr, e2 as wt, e3 as qr, e4 as Wr, e5 as Jr, e6 as Yr, e7 as Zr, b6 as q, S as Qr, W as xt, e8 as kt, N as R, e9 as jt, O as Ae, ea as we, eb as Xr, ec as Ke, V as eo, $ as to, ed as ro, ee as oo, ef as ao, eg as io, eh as so, ei as no, ej as lo } from "./App-CT56EfFO.js";
import { a9 as co, u as Qt, b7 as Je, b0 as xe, b1 as y, b2 as p, b3 as n, b4 as ke, b5 as d, a as e, b8 as T, n as at, b9 as M, b6 as je, aR as i, ba as w, b as C, aN as Ve, aS as ie, aJ as uo, Z as ve, ap as Jt, aQ as mo, bf as W, bh as vo, bi as Et, bD as $t, aq as ho, bj as go, bg as Ct } from "./entry-BmNX31GD.js";
import { b as fo } from "./input-DjMStXyJ.js";
class Mt {
  /** */
...
function Uo(S, t) {
  ...
  Kr(() => (C(F, Wt(v, Xe(), e(ge)), !0), ut(), window.addEventListener("resize", re), window.visualViewport?.addEventListener("resize", re), window.visualViewport?.addEventListener("scroll", re), () => {
    ...
    zt = b(), Ot = e(L), Tt = x(), o && (C(it, 0), st?.querySelector(".custom-emoji-scroll-viewport")?.scrollTo({ top: 0 }));
  }), Ve(() => {
  ...
  function wr(o) {
    ...
    const et = ($e) => {
      ...
      C(A, !1), window.removeEventListener("pointermove", et), window.removeEventListener("pointerup", Ee), window.removeEventListener("pointercancel", Ee);
    };
                                ...
                                var Ir = (Z) => {
                                  ...
                                  var ae = Mo(), ye = p(ae);
                                  {
                                    var He = (O) => {
                                          ...
                                          $(Fe, () => kt, (bt, _t) => {
                                            _t(bt, {
                                              ...
                                              children: (yt, Lr) => {
                                                ...
                                                }), $t("load", D, () => ct(e(E).src)), Ct(D), n(yt, D);
                                              },
                                              $$slots: { default: !0 }
                                            });
                                          });
                                      ...
                                      ), Yt(j, "clientHeight", (G) => C(nt, G)), n(O, j);
                                    }, ze = (O) => {
                                      var j = $o();
                                      Yt(j, "clientHeight", (Q) => C(nt, Q)), n(O, j);
                                    };
                                    se(ye, (O) => {
                                      e(Dt) ? O(He) : O(ze, -1);
                                    });
                                      ...
                                      $(Te, () => kt, (Ue, Ne) => {
                                        Ne(Ue, {
                                          ...
                                          children: (De, qt) => {
                                            ...
                                            }), $t("load", J, () => ct(e(j).src)), Ct(J), n(De, J);
                                          },
                                          $$slots: { default: !0 }
                                        });
                                      });
