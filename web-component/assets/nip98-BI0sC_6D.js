import { f0 as d, f1 as g, f2 as s, f3 as i, f4 as f } from "./App-qNXS1jWJ.js";
...
var c = new TextEncoder(), m = class {
  ...
  finalizeEvent(e, r) {
    const t = e;
    return t.pubkey = s(i.getPublicKey(r)), t.id = u(t), t.sig = s(i.sign(f(u(t)), r)), t[n] = !0, t;
  }
  verifyEvent(e) {
    ...
    try {
      ...
      if (r !== e.id)
        return e[n] = !1, !1;
      const t = i.verify(f(e.sig), f(r), f(e.pubkey));
      return e[n] = t, t;
    } catch {
      return e[n] = !1, !1;
    }
