  ...
  const Oe = Mr({
    ...
    uploadFiles: async (s) => {
        ...
        return null;
      {
        ...
        const { uploadFiles: h } = await import("./App-B15rbX3S.js").then((b) => b.eI);
        return await h(s);
      }
    }
  }), be = Zr({
