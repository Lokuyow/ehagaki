import { aE as _t, aF as ft, cf as Dt, aH as vt, dv as G, aJ as Ft, aI as Ht, dw as gt, aL as It, dx as Tt, dy as nt, dz as Nt, dA as xt, dB as ht, aP as h, aO as St, I as n, K as U, aQ as A, aR as X, dC as Et, b1 as pt, dD as kt, aU as j, aV as yt, aS as E, aT as q, dE as dt } from "./App-CT56EfFO.js";
import { aS as _, b as p, a as o, aR as g, b7 as mt, b0 as Ct, b1 as N, b2 as x, b3 as v, b4 as bt, b5 as s, b6 as wt, b8 as z, n as st, b9 as J, ba as at } from "./entry-BmNX31GD.js";
import { F as Vt } from "./floating-layer-anchor-CLxGowq9.js";
const it = St({
  component: "popover",
...
class ct {
  ...
  onpointerenter(t) {
    if (this.opts.disabled.current || !this.opts.openOnHover.current || G(t) || (p(this.#r, !0), this.#i(), this.root.cancelDelayedClose(), this.root.opts.open.current || this.root.hoverCooldown)) return;
  ...
  onpointerleave(t) {
    this.opts.disabled.current || this.opts.openOnHover.current && (G(t) || (p(this.#r, !1), this.#s(), this.root.hoverCooldown = !1));
  }
  onclick(t) {
...
class ut {
  ...
  onpointerenter(t) {
    G(t) || this.root.cancelDelayedClose();
  }
  onpointerleave(t) {
    G(t);
  }
...
function Wt(Y, t) {
  ...
  const c = ut.create({
    ...
    onEscapeKeydown: h(() => F()),
    customAnchor: h(() => O())
  }), V = g(() => j(r, c.props)), L = g(() => k() && c.shouldTrapFocus);
  function Q(e) {
    ...
    var K = (e) => {
      Et(e, pt(() => o(V), () => c.popperProps, {
        ...
        popper: ($, R) => {
          ...
          const M = g(() => j(tt(), { style: dt("popover") }, { style: S() }));
          var B = N(), et = x(B);
          {
            var ot = (u) => {
              var l = N(), d = x(l);
