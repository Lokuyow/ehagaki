import { R as Yn, cD as Zn, H as er, I as me, dq as tr, bT as nr, L as nn, K as x, aB as rr, al as ar, aC as or, Q as ir, a_ as tt, N as ft, aA as At, b1 as sr, V as rn, $ as lr, cq as St, b6 as an, M as on, ay as cr, cp as ur, bQ as sn, cr as dr, bc as Lt, ba as pr, S as vr, cA as fr, dG as gr, bB as hr, cF as ln } from "./App-BmKERuNr.js";
import { bL as mr, bN as yr, bk as rt, c0 as br, aO as Ot, b0 as _r, aS as w, aJ as xr, a as e, aN as cn, b as n, b2 as L, Z as T, b3 as s, b8 as v, b4 as wr, aR as a, b5 as ye, b1 as nt, bi as R, bf as l, ba as p, b6 as Cr, b9 as f, bj as Nt, bh as kr } from "./entry-COr0Xz6m.js";
import { b as Pr } from "./input-jxEk8QB_.js";
import { D as $r, a as Tr } from "./DialogWrapper-DHXofWjt.js";
import { u as Rr, c as Er, d as Ir, p as Hr, P as Ar, h as Sr, b as Lr, j as Dt, M as Mt, a as Nr, r as Dr, g as un, i as Mr } from "./postBroadcastService-BwryR9jo.js";
function pn(d) {
...
function dn(d = {}) {
  const u = d.replyQuoteService ?? new Yn(), r = d.channelCoordinator ?? Zn, E = d.verifyEventFn ?? ((m) => mr(m) && yr(m));
  function V(m) {
    ...
    return {
      promise: (async () => {
        ...
        let W = null, fe = null, J = null, y = !1;
        if (C.kind === 40 || C.kind === 42) {
          const X = C.kind === 42 ? br(C) : null, ie = C.kind === 40 ? C.id : X?.channelEventId ?? null;
          ...
          W = S.context, y = S.cache?.resolutionQuality === "verified-metadata", J = S.cache?.creatorPubkey ?? null, fe = {
            eventId: ie,
        ...
        if (m.profileService) {
          if (m.onPhase?.("profile-loading"), [h, o] = await Promise.all([
            ve,
            J && J !== C.pubkey ? m.profileService.fetchProfileRealtime(
              J,
              {
    ...
    if (E.type === "nevent") {
      ...
      return {
        ...
        pointer: {
          ...
          authorHint: V.author ?? null,
          kindHint: typeof V.kind == "number" ? V.kind : null
        }
      };
    }
...
function Ca(d, u) {
  _r(u, !0), er(d, wa);
  const r = () => rn(lr, "$_", V), E = () => rn(hr, "$locale", V), [V, m] = ir();
  let N = me(u, "show", 7), be = me(u, "onClose", 7), j = me(u, "onApply", 7), _e = me(u, "rxNostr", 7, void 0), q = me(u, "relayConfig", 7, null), C = me(u, "profileService", 7, void 0), oe = me(u, "resolver", 23, dn), ve = me(u, "pubkeyHex", 7, null), W = w(""), fe = w(null), J = w(null), y = w("empty"), h = w(null), o = w(null), X = w(null), ie = w(null), Le = w(0), U = 0, S, se = null, Ne = w(xr([])), xe = w(-1), De = w(!1), at = w(null);
  const Q = Rr();
  ...
  function Gt() {
    U += 1, kt(), n(W, ""), n(y, "empty"), n(h, null), n(o, null), n(X, null), n(ie, null), n(Le, 0), zt(), Ct.resetState(), n(Ne, [], !0), n(xe, -1), n(De, !1), n(at, null);
  }
  function wn() {
...
`)]), s($, D);
          ...
          var en = l(Zt, 2);
          {
            var Gn = (b) => {
              ...
              var Te = l($, 2);
              {
                var We = (k) => {
                  var Re = aa(), Je = v(Re, !0);
                  f(Re), T((he) => R(Je, he), [() => r()("postHistory.deleteFailed")]), s(k, Re);
                };
                x(Te, (k) => {
                  e(Y) === "failed" && e(o) && k(We);
                });
          ...
          f(le), T(
            (b, _, I) => {
              R(ce, b), R(Ve, _), ft(ue, "placeholder", I);
            },
            [
