import { R as Xn, cI as Zn, H as er, I as me, dv as tr, bY as nr, L as nn, K as x, aG as rr, am as ar, aH as or, Q as ir, b3 as tt, N as ft, aF as At, b6 as sr, V as rn, $ as lr, cv as St, bb as an, M as on, aD as cr, cu as ur, bV as sn, cw as dr, bh as Lt, bf as pr, S as vr, cF as fr, dL as gr, bG as hr, cK as ln } from "./App-BBD-wmht.js";
import { bL as mr, bN as yr, bk as rt, c0 as br, aO as Ot, b0 as _r, aS as w, aJ as xr, a as e, aN as cn, b as n, b2 as L, Z as T, b3 as s, b8 as v, b4 as wr, aR as a, b5 as ye, b1 as nt, bi as R, bf as l, ba as p, b6 as Cr, b9 as f, bj as Nt, bh as kr } from "./entry-BhDgNuDQ.js";
import { b as Pr } from "./input-C0desN7K.js";
import { D as $r, a as Tr } from "./DialogWrapper-EHZBMRpS.js";
import { u as Rr, c as Er, d as Ir, p as Hr, P as Ar, h as Sr, b as Lr, j as Dt, M as Mt, a as Nr, r as Dr, g as un, i as Mr } from "./postBroadcastService-DIkiYbbO.js";
function pn(d) {
...
function dn(d = {}) {
  const u = d.replyQuoteService ?? new Xn(), r = d.channelCoordinator ?? Zn, E = d.verifyEventFn ?? ((m) => mr(m) && yr(m));
  function z(m) {
    ...
    return {
      promise: (async () => {
        ...
        let W = null, fe = null, Y = null, y = !1;
        if (C.kind === 40 || C.kind === 42) {
          const J = C.kind === 42 ? br(C) : null, ie = C.kind === 40 ? C.id : J?.channelEventId ?? null;
          if (!ie || C.kind === 42 && J && Fr(J.issues)) {
            const se = await ve;
            return {
              status: "error",
          ...
          W = S.context, y = S.cache?.resolutionQuality === "verified-metadata", Y = S.cache?.creatorPubkey ?? null, fe = {
            eventId: ie,
        ...
        if (m.profileService) {
          if (m.onPhase?.("profile-loading"), [h, o] = await Promise.all([
            ve,
            Y && Y !== C.pubkey ? m.profileService.fetchProfileRealtime(
              Y,
              {
    ...
    if (E.type === "nevent") {
      ...
      return {
        ...
        pointer: {
          ...
          authorHint: z.author ?? null,
          kindHint: typeof z.kind == "number" ? z.kind : null
        }
      };
    }
...
function Ca(d, u) {
  _r(u, !0), er(d, wa);
  const r = () => rn(lr, "$_", z), E = () => rn(hr, "$locale", z), [z, m] = ir();
  let N = me(u, "show", 7), be = me(u, "onClose", 7), j = me(u, "onApply", 7), _e = me(u, "rxNostr", 7, void 0), q = me(u, "relayConfig", 7, null), C = me(u, "profileService", 7, void 0), oe = me(u, "resolver", 23, dn), ve = me(u, "pubkeyHex", 7, null), W = w(""), fe = w(null), Y = w(null), y = w("empty"), h = w(null), o = w(null), J = w(null), ie = w(null), Le = w(0), U = 0, S, se = null, Ne = w(xr([])), xe = w(-1), De = w(!1), at = w(null);
  const Q = Rr();
  let ot = w(!1), gt = w(null), qe = w(void 0), X = w(void 0), it = w(!1), Ft = w(0), Ut = w(0), Bt = w("postHistory.broadcastSent"), Qe, Ke = w(void 0), ht = a(() => e(o) ? Kr(e(o).event.kind, e(o).event.kind === 1 || !!e(o).channelQuery) : []), P = a(() => e(o)?.event ?? e(J)), vn = a(() => e(P) ? e(P).created_at * 1e3 : 0), Me = a(() => e(o) ? Pn(e(o)) : null), fn = a(() => e(Me) ? Dr(e(Me)) !== null : !1), gn = a(() => e(Me) ? un(e(Me), ve()) : !1), mt = a(() => e(o)?.authorProfile ?? e(ie)), hn = a(() => {
    const t = e(P)?.pubkey;
  ...
  let Fe = a(() => e(jt)[0]), bt = a(() => e(Fe) ? Ge.isPostExpanded(e(Fe)) : !1), qt = a(() => sn(e(bt) ? e(Oe) : e(yt).content)), st = a(() => e(P)?.kind === 40 ? St({ sourceContent: "", displayContent: "", tags: [], media: [] }) : St({
    sourceContent: e(Oe),
    tags: e(P)?.tags ?? []
    ...
    tags: e(P)?.tags ?? [],
    media: e(st).media
  })), yn = a(() => e(st).hasRenderableText), _t = a(() => !!e(Fe) && e(yn) && Ge.shouldCollapsePost(e(Fe))), xt = a(() => e(P) ? `composer-target-preview-content-${e(P).id}` : ""), Qt = a(() => {
  ...
  function Gt() {
    Q.reset(), n(ot, !1), n(gt, null), n(qe, void 0), n(X, void 0), Pt();
  }
  function Vt() {
    U += 1, kt(), n(W, ""), n(y, "empty"), n(h, null), n(o, null), n(J, null), n(ie, null), n(Le, 0), Gt(), Ct.resetState(), n(Ne, [], !0), n(xe, -1), n(De, !1), n(at, null);
  }
  function wn() {
  ...
  async function Cn(t, i) {
    ...
    if (!(U !== i || c.status === "cancelled")) {
      if (se = null, c.status === "resolved") {
        n(o, c.target, !0), n(J, null), n(ie, null), n(y, "ready"), n(h, null);
        return;
      }
      n(J, c.event ?? null, !0), n(ie, c.authorProfile ?? null, !0), n(y, "error"), n(h, c.reason, !0);
    }
  }
  function kn() {
    n(Le, e(Le) + 1);
  ...
  cn(() => {
    ...
    e(Le);
    const i = ++U;
    kt(), Gt(), n(o, null), n(J, null), n(ie, null), n(h, null), n(y, "parsing");
    const c = Qr(t);
    if (c.status === "empty") {
      n(y, "empty");
      return;
        ...
        var le = ya();
        {
          const tn = (b) => {
            ...
            var ee = l(Pe, 2);
            {
              var $e = ($) => {
                var D = Yr(), Te = v(D);
                f(D), T((We) => R(Te, `${We ?? ""}: ${e(Kt) ?? ""}`), [() => r()("composerTarget.creator")]), s($, D);
              };
              x(ee, ($) => {
                e(Kt) && $($e);
              });
            ...
            var Be = l(ee, 2);
            {
              var je = ($) => {
                var D = Jr(), Te = v(D, !0);
                f(D), T((We) => R(Te, We), [() => e(o).channelContext.channelRelays.join(`
`)]), s($, D);
              };
              x(Be, ($) => {
          ...
          f(we);
          var G = l(we, 2), ze = v(G, !0);
          f(G);
          var ge = l(G, 2), ue = v(ge);
          ...
          var Zt = l(ge, 2);
          {
            var Gn = (b) => {
              ...
              f(_), T(() => I = on(_, 1, "target-status svelte-19ui8fd", null, I, { error: e(y) === "error" })), s(b, _);
            };
            x(Zt, (b) => {
              e(wt) && b(Gn);
            });
          ...
          var en = l(Zt, 2);
          {
            var Vn = (b) => {
                  ...
                  var he = nt(), Ee = L(he);
                  {
                    var Je = (Ie) => {
                      ...
                      Sr(Xe, {
                        ...
                        onToggle: () => Ge.togglePostExpanded(e(Fe).eventId)
                      }), s(Ie, te);
                    };
                    x(Ee, (Ie) => {
                      e(Fe) && e(_t) && Ie(Je);
              ...
              var Te = l($, 2);
              {
                var We = (k) => {
                  var Re = aa(), Ye = v(Re, !0);
                  f(Re), T((he) => R(Ye, he), [() => r()("postHistory.deleteFailed")]), s(k, Re);
                };
                x(Te, (k) => {
                  e(X) === "failed" && e(o) && k(We);
                });
                  ...
                  var Ee = nt(), Je = L(Ee);
                  {
                    var Ie = (te) => {
                      const M = a(() => e(Me)), He = a(() => r()("common.showActions"));
                      {
                                ...
                                tt(re, () => Mt, (B, pe) => {
                                  pe(B, {
                                    ...
                                    children: (pt, It) => {
                                      ...
                                      f(vt), T((Jn) => R(Ht, Jn), [
                                        () => e(X) === "sending" ? r()("postHistory.deleteSending") : r()("postHistory.delete")
                                      ]), s(pt, et);
                                    },
                                    $$slots: { default: !0 }
                                  });
                        ...
                        let Ae = a(() => Q.isPostMenuOpen(e(M).eventId)), Se = a(() => fr(e(M).postedAt, E()));
                        Lr(te, {
                          get open() {
                            return e(Ae);
                          },
              ...
              f(_), nn(_, (k) => n(Y, k), () => e(Y)), T(
                (k) => {
                  ft(_, "aria-label", k), Z = on(I, 1, "target-preview-body svelte-19ui8fd", null, Z, {
          ...
          var zn = l(en, 2);
          {
            ...
            x(zn, (b) => {
              e(o) && e(o).event.kind !== 1 && e(o).event.kind !== 40 && e(o).event.kind !== 42 && b(Wn);
            });
          }
          f(le), T(
            (b, _, I) => {
              R(ce, b), R(ze, _), ft(ue, "placeholder", I);
            },
            [
  ...
  {
    const t = (we) => {
      var ce = ba(), G = v(ce), ze = v(G, !0);
      f(G);
      var ge = l(G, 2), ue = v(ge, !0);
      f(ge), f(ce), T(
        (lt, Ue) => {
          R(ze, lt), R(ue, Ue);
        },
    ...
    let i = a(() => r()("postHistory.deleteRequestTitle")), c = a(() => r()("postHistory.deleteRequestDescription")), g = a(() => e(X) === "sending" ? r()("postHistory.deleteSending") : r()("postHistory.deleteConfirm")), K = a(() => r()("postHistory.deleteCancel")), le = a(() => e(X) === "sending");
    rr(Jt, {
      get open() {
