import { a8 as l, b8 as Z, ey as Rr, b6 as I, aa as ie, b9 as ee, ba as Ge, bb as qe, bc as Je, ez as Hr, eA as zr, aX as Or, aY as Yt, b4 as Tr, b1 as Nr, aZ as Ur, b5 as Fr, a7 as Dr, eB as Ar, aG as Vr, eC as qt, bi as M, ab as Br, ac as Kr, eD as yt, eE as Gr, eF as qr, eG as Jr, eH as Wr, eI as Yr, br as G, eJ as Zr, ae as R, af as Ae, eK as Ve, aj as Qr, ak as Xr, eL as eo, eM as to, eN as ro, eO as oo, ag as ao, al as wt, eP as xt, eQ as kt, eR as we, eS as io, eT as so, eU as no } from "./App-B-vAJu8d.js";
import { a9 as lo, u as Zt, b5 as We, a_ as xe, a$ as y, b0 as p, b1 as n, b2 as ke, b3 as c, a as e, b6 as T, n as rt, b7 as P, b4 as je, aP as i, b8 as w, b as C, aN as Be, aQ as ae, aJ as co, Z as ve, ap as Jt, aO as uo, bd as q, aq as mo, bf as vo, bg as ho, bh as jt, bj as Et, be as $t } from "./entry-y-09yyZ0.js";
import { b as go } from "./input-BsTyw8KX.js";
class Mt {
  /** */
...
class Pt {
  ...
  #r = i(() => ({
    ...
    role: e(this.#t),
    tabindex: e(this.#e),
    "data-disabled": Ur(this.opts.disabled.current),
                          ...
                          B(V, {
                            ...
                            children: (Re, re) => {
                              var Kt = y(), Cr = p(Kt);
                              {
                                var Pr = (Q) => {
                                  ...
                                  var oe = Mo(), ye = p(oe);
                                  {
                                    var He = (z) => {
                                          ...
                                          M(De, () => xt, (pt, bt) => {
                                            bt(pt, {
                                              ...
                                              children: (_t, Lr) => {
                                                var F = xo();
                                                ve(() => {
                                                  R(F, "src", e($).src), R(F, "alt", `:${e($).shortcode}:`), R(F, "title", `:${e($).shortcode}:`);
                                                }), Et("load", F, () => ct(e($).src)), $t(F), n(_t, F);
                                              },
                                              $$slots: { default: !0 }
                                            });
                                          });
                                      ...
                                      var Ue = q(X, 2), Fe = T(Ue), Gt = T(Fe, !0);
                                      P(Fe);
                                      var Y = q(Fe, 2);
                                      wt(Y, 21, () => e(ir), (K) => K.identityKey, (K, $) => {
                                        ...
                                        (K, $, me, De) => {
                                          R(X, "aria-label", K), jt(ht, $), Ae(Ne, `grid-template-columns: repeat(${e(le)}, minmax(0, 1fr));`), R(Ue, "aria-label", me), jt(Gt, De), Ae(Y, `grid-template-columns: repeat(${e(le)}, minmax(0, 1fr));`);
                                        },
                                        [
                                      ...
                                      M(Te, () => xt, (Ne, Ue) => {
                                        Ue(Ne, {
                                          ...
                                          children: (Fe, Gt) => {
                                            ...
                                            }), Et("load", Y, () => ct(e(E).src)), $t(Y), n(Fe, Y);
                                          },
                                          $$slots: { default: !0 }
                                        });
                                      });
                                ...
                                ie(Cr, (Q) => {
                                  e(or) || !e(D) ? Q(Pr) : e(Ye).length === 0 && !e(Ut) ? Q(Ir, 1) : Q(Sr, -1);
                                });
                              }
                              n(Re, Kt);
                            },
