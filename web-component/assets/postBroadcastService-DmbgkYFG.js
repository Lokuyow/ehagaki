import { I as o, dG as Ye, aP as j, K as ie, aQ as X, aR as ae, aS as q, aT as ue, aU as he, aV as we, dH as et, dI as tt, dJ as rt, bZ as nt, dK as ot, dC as st, b1 as _e, dD as it, dE as He, dL as at, H as Pe, a_ as z, b_ as Re, cx as je, cu as ze, cv as Le, cw as Ke, cy as lt, M as dt, Q as qe, aA as $e, N as ct, V as Ue, $ as Je, bT as ut, cs as pt, w as Be, i as vt, k as gt, a as ft, ag as ht, ah as mt, y as yt, z as bt, A as _t, P as Ve, x as wt, G as xt } from "./App-7Fg7Mioa.js";
import { b7 as ke, b0 as te, b1 as $, b2 as O, b3 as b, b4 as re, b5 as s, b6 as ne, a as x, b8 as A, n as ee, b9 as H, aR as K, ba as U, bl as We, bf as oe, bh as De, Z as pe, bi as ve, bj as Ie, aS as be, aJ as Fe, b as G, aN as Ee, a$ as Ne, bk as Te } from "./entry-rRm6YwMC.js";
import { F as Ct } from "./floating-layer-anchor-B2Jq1-43.js";
import { D as St, a as Pt } from "./DialogWrapper-CvgmAkfr.js";
var kt = U("<div><!></div>");
function Ot(l, e) {
  const t = ke();
  te(e, !0);
...
ne(Ge, { ref: {}, id: {}, child: {}, children: {} }, [], [], { mode: "open" });
function Qe(l, e) {
  te(e, !0);
...
function Ze(l, e) {
  const t = ke();
  te(e, !0);
  let a = o(e, "id", 23, () => ae(t)), n = o(e, "child", 7), i = o(e, "children", 7), p = o(e, "ref", 15, null), h = o(e, "loop", 7, !0), _ = o(e, "onInteractOutside", 7, X), f = o(e, "onEscapeKeydown", 7, X), w = o(e, "onCloseAutoFocus", 7, X), r = o(e, "forceMount", 7, !1), v = o(e, "trapFocus", 7, !1), y = o(e, "style", 7), S = we(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
...
var $t = U('<div class="more-icon svg-icon"></div>'), Dt = U("<!> <!>", 1), It = U('<div class="more-icon svg-icon"></div>'), Tt = U('<div class="post-history-menu-timestamp"> </div> <!>', 1), At = U('<div class="post-history-menu-body"><!> <!></div>'), Ht = U("<!> <!>", 1);
const Nt = {
  hash: "svelte-ea4c9b",
        ...
        const c = (E, R) => {
          let N = () => R?.().props;
          {
            ...
            $e(E, _e(N, {
              ...
              children: (Y, u) => {
                var g = qt();
                pe((C) => ct(g, "aria-label", C), [() => t()("global.close")]), b(Y, g);
              },
              $$slots: { default: !0 }
            }));
          }
...
ne(Bt, { open: {}, rawEvent: {}, onOpenChange: {} }, [], [], { mode: "open" });
var Vt = U("<!> <!>", 1);
function Wt(l, e) {
  te(e, !0);
...
var Gt = U('<div class="post-preview-toggle-row svelte-1yd56n0"><!></div>');
const Qt = {
  hash: "svelte-1yd56n0",
...
function pr() {
  ...
  function i() {
    Object.keys(x(l)).length > 0 && G(l, {}, !0);
  }
  function p(v) {
    G(e, v, !0), v || G(t, null);
  }
...
function vr({ getShow: l, getPosts: e, getContainer: t, maxLines: a = 5 }) {
  ...
  function S(g) {
    ...
    C.length === F.length && C.every((k) => x(n)[k] === g[k]) || G(n, g, !0);
  }
  function d() {
    if (!l()) {
      f.clear(), w = !1, S({});
    ...
    for (const P of g) {
      ...
      if (!F && !C.has(P.eventId)) {
        const Q = x(n)[P.eventId];
        Q !== void 0 && (k[P.eventId] = Q);
        continue;
      }
      const D = p[P.eventId];
      if (!D)
        continue;
      const J = v(D) * a, B = D.scrollHeight > 0;
      k[P.eventId] = B ? D.scrollHeight > J + 0.5 : P.content.split(`
`).length > a;
    }
    S(k);
  }
  ...
  function N() {
    S({}), G(i, {}, !0), p = {}, _.clear(), f.clear(), w = !1, R();
  }
  function W(g) {
...
function rr(l, e) {
  return Te.sanitizeExternalRelayUrls([
    ...l.acceptedRelays ?? [],
    ...l.fetchedRelays ?? [],
    ...l.relayHints ?? [],
...
class nr {
  ...
  constructor(e = {}) {
    this.deps = {
      ...
      writeRelaysStore: e.writeRelaysStore ?? Be,
  ...
  async requestDeletion(e) {
    ...
    if (xt() && Te.sanitizeExternalRelayUrls(
...
class ir {
  ...
  async broadcast(e) {
    ...
    const n = Te.sanitizeExternalRelayUrls(
      this.deps.writeRelaysStore.value
    );
