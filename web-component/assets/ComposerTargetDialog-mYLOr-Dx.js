import { D as Yn, cJ as Zn, cu as er, dz as tr, R as rt, dQ as nr, bT as Ot, H as rr, I as me, dA as ar, bU as or, L as nn, K as x, aA as ir, al as sr, aB as lr, Q as cr, a_ as tt, N as ft, aZ as At, b1 as ur, V as rn, $ as dr, cr as St, b6 as an, M as on, ay as pr, cq as vr, bQ as sn, cs as fr, bc as Lt, ba as gr, S as hr, cG as mr, dR as yr, bB as br, cL as ln } from "./App-B15rbX3S.js";
import { a_ as _r, aQ as w, aJ as xr, a as e, aN as cn, b as n, b0 as L, Z as T, b1 as s, b6 as v, b2 as wr, aP as a, b3 as ye, a$ as nt, bg as R, bd as l, b8 as p, b4 as Cr, b7 as f, bh as Nt, bf as kr } from "./entry-B_zlOICe.js";
import { b as Pr } from "./input-C5iYt6rQ.js";
import { D as $r, a as Tr } from "./DialogWrapper-aQdoiq6H.js";
import { u as Rr, c as Er, d as Ir, p as Hr, P as Ar, h as Sr, b as Lr, j as Dt, M as Mt, a as Nr, r as Dr, g as un, i as Mr } from "./postBroadcastService-B5Q98PZQ.js";
function pn(d) {
...
function Ca(d, u) {
  _r(u, !0), rr(d, wa);
  const r = () => rn(dr, "$_", V), E = () => rn(br, "$locale", V), [V, m] = cr();
  let N = me(u, "show", 7), be = me(u, "onClose", 7), j = me(u, "onApply", 7), _e = me(u, "rxNostr", 7, void 0), q = me(u, "relayConfig", 7, null), C = me(u, "profileService", 7, void 0), oe = me(u, "resolver", 23, dn), ve = me(u, "pubkeyHex", 7, null), J = w(""), fe = w(null), W = w(null), y = w("empty"), h = w(null), o = w(null), X = w(null), ie = w(null), Le = w(0), U = 0, S, se = null, Ne = w(xr([])), xe = w(-1), De = w(!1), at = w(null);
  const Q = Rr();
  ...
  function Gt() {
    U += 1, kt(), n(J, ""), n(y, "empty"), n(h, null), n(o, null), n(X, null), n(ie, null), n(Le, 0), zt(), Ct.resetState(), n(Ne, [], !0), n(xe, -1), n(De, !1), n(at, null);
  }
  function wn() {
        ...
        var le = ya();
        {
          const tn = (b) => {
            ...
            var ee = l(Pe, 2);
            {
              var $e = ($) => {
                var D = Wr(), Te = v(D);
                f(D), T((Je) => R(Te, `${Je ?? ""}: ${e(Kt) ?? ""}`), [() => r()("composerTarget.creator")]), s($, D);
              };
              x(ee, ($) => {
                e(Kt) && $($e);
              });
            ...
            var Be = l(ee, 2);
            {
              var je = ($) => {
                var D = Xr(), Te = v(D, !0);
                f(D), T((Je) => R(Te, Je), [() => e(o).channelContext.channelRelays.join(`
`)]), s($, D);
              };
              x(Be, ($) => {
