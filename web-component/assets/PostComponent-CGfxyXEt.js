import { a as mn, h as ut, m as ze, b as re, c as St, d as bt, k as vn, e as yn, s as wn, w as Sn, r as Et, f as bn, i as gt, j as En, l as Pn, n as xn, o as Fn, p as Cn, q as Pt, t as _n, u as qe, P as In, v as Mn, R as ht, x as De, y as kn, z as Tn, A as Dn, B as Ln, C as An, D as Ae, E as Rn, F as xt, G as Hn, H as Ue, I as q, J as On, K as se, L as Pe, M as Me, N as oe, O as Ft, Q as Ke, S as Wn, T as Nn, U as jn, V as Xe, $ as Qe, W as zn, X as J, Y as Ce, Z as pt, _ as qn, a0 as Bn, a1 as ft, a2 as Un, a3 as Kn, a4 as Ct, a5 as Xn, a6 as Qn, a7 as Gn, a8 as $n, a9 as He, aa as Yn, ab as Vn, ac as Zn, ad as Ee, ae as Jn, af as er, ag as tr, ah as nr, ai as rr, aj as mt, ak as Le, al as sr, am as ar, an as ir, ao as or, ap as lr, aq as cr, ar as dr, as as ur, at as gr, au as hr, av as pr, aw as fr, ax as mr, ay as vr, az as yr, aA as wr, aB as Sr, aC as br } from "./App-BnEIDDep.js";
import { aJ as Re, aq as _t, b4 as Ge, a_ as $e, a as e, bd as le, b as w, Z as we, bj as fe, ap as ye, b1 as ce, b2 as Ye, aQ as Q, b8 as ge, b6 as me, aP as x, b3 as B, be as Er, b7 as ue, aN as pe, a$ as Pr, b0 as It, bi as xr, u as _e, bg as vt } from "./entry-YqIkvCgN.js";
class Fr {
  constructor(t, r = {}) {
...
`)}`.trim());
    ...
    try {
      const y = this.deps.authStateStore, P = Rn(y), k = this.deps.hashtagStore, { hashtags: p, tags: C } = this.getHashtagArrays(k), N = this.deps.keyManager, T = this.deps.window || (typeof window < "u" ? window : void 0), G = this.deps.contentWarningStore.value, he = this.deps.contentWarningReasonStore.value, ee = this.deps.channelContextState?.value ?? null, Z = ee?.channelRelays, K = this.deps.replyQuoteState.value;
      let l;
      ...
      if (K.reply || K.quotes.length > 0) {
        ...
        K.quotes.forEach((U) => {
          E.buildQuoteTags(U, U.quoteNotificationEnabled).forEach((j) => {
            if (j[0] === "q") {
              if (D.has(j[1]))
                return;
              D.add(j[1]);
...
function Mt(n, t) {
  ...
  let a = q(t, "item", 7), c = q(t, "index", 7), d = q(t, "onDelete", 7), f = q(t, "onDragStart", 7), y = q(t, "onDragOver", 7), P = q(t, "onDragEnd", 7), k = q(t, "onDrop", 7), p = q(t, "onTouchDragStart", 7), C = q(t, "disabled", 7, !1), N = Q(void 0), T = Q(void 0);
  const G = jn();
  On(() => e(N), {
    onLongPress: (u, L) => {
      C() || p()?.(c(), u, L);
  ...
  ue(S), Pe(S, (u) => w(N, u), () => e(N)), we(() => {
    U = Me(S, 1, "gallery-item svelte-aw59wn", null, U, {
      ...
      "is-disabled": C()
    }), oe(S, "draggable", !C() && (a().type !== "video" || a().isPlaceholder)), Ft(j, e(ae)), oe(j, "role", a().type === "image" && !a().isPlaceholder ? "button" : void 0), oe(j, "tabindex", a().type === "image" && !a().isPlaceholder ? 0 : void 0), oe(j, "aria-label", a().alt || a().src);
  }), fe("dragstart", S, A), fe("dragover", S, V), fe("drop", S, te), fe("dragend", S, () => P()()), ye("click", j, function(...u) {
    (a().type === "image" && !a().isPlaceholder ? X : void 0)?.apply(this, u);
  }), ye("keydown", j, E), ce(n, S);
  var de = Ye(D);
  return o(), de;
}
...
function kt(n, t) {
  $e(t, !0), Ue(n, jr);
  const r = () => Xe(Qe, "$_", i), [i, o] = Ke();
  let a = Q(-1), c = Q(-1), d = Q(-1), f = Q(-1), y = null, P = 60, k = 60, p = Q(void 0), C = null, N = x(() => re.items), T = x(() => J.postStatus.sending), G = x(() => {
  ...
  function l(m) {
    ...
    if (g && g.length > 0) {
      ...
      m.clientX < M.left ? w(c, 0) : m.clientX > _.right && w(c, e(N).length, !0);
    }
    if (e(p)) {
  ...
  function A(m, g) {
    ...
    const M = e(p).getBoundingClientRect(), _ = m === "left" ? g - M.left : M.right - g, I = Math.max(0, Math.min(1, _ / Ce)), O = pt + (qn - pt) * (1 - I), z = () => {
      if (!e(p)) return;
      const de = e(p).scrollWidth - e(p).clientWidth;
      m === "left" && e(p).scrollLeft > 0 ? (e(p).scrollLeft = Math.max(0, e(p).scrollLeft - O), C = requestAnimationFrame(z)) : m === "right" && e(p).scrollLeft < de ? (e(p).scrollLeft = Math.min(de, e(p).scrollLeft + O), C = requestAnimationFrame(z)) : C = null;
    };
  ...
  function V(m, g, M) {
    ...
    const _ = e(p)?.querySelectorAll(".gallery-item-wrapper")[m];
    if (_) {
      const I = _.getBoundingClientRect(), O = 120, z = Math.min(O / I.width, O / I.height);
      P = I.width * z / 2, k = I.height * z / 2, y = _.cloneNode(!0), y.style.cssText = `
                position: fixed;
                left: ${g - P}px;
                top: ${M - k}px;
                width: ${I.width}px;
  ...
  function te(m) {
    ...
    if (_ && e(p)) {
      ...
      if (O !== -1) {
        ...
        w(f, g.clientX < z.left + z.width / 2 ? O : O + 1, !0);
      }
    } else if (e(p)) {
      const I = e(p).querySelectorAll(".gallery-item-wrapper");
      if (I.length > 0) {
        const O = I[0].getBoundingClientRect(), z = I[I.length - 1].getBoundingClientRect();
        g.clientX <= O.left ? w(f, 0) : g.clientX >= z.right && w(f, e(N).length, !0);
      }
    }
    if (e(p)) {
  ...
  var U = Pr(), j = It(U);
  {
    var ve = (m) => {
      ...
      zn(g, 23, () => e(N), (_) => _.id, (_, I, O) => {
        ...
        }), ue(z), we(() => de = Me(z, 1, "gallery-item-wrapper svelte-w2vv8k", null, de, {
          "insert-bar-left": e(G) === e(O),
          "insert-bar-right": e(G) === e(N).length && e(O) === e(N).length - 1
        })), ce(_, z);
...
function ms(n, t) {
  $e(t, !0), Ue(n, fs);
  const r = () => Xe(Qe, "$_", i), [i, o] = Ke();
  let a = q(t, "rxNostr", 7), c = q(t, "hasStoredKey", 7), d = q(t, "hasPostingCapability", 23, c), f = q(t, "isSwitchingAccount", 7, !1), y = q(t, "onPostSuccess", 7), P = q(t, "availableComposerHeight", 7, Ee), k = q(t, "minEditorHeight", 7, Ee), p = q(t, "onCustomEmojiSelect", 7), C = q(t, "notificationPort", 7), N = q(t, "hostOwnedConfig", 7), T = q(t, "hostCustomEmojiItems", 23, () => []), G = q(t, "normalUploadFiles", 7);
  const ee = !1;
  let Z = x(() => !ee), K = Q(null), l = Q(null), ae = Q(!1), X = Q(void 0), A = Q(void 0), H = Q(Re({})), V = Q(Re({})), te = x(() => ze.value), E = x(() => J.postStatus), D = x(() => J.uploadErrorMessage), S = x(() => br.value), U = x(() => gr.value), j = x(() => hr.value), ve = Q(!0), m = x(() => c() && !f() && e(U) && !e(j) && e(ve)), g = null, M = null, _ = null, I = null, O = Q(Re(Ee)), z = x(() => `--post-editor-min-height: ${k()}px; --post-editor-target-height: ${e(O)}px;`), de = x(() => r()("postComponent.enter_your_text") || "テキストを入力してください");
  pe(() => {
    e(l), Jn(e(de));
  }), pe(() => {
  ...
  const Oe = Mr({
    ...
    uploadFiles: async (s) => {
        ...
        return null;
      {
        ...
        const { uploadFiles: h } = await import("./App-BnEIDDep.js").then((b) => b.eI);
        return await h(s);
      }
    }
  }), be = Zr({
...
`).map((v) => ({
  ...
  we(
    (s) => {
      Ft(Fe, e(z)), at = Me(ne, 1, "editor-container svelte-15ticnd", null, at, {
        "drag-over": e(ae),
        "gallery-mode": !e(te),
        sending: e(E).sending,
