import { b$ as xs, c0 as as, c1 as kh, c2 as jc, c3 as gs, aJ as Kc, c4 as pi, c5 as gi, c6 as Lo, c7 as Fo, c8 as Yc, aI as zc, c9 as yi, ca as Qc, aH as eo, cb as Mi, cc as Fd, aO as Wc, aG as en, cd as Dh, aE as mi, ce as Jc, aF as fr, cf as _l, ai as Gc, aL as La, cg as El, I as _, aR as Kt, aP as Ee, K as be, aS as Mt, aT as Kr, aU as xr, aV as Ir, ch as Th, ci as Mh, cj as bi, ck as ul, cl as Zc, cm as hl, cn as Oh, b1 as no, aQ as la, co as Lh, a_ as Le, bZ as Fh, H as Ha, Q as Us, V as bs, $ as qs, cp as Xc, cq as fl, cr as vl, bc as eu, N as Tn, M as Ma, aA as ir, a4 as at, cs as ro, A as Hh, bT as ao, L as Ro, O as Ci, ct as $h, cu as Nh, cv as Bh, b_ as Xo, cw as Uh, cx as qh, cy as Vh, cz as jh, cA as ei, W as Pa, cB as Kh, cC as Yh, cD as zh, cE as Qh, b7 as Wh, cF as ai, cG as Jh, w as tu, cH as Al, cI as kl, cJ as Dl, cK as nu, cL as wi, cM as pl, cN as Gh, cO as Zh, cP as Zs, cQ as ti, cR as Xh, cS as ru, cT as Tl, cU as es, cV as ys, cW as Ml, cX as Ol, cY as ef, cZ as Hd, c_ as tf, c$ as au, d0 as $d, d1 as nf, d2 as Oi, d3 as Li, d4 as su, d5 as rf, d6 as af, d7 as sf, d8 as ou, d9 as of, da as lf, db as Fi, dc as df, dd as Ll, de as iu, df as lu, dg as du, bb as cf, dh as uf, di as Nd, dj as hf, dk as ff, dl as cu, dm as Pi, dn as Fl, dp as vf, aY as pf, dq as gf, aB as Bd, al as yf, aC as Hi, dr as Ud, bB as mf, S as Ls, ds as bf, dt as Cf, s as qd, ba as wf, ay as Pf } from "./App-7Fg7Mioa.js";
import { aN as Ke, u as ca, aR as I, a, b as p, aS as ye, aJ as lr, a_ as xf, b7 as Yr, b0 as Ot, b1 as Ae, b2 as Z, b3 as E, b4 as Lt, b5 as S, ba as j, b8 as T, n as Sr, bh as ss, Z as ge, bi as J, b9 as A, b6 as Ft, bf as L, aO as uu, bj as $s, bL as Hl, ap as ni, bD as _o, aq as hu, bl as fu, bS as vu, b_ as $l, bQ as ns, bO as xi, bk as Mn, bI as Nl, bY as Vd, bX as If, b$ as pu, a$ as da, bP as Sf, bN as Rf } from "./entry-rRm6YwMC.js";
import { b as _f } from "./input-BQ9rfxmY.js";
import { D as gu, a as yu } from "./DialogWrapper-CvgmAkfr.js";
import { M as Jn, a as ts, P as mu, b as gl, u as Ef, c as Af, d as kf, p as Df, e as jd, D as Kd, f as Yd, g as zd, h as Tf, r as Mf, i as Of, j as $i } from "./postBroadcastService-DmbgkYFG.js";
import { H as Lf } from "./hidden-input-Vm9ZlF8B.js";
import { P as Ff, b as Hf, a as $f } from "./popover-trigger-CHlF0qsa.js";
function Ni(t, e) {
...
function Pd(t, e) {
  ...
  let n = _(e, "event", 7), r = _(e, "profile", 7, null), o = _(e, "media", 7, void 0), s = _(e, "model", 7, void 0), l = _(e, "emojiLoadStateByUrl", 23, () => ({})), c = _(e, "emojiImageMetaByUrl", 23, () => ({})), u = _(e, "scrollRoot", 7, null), b = _(e, "onImageOpen", 7, void 0), g = _(e, "topActions", 7, void 0), y = _(e, "footerLeftExtras", 7, void 0), x = _(e, "footerActions", 7, void 0), f = _(e, "footerMenu", 7, void 0), R = I(() => {
    ...
    return ne || eu(uu.npubEncode(n().pubkey), 12, 4);
  }), w = I(() => s() ?? fl({
...
function wl(t) {
  return vu(t.rawEvent, t) ? $l(t.rawEvent) : {
    id: t.eventId,
    pubkey: t.pubkeyHex,
    kind: t.kind,
    content: t.content,
...
function Eo(t) {
  ...
  return xi(t.rawEvent) && t.rawEvent.id === e.id && t.rawEvent.pubkey === e.pubkey && t.rawEvent.kind === e.kind && t.rawEvent.content === e.content && t.rawEvent.created_at === e.created_at && JSON.stringify(t.rawEvent.tags) === JSON.stringify(e.tags) ? $l(t.rawEvent) : e;
}
function mo(t) {
  const e = ns(t.event);
  return {
...
class ey {
  ...
  fetchEventById(e, n) {
    const r = Al(), o = this.resolveRelayUrls(n.relayHints, n.relayConfig);
    let s = !1, l, c, u;
    const b = () => {
...
function ph(t) {
  ...
  for (const n of t.tags) {
    ...
    if (!Vd(r))
      continue;
    const o = oy(n[2]), s = Vd(n[3]) ? n[3] : null, l = e.get(r);
    if (!l) {
      e.set(r, {
        eventId: r,
        relayHint: o,
...
class $y {
  ...
  now;
  constructor(e = {}) {
    this.deletionFetchService = e.deletionFetchService ?? wi, this.deletionRequestsRepository = e.deletionRequestsRepository ?? ro, this.childInteractionsRepository = e.childInteractionsRepository ?? Tl, this.now = e.now ?? Date.now;
  }
...
class Wy {
  ...
  constructor(e = {}) {
    this.directReplySaveService = e.directReplySaveService ?? Ny, this.childInteractionsRepository = e.childInteractionsRepository ?? Tl, this.quoteVisibleRangeRepairExecutor = e.quoteVisibleRangeRepairExecutor, this.console = e.console ?? (typeof globalThis.console < "u" ? globalThis.console : { warn: () => {
    }, error: () => {
  ...
  fetchCandidates(e, n, r, o) {
    const s = this.resolveRelayUrls(n, r), l = n.map((i) => i.eventId), c = Al(), u = /* @__PURE__ */ new Map();
    let b = 0, g = !1, y, x, f;
    const R = () => {
...
const hi = {
  ...
  hasOlderLocal: !1,
  hasNewerLocal: !1
}, Io = im([...su]), yc = 1440 * 60, mc = 4320 * 60, hm = 100, fm = 720 * 60;
function ol(t, e) {
  if (t.length === 0)
    return !0;
...
function wm({
  ...
  function ja() {
    return typeof i.lastDialogOpenRefreshAt != "number" ? !0 : Date.now() - i.lastDialogOpenRefreshAt >= sf;
  }
  function ba(v, P) {
    if (!(fe || !t() || e() !== v || !n())) {
      if (fe = !0, P.length === 0) {
  ...
  return Ke(() => {
    ...
    if (!t() || !a($) || a(X) !== Xr(e()))
      return;
    const v = a(Ue);
    if (v.length === 0 || !Hd.canUsePersistentCache())
      return;
    const P = tf(v);
    if (P.length === 0)
      return;
    const k = [...P].sort().join("\0");
    k !== me && (me = k, Promise.resolve(Hd.prefetchCachedMediaDescriptors(P)).catch(() => {
    }));
  }), ao(() => {
...
class Mm {
  ...
  fetchDirectReplies(e, n) {
    const r = Al(), o = Tm(n), s = new Map(o.map((W) => [W.eventId, W])), l = o.map((W) => W.eventId), c = this.resolveRelayUrls(
      [
        ...n.relayHints ?? [],
  ...
  resolveRelayUrls(e, n, r) {
    const o = Number.isFinite(r) ? Math.max(1, Math.trunc(r ?? Pc)) : Pc, s = Dl(e, o);
    if (s)
      return s;
    const l = n ? [
      ...Mn.extractReadRelays(n),
...
function Nm(t) {
  if (!Ll(t.content))
    return;
  const e = iu(t.content);
  if (e)
    return lu(t.tags ?? []).get(e)?.url;
}
function Bm(t) {
  if (t.length === 0)
    return Sl;
...
function v0({
  ...
  getRelayConfig: r,
  postHistoryRepositoryImpl: o = at,
  directReplyRecordsAdapterImpl: s = uf,
  reactionRecordsAdapterImpl: l = du,
  childInteractionsRepositoryImpl: c = Tl,
    ...
    await Ec({
      ...
      run: async ({ ensureActive: le }) => {
        ...
        if (Be.length > 0 && (await Promise.all(Be.map((Ie) => c.deleteChildInteractionByEventId(Ie))), !le()))
          return;
        const er = Ye.size > 0 ? await nu.getProfiles(Array.from(Ye), { allowBackgroundRefresh: !1 }) : {};
        if (!le())
          return;
...
function p0({
  ...
  async function y(f) {
    ...
    if (f === "dialog-open-refresh") {
      const W = await Nd.get(R);
      if (typeof W?.lastDialogRefreshAt == "number" && Date.now() - W.lastDialogRefreshAt < hf)
        return;
    }
    g();
    const m = ++b;
    c.status = "syncing";
    const i = f === "dialog-open-refresh" ? ou.runInbound(w, {
      ownerPubkeyHex: R,
      relayConfig: r(),
      reason: f,
      reconcileDirectReplyCandidates: l
    ...
    m !== b || u !== i || !t() || e() !== R || (u = null, c.status = "idle", !(i.joinedExisting || O.status === "cancelled" || O.changedParentEventIds.length === 0) && (await s(O.changedParentEventIds), Ml({
...
function x0(t) {
  return t?.ruleVersion === Pi && (t.status === "valid" || t.status === "invalid");
}
function Ih(t) {
  return t?.status === "valid" && t.ruleVersion === Pi;
}
function Sh(t) {
  if (xi(t))
    try {
      return `nostr:${Fl(t)}\0${t.id}\0${t.sig}`;
    } catch {
    }
  try {
...
function I0(t) {
  ...
  try {
    const e = Sf(t);
    return Hl(e) && Fl(e) === e.id && Rf(e) ? { ...P0 } : { ...cl };
  } catch {
    return { ...cl };
  }
}
...
function E0(t, e, n) {
  return !Ih(t.rawEventVerification) || !Rh(e, 5) || e.pubkey !== n || t.targetAuthorPubkey !== n || t.deletionEventPubkey !== n || e.id !== t.deletionEventId ? !1 : cu(e).includes(t.targetEventId);
}
function A0() {
  return {
...
async function D0(t, e, n, r = {}) {
  ...
  for (const m of g)
    if (!(m.kind !== 1 && m.kind !== 42)) {
      if (!Ih(m.rawEventVerification) || !vu(m.rawEvent, m) || !Rh(m.rawEvent, m.kind)) {
...
function pC(t, e) {
  Ot(e, !0), Ha(t, vC);
  const n = () => bs(mf, "$locale", o), r = () => bs(qs, "$_", o), [o, s] = Us(), l = fu().overlayTarget, c = 18, u = 200;
  ...
  function $a() {
    X.reset(), ne.resetState(), it(), P(), fe.resetDeleteConfirmation(), p(M, !1), p(ue, !1), p(Fe, null), p(He, !1), p(xe, "none"), p(se, !1), p(G, ke(), !0), p(de, ke(), !0), p(Se, !1), p(te, !1), p(Ue, {}, !0), p(re, {}, !0), Ud(), p(yt, {}, !0), Dt.resetState(), p(Ze, [], !0), p(ot, -1), p(It, !1);
  }
  function Mr() {
    ce?.abort();
  }
  ...
  pf(() => b(), fa, !0), Ke(() => {
    ...
    const h = D.posts;
    !b() || h.length === 0 || (gf(h.map((B) => B.eventId)).catch(() => {
    }), ca(() => ae.loadCachedChildInteractionStateForPosts(h)));
  }), Ke(() => {
    const h = i()?.revision ?? 0, B = i()?.parentEventIds ?? [], Ce = D.posts;
    !b() || h <= 0 || B.length === 0 || (ca(() => ae.loadCachedChildInteractionStateForPosts(Ce, B)), Ml({
  ...
  function ls() {
    return {
      client: qd.externalNostrClient,
      customUrlTemplate: qd.externalNostrClientCustomUrl
    };
  }
  function ja() {
    const h = bf(ls());
      ...
      children: (Pe, Qe) => {
        ...
        var Qs = L(vn, 2);
        {
          var qo = (We) => {
            ...
            A(nr);
            var Bn = L(nr, 2);
            wf(Bn), Ro(Bn, (In) => p(Gn, In), () => a(Gn)), A(Et);
            var Br = L(Et, 2);
            {
