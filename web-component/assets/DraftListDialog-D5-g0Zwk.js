import { bP as ze, bQ as vt, bR as pt, bS as pe, bc as Re, H as ut, I as V, aX as gt, ai as ht, bT as mt, aZ as ee, K as ue, aB as yt, Q as bt, bU as xt, a_ as _t, b1 as qt, V as wt, N as Dt, X as Ae, $ as $t, bV as kt, W as Ee, bW as St, b5 as Ct, M as Pt, bX as Lt, bY as Tt } from "./App-DP7djUfw.js";
import { aO as Ht, b0 as Nt, aS as de, aJ as It, aN as At, b as d, b2 as te, bh as Me, Z as y, b3 as i, a as e, bf as x, aR as g, b4 as Et, b5 as B, bi as _, b8 as o, ba as v, ap as Mt, aq as Qt, b6 as jt, b9 as r, bj as Qe } from "./entry-Agq2pP_8.js";
import { D as zt, a as Rt } from "./DialogWrapper-CEARWe_P.js";
import { I as Vt } from "./InfoPopoverButton-EKGzX7VU.js";
function $e(t) {
  return t ? vt(t).trim() : "";
}
function ke(t) {
...
function ga(t, s) {
  ...
  let c = V(s, "show", 15, !1), C = V(s, "onClose", 7), b = V(s, "onApplyDraft", 7), W = V(s, "onSaveDraft", 7), ge = V(s, "subscribeToDraftSaveCompleted", 7), he = V(s, "canSaveDraft", 7), p = V(s, "pubkeyHex", 7, null), F = de(It([])), I = de("idle"), L = de("loading"), q = de(void 0), me = de(!1), ae, ne = 0, A = 0, M = !1;
  function Be() {
    return {
