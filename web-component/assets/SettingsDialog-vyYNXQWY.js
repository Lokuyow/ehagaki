import { aD as sd, aE as mo, aG as Dp, aH as id, bd as od, aF as Hs, aM as Op, aK as za, aN as ad, K as mt, b1 as yo, I as Me, aO as qt, aP as lo, aQ as ds, aR as Br, aS as wo, aT as xo, aU as _o, aI as Np, be as Mp, aJ as Rp, bf as _c, H as Eo, aZ as Mt, Q as $o, N as br, V as is, $ as ko, R as Ec, W as Lr, M as Ha, b5 as Dr, b7 as Bp, a_ as Jt, bg as Rs, bh as xa, bi as _a, bj as Ea, ai as ld, bk as tr, a as rs, bl as cd, ba as os, L as Up, bm as dd, bn as Pp, bo as zp, bp as Hp, bq as qp, br as jp, bs as $c, bt as Fp, b6 as kc, aX as Zp, s as rt, bu as ro, bv as $n, bw as Ac, bx as $a, by as Sc, bz as Vp, bA as Gp, bB as Wp, bC as Cc, bD as Kp, bE as Qp, S as Yp, bF as bi, b4 as mi, bG as Ic, bH as Xp, bI as Jp, bJ as eg, bK as tg, bL as Tc, bM as ng, bN as rg, bO as sg } from "./App-B15rbX3S.js";
import { aP as Ee, a as y, b as me, aQ as Rt, aN as On, a_ as rr, a$ as Bt, b0 as at, b1 as he, b2 as sr, b4 as ir, b5 as Ao, bd as se, b3 as Re, b8 as je, b6 as R, n as Di, b7 as N, Z as Ve, bg as ge, bf as Lt, bh as Ht, aJ as vr, aq as ud, ap as mr, aZ as ig, bj as Lc } from "./entry-B_zlOICe.js";
import { D as og, a as ag } from "./DialogWrapper-aQdoiq6H.js";
import { I as Ir } from "./InfoPopoverButton-BmnSv3Eu.js";
import { H as hd } from "./hidden-input-C27gJpqh.js";
import { b as lg, a as Dc } from "./input-C5iYt6rQ.js";
...
class sl {
  ...
  #s = Rt(-1);
  constructor(e, t) {
    this.opts = e, this.root = t, this.attachment = mo(this.opts.ref), this.opts.value.current === this.root.opts.value.current ? (this.root.rovingFocusGroup.setCurrentTabStopId(this.opts.id.current), me(this.#s, 0)) : this.root.opts.value.current || me(this.#s, 0), On(() => {
...
ir(fd, {}, [], [], { mode: "open" });
var cg = je("<div><!></div>"), dg = je("<!> <!>", 1);
function co(n, e) {
  const t = Ao();
  rr(e, !0);
  let r = Me(e, "disabled", 7, !1), i = Me(e, "children", 7), a = Me(e, "child", 7), c = Me(e, "value", 15, ""), d = Me(e, "ref", 15, null), h = Me(e, "orientation", 7, "vertical"), g = Me(e, "loop", 7, !0), b = Me(e, "name", 7, void 0), m = Me(e, "required", 7, !1), v = Me(e, "readonly", 7, !1), T = Me(e, "id", 23, () => ds(t)), A = Me(e, "onValueChange", 7, lo), E = _o(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
...
var ug = je("<button><!></button>");
function pd(n, e) {
  const t = Ao();
  rr(e, !0);
  let r = Me(e, "id", 23, () => ds(t)), i = Me(e, "children", 7), a = Me(e, "child", 7), c = Me(e, "value", 7), d = Me(e, "disabled", 7, !1), h = Me(e, "ref", 15, null), g = _o(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
  ...
  }, T = Bt(), A = at(T);
  {
    var E = (U) => {
      ...
      wo(P, () => ({ ...y(m) }));
      var J = R(P);
      Br(J, () => i() ?? Di, () => b.snippetProps), N(P), he(U, P);
    };
    mt(A, (U) => {
      a() ? U(E) : U(L, -1);
    });
...
ir(vd, {}, [], [], { mode: "open" });
var hg = je("<button><!></button>"), fg = je("<!> <!>", 1);
function ts(n, e) {
  const t = Ao();
  rr(e, !0);
  let r = Me(e, "child", 7), i = Me(e, "children", 7), a = Me(e, "ref", 15, null), c = Me(e, "id", 23, () => ds(t)), d = Me(e, "disabled", 7, !1), h = Me(e, "required", 7, !1), g = Me(e, "checked", 15, !1), b = Me(e, "value", 7, "on"), m = Me(e, "name", 7, void 0), v = Me(e, "type", 7, "button"), T = Me(e, "onCheckedChange", 7, lo), A = _o(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
  ...
  }, P = fg(), J = at(P);
  {
    var ie = (F) => {
      ...
      wo(O, () => ({ ...y(L) }));
      var k = R(O);
      Br(k, () => i() ?? Di, () => E.snippetProps), N(O), he(F, O);
    };
    mt(J, (F) => {
      r() ? F(ie) : F(te, -1);
    });
...
function ns(n, e) {
  const t = Ao();
  rr(e, !0);
  let r = Me(e, "child", 7), i = Me(e, "children", 7), a = Me(e, "ref", 15, null), c = Me(e, "id", 23, () => ds(t)), d = _o(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
  ...
  }, m = Bt(), v = at(m);
  {
    var T = (E) => {
      ...
      wo(L, () => ({ ...y(g) }));
      var U = R(L);
      Br(U, () => i() ?? Di, () => h.snippetProps), N(L), he(E, L);
    };
    mt(v, (E) => {
      r() ? E(T) : E(A, -1);
    });
...
ir(ns, { child: {}, children: {}, ref: {}, id: {} }, [], [], { mode: "open" });
var gg = { 203: (n, e) => {
  function t(k) {
  ...
  function h(k, $, S) {
    ...
    for (Y.forEach(((W) => {
      ...
      for (let de = j; de < Y.length; de++) {
        ...
        if (W = fe % S, Y[de] = Math.floor(fe / S), !Number.isSafeInteger(Y[de]) || Y[de] * S + W !== fe) throw new Error("convertRadix: carry overflow");
        re && (Y[de] ? re = !1 : j = de);
      }
  ...
  function ee(k) {
    ...
    function W(re, de = 90) {
      ...
      const Ie = re.slice(0, fe), $e = re.slice(fe + 1);
      if ($e.length < 6) throw new Error("Data must be at least 6 characters long");
      const Ce = P.decode($e).slice(0, -6), Ge = te(Ie, Ce, $);
      if (!$e.endsWith(Ge)) throw new Error(`Invalid checksum in ${re}: expected "${Ge}"`);
...
@keyframes spin {
  ...
  n.exports = { decode: function(te, ee) {
    ...
    for ($ = $.slice(7), F.push({ name: "timestamp", letters: S.slice(0, 7), value: be }), S = S.slice(7); $.length > 0; ) {
      const ke = $[0].toString();
      fe = L[ke] || "unknown_tag", Ie = U[ke] || P(ke), $ = $.slice(1), $e = J($.slice(0, 2)), $ = $.slice(2), Ce = $.slice(0, $e), $ = $.slice($e), F.push({ name: fe, tag: S[0], letters: S.slice(0, 3 + $e), value: Ie(Ce) }), S = S.slice(3 + $e);
    }
    ...
    let Ge = { paymentRequest: te, sections: F, get expiry() {
      let ke = F.find(((Ze) => Ze.name === "expiry"));
      if (ke) return We("timestamp") + ke.value;
    }, get route_hints() {
      return F.filter(((ke) => ke.name === "route_hint")).map(((ke) => ke.value));
    } };
    for (let ke in E) ke !== "route_hint" && Object.defineProperty(Ge, ke, { get: () => We(ke) });
    return Ge;
    function We(ke) {
      let Ze = F.find(((pt) => pt.name === ke));
      return Ze ? Ze.value : void 0;
    }
  }, hrpToMillisat: ie };
}, 0: (n, e, t) => {
  var r = t(540);
...
var $r = {};
wn.d($r, { vQ: () => Xe, ZM: () => Ii, yk: () => Ne, h0: () => _s, n_: () => Lh, Xz: () => c1, Uv: () => Ti, fU: () => Li, Dw: () => xr });
var ja = {};
wn.r(ja), wn.d(ja, { OG: () => fl, My: () => qs, Ph: () => Mn, lX: () => ul, Id: () => Es, fg: () => _d, qj: () => yn, aT: () => ki, lq: () => ls, z: () => hl, Q5: () => Ai });
var Fa = {};
wn.r(Fa), wn.d(Fa, { Relay: () => Du, SimplePool: () => Lv, finalizeEvent: () => or, fj: () => ku, generateSecretKey: () => du, getEventHash: () => _i, getFilterLimit: () => Ev, getPublicKey: () => $l, kinds: () => uu, matchFilter: () => Eu, matchFilters: () => $u, mergeFilters: () => _v, nip04: () => Mu, nip05: () => Uu, nip10: () => zu, nip11: () => Hu, nip13: () => qu, nip18: () => Zu, nip19: () => Ou, nip21: () => Gu, nip25: () => Wu, nip27: () => Ku, nip28: () => Qu, nip30: () => Yu, nip39: () => Ju, nip42: () => Cu, nip44: () => eh, nip47: () => ih, nip57: () => oh, nip59: () => ah, nip98: () => vh, parseReferences: () => zv, serializeEvent: () => cu, sortEvents: () => o0, utils: () => ou, validateEvent: () => Oo, verifiedSymbol: () => ss, verifyEvent: () => Ys });
var vg = wn(705);
function Nc(n) {
...
const ka = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0, md = (n) => n instanceof Uint8Array, Aa = (n) => new DataView(n.buffer, n.byteOffset, n.byteLength), pr = (n, e) => n << 32 - e | n >>> e;
...
class Eg extends wg {
  ...
  process(e, t) {
    ...
    for (let v = 16; v < 64; v++) {
      const T = Xr[v - 15], A = Xr[v - 2], E = pr(T, 7) ^ pr(T, 18) ^ T >>> 3, L = pr(A, 17) ^ pr(A, 19) ^ A >>> 10;
      Xr[v] = L + Xr[v - 7] + E + Xr[v - 16] | 0;
    }
    let { A: r, B: i, C: a, D: c, E: d, F: h, G: g, H: b } = this;
    for (let v = 0; v < 64; v++) {
      const T = b + (pr(d, 6) ^ pr(d, 11) ^ pr(d, 25)) + ((m = d) & h ^ ~m & g) + _g[v] + Xr[v] | 0, A = (pr(r, 2) ^ pr(r, 13) ^ pr(r, 22)) + xg(r, i, a) | 0;
...
function ul(n) {
  if (!So(n)) throw new Error("Uint8Array expected");
  return xd(qs(Uint8Array.from(n).reverse()));
}
function ls(n, e) {
  return ki(n.toString(16).padStart(2 * e, "0"));
}
function hl(n, e) {
  return ls(n, e).reverse();
}
function yn(n, e, t) {
  let r;
...
const on = BigInt(0), Wt = BigInt(1), ys = BigInt(2), Cg = BigInt(3), Ca = BigInt(4), Rc = BigInt(5), Bc = BigInt(8);
BigInt(9), BigInt(16);
function hn(n, e) {
  const t = n % e;
  return t >= on ? t : e + t;
...
function Ig(n, e, t) {
  if (t <= on || e < on) throw new Error("Expected power/modulo > 0");
  if (t === Wt) return on;
  let r = Wt;
  for (; e > on; ) e & Wt && (r = r * n % t), n = n * n % t, e >>= Wt;
  return r;
}
function Vn(n, e, t) {
  let r = n;
...
function Va(n, e) {
  if (n === on || e <= on) throw new Error(`invert: expected positive integers, got n=${n} mod=${e}`);
  let t = hn(n, e), r = e, i = on, a = Wt;
  for (; t !== on; ) {
...
function Tg(n) {
  ...
  return (function(e) {
    const t = (e - Wt) / ys;
    let r, i, a;
    for (r = e - Wt, i = 0; r % ys === on; r /= ys, i++) ;
    for (a = ys; a < e && Ig(a, t, e) !== e - Wt; a++) ;
    if (i === 1) {
      const d = (e + Wt) / Ca;
      return function(h, g) {
        const b = h.pow(g, d);
...
function Sd(n) {
  return Ai(n.Fp, Lg.reduce(((e, t) => (e[t] = "function", e)), { ORDER: "bigint", MASK: "bigint", BYTES: "isSafeInteger", BITS: "isSafeInteger" })), Ai(n, { n: "bigint", h: "bigint", Gx: "field", Gy: "field" }, { nBitLength: "isSafeInteger", nByteLength: "isSafeInteger" }), Object.freeze({ ...Ed(n.n, n.nBitLength), ...n, p: n.Fp.ORDER });
}
...
} }, Tr = BigInt(0), Gn = BigInt(1), Pc = (BigInt(2), BigInt(3));
BigInt(4);
function Mg(n) {
  const e = (function(A) {
    const E = Sd(A);
    Ai(E, { a: "field", b: "field" }, { allowedPrivateKeyLengths: "array", wrapPrivateKey: "boolean", isTorsionFree: "function", clearCofactor: "function", allowInfinityPoint: "boolean", fromBytes: "function", toBytes: "function" });
  ...
  function c(A) {
    return typeof A == "bigint" && Tr < A && A < e.n;
  }
  function d(A) {
  ...
  function h(A) {
    ...
    if (E && typeof A != "bigint") {
      if (A instanceof Uint8Array && (A = qs(A)), typeof A != "string" || !E.includes(A.length)) throw new Error("Invalid key");
      A = A.padStart(2 * L, "0");
    }
    let J;
    try {
      J = typeof A == "bigint" ? A : Mn(yn("private key", A, L));
    } catch {
      throw new Error(`private key must be ${L} bytes, hex or bigint, not ${typeof A}`);
    }
    return U && (J = hn(J, P)), d(J), J;
  }
  ...
  class m {
    ...
    multiplyAndAddUnsafe(E, L, U) {
      const P = m.BASE, J = (te, ee) => ee !== Tr && ee !== Gn && te.equals(P) ? te.multiply(ee) : te.multiplyUnsafe(ee), ie = J(this, L).add(J(E, U));
    ...
    clearCofactor() {
      ...
      return E === Gn ? this : L ? L(m, this) : this.multiplyUnsafe(e.h);
    }
    toRawBytes(E = !0) {
      return this.assertValidity(), r(m, this, E);
    }
    toHex(E = !0) {
      return qs(this.toRawBytes(E));
    }
  }
  ...
  const v = e.nBitLength, T = /* @__PURE__ */ (function(A, E) {
    ...
    return { constTimeNegate: L, unsafeLadder(P, J) {
      ...
      for (let j = 0; j < te; j++) {
        ...
        Y === 0 ? O = O.add(L(de, J[W])) : F = F.add(L(be, J[re]));
      }
      return { p: F, f: O };
...
function Rg(n) {
  const e = (function(k) {
    const $ = Sd(k);
    return Ai($, { hash: "hash", hmac: "function", randomBytes: "function" }, { bits2int: "function", bits2int_modN: "function", lowS: "boolean" }), Object.freeze({ lowS: !0, ...$ });
  ...
  const { ProjectivePoint: h, normPrivateKeyToScalar: g, weierstrassEquation: b, isWithinCurveOrder: m } = Mg({ ...e, toBytes(k, $, S) {
    ...
    {
      const Y = Mn(j);
      if (!(Tr < (V = Y) && V < t.ORDER)) throw new Error("Point is not on curve");
      const W = b(Y);
      let re = t.sqrt(W);
      return !(1 & ~S) != ((re & Gn) === Gn) && (re = t.neg(re)), { x: Y, y: re };
    }
    var V;
  } }), v = (k) => qs(ls(k, e.nByteLength));
  function T(k) {
    return k > r >> Gn;
  }
  const A = (k, $, S) => Mn(k.slice($, S));
  class E {
    constructor($, S, j) {
    ...
    recoverPublicKey($) {
      ...
      const re = 1 & V ? "03" : "02", de = h.fromHex(re + v(W)), be = d(W), fe = c(-Y * be), Ie = c(j * be), $e = h.BASE.multiplyAndAddUnsafe(de, fe, Ie);
  ...
  const L = { isValidPrivateKey(k) {
    ...
    return (function($, S, j = !1) {
      ...
      const re = hn(j ? Mn($) : ul($), S - Wt) + Wt;
      return j ? hl(re, Y) : ls(re, Y);
    })(e.randomBytes(k), e.n);
  ...
  const P = e.bits2int || function(k) {
    const $ = Mn(k), S = 8 * k.length - e.nBitLength;
    return S > 0 ? $ >> BigInt(S) : $;
  ...
  function te(k) {
    ...
    if (!(Tr <= k && k < ie)) throw new Error(`bigint expected < 2^${e.nBitLength}`);
    return ls(k, e.nByteLength);
  }
  function ee(k, $, S = F) {
    ...
    if (re != null) {
      ...
      fe.push(yn("extraEntropy", Ce));
    }
    const Ie = Es(...fe), $e = de;
    return { seed: Ie, k2sig: function(Ce) {
      const Ge = P(Ce);
      if (!m(Ge)) return;
      const We = d(Ge), ke = h.BASE.multiply(Ge).toAffine(), Ze = c(ke.x);
      if (Ze === Tr) return;
      const pt = c(We * c($e + Ze * be));
      if (pt === Tr) return;
      let pe = (ke.x === Ze ? 0 : 2) | Number(ke.y & Gn), it = pt;
      return Y && T(pt) && (it = (function(fn) {
        return T(fn) ? c(-fn) : fn;
      })(pt), pe ^= 1), new E(Ze, it, pe);
    } };
  }
  ...
  return h.BASE._setWindowSize(8), { CURVE: e, getPublicKey: function(k, $ = !0) {
    ...
    W && ($ = e.hash($));
    const { r: be, s: fe } = re, Ie = J($), $e = d(fe), Ce = c(Ie * $e), Ge = c(be * $e), We = h.BASE.multiplyAndAddUnsafe(de, Ce, Ge)?.toAffine();
    return !!We && c(We.x) === be;
...
function Id(n) {
  const e = Co, t = BigInt(3), r = BigInt(6), i = BigInt(11), a = BigInt(22), c = BigInt(23), d = BigInt(44), h = BigInt(88), g = n * n * n % e, b = g * g * n % e, m = Vn(b, t, e) * b % e, v = Vn(m, t, e) * b % e, T = Vn(v, fo, e) * g % e, A = Vn(T, i, e) * T % e, E = Vn(A, a, e) * A % e, L = Vn(E, d, e) * E % e, U = Vn(L, h, e) * L % e, P = Vn(U, d, e) * E % e, J = Vn(P, t, e) * b % e, ie = Vn(J, c, e) * A % e, te = Vn(ie, r, e) * g % e, ee = Vn(te, fo, e);
  if (!Ga.eql(Ga.sqr(ee), n)) throw new Error("Cannot find square root");
  return ee;
}
const Ga = (function(n, e, t = !1, r = {}) {
  if (n <= on) throw new Error(`Expected Field ORDER > 0, got ${n}`);
  const { nBitLength: i, nByteLength: a } = Ed(n, e);
  if (a > 2048) throw new Error("Field lengths over 2048 bytes are not supported");
  const c = Tg(n), d = Object.freeze({ ORDER: n, BITS: i, BYTES: a, MASK: fl(i), ZERO: on, ONE: Wt, create: (h) => hn(h, n), isValid: (h) => {
    if (typeof h != "bigint") throw new Error("Invalid field element: expected bigint, got " + typeof h);
    return on <= h && h < n;
  }, is0: (h) => h === on, isOdd: (h) => (h & Wt) === Wt, neg: (h) => hn(-h, n), eql: (h, g) => h === g, sqr: (h) => hn(h * h, n), add: (h, g) => hn(h + g, n), sub: (h, g) => hn(h - g, n), mul: (h, g) => hn(h * g, n), pow: (h, g) => (function(b, m, v) {
    if (v < on) throw new Error("Expected power > 0");
    if (v === on) return b.ONE;
    if (v === Wt) return m;
    let T = b.ONE, A = m;
    for (; v > on; ) v & Wt && (T = b.mul(T, A)), A = b.sqr(A), v >>= Wt;
    return T;
  })(d, h, g), div: (h, g) => hn(h * Va(g, n), n), sqrN: (h) => h * h, addN: (h, g) => h + g, subN: (h, g) => h - g, mulN: (h, g) => h * g, inv: (h) => Va(h, n), sqrt: r.sqrt || ((h) => c(d, h)), invertBatch: (h) => (function(g, b) {
  ...
  })(d, h), cmov: (h, g, b) => b ? g : h, toBytes: (h) => t ? hl(h, a) : ls(h, a), fromBytes: (h) => {
    if (h.length !== a) throw new Error(`Fp.fromBytes: expected ${a}, got ${h.length}`);
    return t ? ul(h) : Mn(h);
  } });
  return Object.freeze(d);
})(Co, void 0, void 0, { sqrt: Id }), Gs = (function(n, e) {
  const t = (r) => Rg({ ...n, ...Bg(r) });
  ...
  let g = hn(n - d * t - h * i, e), b = hn(-d * r - h * a, e);
  const m = g > c, v = b > c;
...
const pl = (n) => n.toRawBytes(!0).slice(1), Wa = (n) => ls(n, 32), Ta = (n) => hn(n, Co), Si = (n) => hn(n, ho), gl = Gs.ProjectivePoint;
function Ka(n) {
  let e = Gs.utils.normPrivateKeyToScalar(n), t = gl.fromPrivateKey(e);
  return { scalar: t.hasEvenY() ? e : Si(-e), bytes: pl(t) };
}
function Ld(n) {
...
function Dd(...n) {
  return Si(Mn(po("BIP0340/challenge", ...n)));
}
function Ug(n) {
  return Ka(n).bytes;
}
function Pg(n, e, t = wd(32)) {
  const r = yn("message", n), { bytes: i, scalar: a } = Ka(e), c = yn("auxRand", t, 32), d = Wa(a ^ Mn(po("BIP0340/aux", c))), h = po("BIP0340/nonce", d, i, r), g = Si(Mn(h));
  if (g === Io) throw new Error("sign failed: k is zero");
  const { bytes: b, scalar: m } = Ka(g), v = Dd(b, i, r), T = new Uint8Array(64);
  if (T.set(b, 0), T.set(Wa(Si(m + v * a)), 32), !Od(T, r, i)) throw new Error("sign: Invalid signature produced");
  return T;
}
function Od(n, e, t) {
  const r = yn("signature", n, 64), i = yn("message", e), a = yn("publicKey", t, 32);
  try {
    const b = Ld(Mn(a)), m = Mn(r.subarray(0, 32));
    if (!Td(m)) return !1;
    const v = Mn(r.subarray(32, 64));
    if (!(typeof (g = v) == "bigint" && Io < g && g < ho)) return !1;
    const T = Dd(Wa(m), pl(b), i), A = (c = b, d = v, h = Si(-T), gl.BASE.multiplyAndAddUnsafe(c, d, h));
...
const yr = { getPublicKey: Ug, sign: Pg, verify: Od, utils: { randomPrivateKey: Gs.utils.randomPrivateKey, lift_x: Ld, pointToBytes: pl, numberToBytesBE: ls, bytesToNumberBE: Mn, taggedHash: po, mod: hn } }, La = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0, vl = (n) => n instanceof Uint8Array, Da = (n) => new DataView(n.buffer, n.byteOffset, n.byteLength), gr = (n, e) => n << 32 - e | n >>> e;
if (new Uint8Array(new Uint32Array([287454020]).buffer)[0] !== 68) throw new Error("Non little-endian hardware is not supported");
...
function Md(n) {
  const e = (r) => n().update(Ci(r)).digest(), t = n();
  return e.outputLen = t.outputLen, e.blockLen = t.blockLen, e.create = () => n(), e;
}
function Rd(n = 32) {
...
class qg extends Nd {
  ...
  update(e) {
    _r.exists(this);
    const { view: t, buffer: r, blockLen: i } = this, a = (e = Ci(e)).length;
    for (let c = 0; c < a; ) {
      const d = Math.min(i - this.pos, a - c);
      if (d !== i) r.set(e.subarray(c, c + d), this.pos), this.pos += d, c += d, this.pos === i && (this.process(t, 0), this.pos = 0);
      else {
  ...
  digestInto(e) {
    _r.exists(this), _r.output(e, this), this.finished = !0;
    const { buffer: t, view: r, blockLen: i, isLE: a } = this;
    let { pos: c } = this;
    t[c++] = 128, this.buffer.subarray(c).fill(0), this.padOffset > i - c && (this.process(r, 0), c = 0);
    for (let m = c; m < i; m++) t[m] = 0;
...
class Bd extends qg {
  ...
  process(e, t) {
    ...
    for (let v = 16; v < 64; v++) {
      const T = es[v - 15], A = es[v - 2], E = gr(T, 7) ^ gr(T, 18) ^ T >>> 3, L = gr(A, 17) ^ gr(A, 19) ^ A >>> 10;
      es[v] = L + es[v - 7] + E + es[v - 16] | 0;
    }
    let { A: r, B: i, C: a, D: c, E: d, F: h, G: g, H: b } = this;
    for (let v = 0; v < 64; v++) {
      const T = b + (gr(d, 6) ^ gr(d, 11) ^ gr(d, 25)) + ((m = d) & h ^ ~m & g) + Fg[v] + es[v] | 0, A = (gr(r, 2) ^ gr(r, 13) ^ gr(r, 22)) + jg(r, i, a) | 0;
      b = g, g = h, h = d, d = c + T | 0, c = a, a = i, i = r, r = T + A | 0;
    }
    var m;
    r = r + this.A | 0, i = i + this.B | 0, a = a + this.C | 0, c = c + this.D | 0, d = d + this.E | 0, h = h + this.F | 0, g = g + this.G | 0, b = b + this.H | 0, this.set(r, i, a, c, d, h, g, b);
...
Nr(cs(4), Mr("0123456789ABCDEF"), Rr(""));
Nr(cs(5), Mr("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), go(5), Rr(""));
const us = (Nr(cs(5), Mr("0123456789ABCDEFGHIJKLMNOPQRSTUV"), go(5), Rr("")), Nr(cs(5), Mr("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), Rr(""), Ud(((n) => n.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1")))), Nr(cs(6), Mr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), go(6), Rr("")));
Nr(cs(6), Mr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), go(6), Rr(""));
const Ya = (n) => Nr(Vg(58), Mr(n), Rr(""));
...
const Xa = Nr(Mr("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), Rr("")), Zc = [996825010, 642813549, 513874426, 1027748829, 705979059];
function yi(n) {
  const e = n >> 25;
  let t = (33554431 & n) << 5;
...
function Vc(n, e, t = 1) {
  ...
  i = yi(i);
  for (let a = 0; a < r; a++) i = yi(i) ^ 31 & n.charCodeAt(a);
  for (let a of e) i = yi(i) ^ a;
  for (let a = 0; a < 6; a++) i = yi(i);
  return i ^= t, Xa.encode(Qa([i % 2 ** 30], 30, 5, !1));
}
function zd(n) {
  const e = n === "bech32" ? 1 : 734539939, t = cs(5), r = t.decode, i = t.encode, a = Fc(r);
  function c(d, h = 90) {
...
const Fs = zd("bech32");
zd("bech32m");
Nr(cs(4), Mr("0123456789abcdef"), Rr(""), Ud(((n) => {
...
const Cr = 16, wl = new Uint8Array(16), wr = ct(wl), Wn = (n) => (n >>> 0 & 255) << 24 | (n >>> 8 & 255) << 16 | (n >>> 16 & 255) << 8 | n >>> 24 & 255;
class qd {
  constructor(e, t) {
    this.blockLen = Cr, this.outputLen = Cr, this.s0 = 0, this.s1 = 0, this.s2 = 0, this.s3 = 0, this.finished = !1, xt(e = hs(e), 16);
    const r = Lo(e);
    let i = r.getUint32(0, !1), a = r.getUint32(4, !1), c = r.getUint32(8, !1), d = r.getUint32(12, !1);
    const h = [];
    for (let U = 0; U < 128; U++) h.push({ s0: Wn(i), s1: Wn(a), s2: Wn(c), s3: Wn(d) }), { s0: i, s1: a, s2: c, s3: d } = { s3: (m = c) << 31 | (v = d) >>> 1, s2: (b = a) << 31 | m >>> 1, s1: (g = i) << 31 | b >>> 1, s0: g >>> 1 ^ 225 << 24 & -(1 & v) };
    var g, b, m, v;
  ...
  update(e) {
    e = hs(e), Zs(this);
    const t = ct(e), r = Math.floor(e.length / Cr), i = e.length % Cr;
    for (let a = 0; a < r; a++) this._updateBlock(t[4 * a + 0], t[4 * a + 1], t[4 * a + 2], t[4 * a + 3]);
    return i && (wl.set(e.subarray(r * Cr)), this._updateBlock(wr[0], wr[1], wr[2], wr[3]), wr.fill(0)), this;
  }
  destroy() {
    const { t: e } = this;
...
class Gg extends qd {
  ...
  update(e) {
    e = hs(e), Zs(this);
    const t = ct(e), r = e.length % Cr, i = Math.floor(e.length / Cr);
    for (let a = 0; a < i; a++) this._updateBlock(Wn(t[4 * a + 3]), Wn(t[4 * a + 2]), Wn(t[4 * a + 1]), Wn(t[4 * a + 0]));
    return r && (wl.set(e.subarray(i * Cr)), this._updateBlock(Wn(wr[3]), Wn(wr[2]), Wn(wr[1]), Wn(wr[0])), wr.fill(0)), this;
  }
  digestInto(e) {
    Zs(this), bl(e, this), this.finished = !0;
    const { s0: t, s1: r, s2: i, s3: a } = this, c = ct(e);
...
function jd(n) {
  const e = (r, i) => n(i, r.length).update(hs(r)).digest(), t = n(new Uint8Array(16), 0);
  return e.outputLen = t.outputLen, e.blockLen = t.blockLen, e.create = (r, i) => n(r, i), e;
}
const Wc = jd(((n, e) => new qd(n, e))), Wg = jd(((n, e) => new Gg(n, e))), Rn = 16, so = new Uint8Array(Rn);
function xl(n) {
  return n << 1 ^ 283 & -(n >> 7);
}
function Bs(n, e) {
...
const _l = Fd(el, ((n) => Bs(n, 3) << 24 | n << 16 | n << 8 | Bs(n, 2))), Zd = Fd(Kg, ((n) => Bs(n, 11) << 24 | Bs(n, 13) << 16 | Bs(n, 9) << 8 | Bs(n, 14))), Qg = (() => {
...
function fs(n) {
  ...
  const { sbox2: t } = _l, r = ct(n), i = r.length, a = (h) => Er(t, h, h, h, h), c = new Uint32Array(e + 28);
  c.set(r);
...
function Vd(n) {
  const e = fs(n), t = e.slice(), r = e.length, { sbox2: i } = _l, { T0: a, T1: c, T2: d, T3: h } = Zd;
  for (let g = 0; g < r; g += 4) for (let b = 0; b < 4; b++) t[g + b] = e[r - g - 4 + b];
  e.fill(0);
  for (let g = 4; g < r - 4; g++) {
    const b = t[g], m = Er(i, b, b, b, b);
    t[g] = a[255 & m] ^ c[m >>> 8 & 255] ^ d[m >>> 16 & 255] ^ h[m >>> 24];
  }
  return t;
}
function as(n, e, t, r, i, a) {
...
function Kn(n, e, t, r, i) {
  ...
  for (let b = 0; b < g; b++) {
    const m = n[h++] ^ as(c, d, e, t, r, i), v = n[h++] ^ as(c, d, t, r, i, e), T = n[h++] ^ as(c, d, r, i, e, t), A = n[h++] ^ as(c, d, i, e, t, r);
    e = m, t = v, r = T, i = A;
  }
  return { s0: n[h++] ^ Er(a, e, t, r, i), s1: n[h++] ^ Er(a, t, r, i, e), s2: n[h++] ^ Er(a, r, i, e, t), s3: n[h++] ^ Er(a, i, e, t, r) };
}
function Gd(n, e, t, r, i) {
  ...
  const g = n.length / 4 - 2;
  for (let b = 0; b < g; b++) {
    const m = n[h++] ^ as(c, d, e, i, r, t), v = n[h++] ^ as(c, d, t, e, i, r), T = n[h++] ^ as(c, d, r, t, e, i), A = n[h++] ^ as(c, d, i, r, t, e);
    e = m, t = v, r = T, i = A;
  }
  return { s0: n[h++] ^ Er(a, e, i, r, t), s1: n[h++] ^ Er(a, t, e, i, r), s2: n[h++] ^ Er(a, r, t, e, i), s3: n[h++] ^ Er(a, i, r, t, e) };
}
function Qs(n, e) {
...
function Yg(n, e, t, r) {
  ...
  r = Qs(i, r);
  const a = e, c = ct(a);
  let { s0: d, s1: h, s2: g, s3: b } = Kn(n, c[0], c[1], c[2], c[3]);
  const m = ct(t), v = ct(r);
  for (let A = 0; A + 4 <= m.length; A += 4) {
    ...
    ({ s0: d, s1: h, s2: g, s3: b } = Kn(n, c[0], c[1], c[2], c[3]));
  }
...
function wi(n, e, t, r, i) {
  xt(t, Rn), xt(r), i = Qs(r.length, i);
  const a = t, c = ct(a), d = Lo(a), h = ct(r), g = ct(i), b = e ? 0 : 12, m = r.length;
  let v = d.getUint32(b, e), { s0: T, s1: A, s2: E, s3: L } = Kn(n, c[0], c[1], c[2], c[3]);
  for (let P = 0; P + 4 <= h.length; P += 4) g[P + 0] = h[P + 0] ^ T, g[P + 1] = h[P + 1] ^ A, g[P + 2] = h[P + 2] ^ E, g[P + 3] = h[P + 3] ^ L, v = v + 1 >>> 0, d.setUint32(b, v, e), { s0: T, s1: A, s2: E, s3: L } = Kn(n, c[0], c[1], c[2], c[3]);
  const U = Rn * Math.floor(h.length / 4);
  if (U < m) {
...
Ks({ blockSize: 16, nonceLength: 16 }, (function(n, e) {
  function t(r, i) {
    const a = fs(n), c = e.slice(), d = Yg(a, c, r, i);
    return a.fill(0), c.fill(0), d;
  }
  return xt(n), xt(e, Rn), { encrypt: (r, i) => t(r, i), decrypt: (r, i) => t(r, i) };
}));
function Wd(n) {
  if (xt(n), n.length % Rn != 0) throw new Error("aes/(cbc-ecb).decrypt ciphertext should consist of blocks with size 16");
}
function Kd(n, e, t) {
  let r = n.length;
  const i = r % Rn;
...
Ks({ blockSize: 16 }, (function(n, e = {}) {
  ...
  return { encrypt: (r, i) => {
    xt(r);
    const { b: a, o: c, out: d } = Kd(r, t, i), h = fs(n);
    let g = 0;
    for (; g + 4 <= a.length; ) {
      const { s0: b, s1: m, s2: v, s3: T } = Kn(h, a[g + 0], a[g + 1], a[g + 2], a[g + 3]);
      c[g++] = b, c[g++] = m, c[g++] = v, c[g++] = T;
    }
    if (t) {
      const b = Yd(r.subarray(4 * g)), { s0: m, s1: v, s2: T, s3: A } = Kn(h, b[0], b[1], b[2], b[3]);
      c[g++] = m, c[g++] = v, c[g++] = T, c[g++] = A;
    }
    return h.fill(0), d;
  }, decrypt: (r, i) => {
    Wd(r);
    const a = Vd(n), c = Qs(r.length, i), d = ct(r), h = ct(c);
...
const Xd = Ks({ blockSize: 16, nonceLength: 16 }, (function(n, e, t = {}) {
  xt(n), xt(e, 16);
  const r = !t.disablePadding;
  return { encrypt: (i, a) => {
    const c = fs(n), { b: d, o: h, out: g } = Kd(i, r, a), b = ct(e);
    let m = b[0], v = b[1], T = b[2], A = b[3], E = 0;
    for (; E + 4 <= d.length; ) m ^= d[E + 0], v ^= d[E + 1], T ^= d[E + 2], A ^= d[E + 3], { s0: m, s1: v, s2: T, s3: A } = Kn(c, m, v, T, A), h[E++] = m, h[E++] = v, h[E++] = T, h[E++] = A;
    if (r) {
      const L = Yd(i.subarray(4 * E));
      m ^= L[0], v ^= L[1], T ^= L[2], A ^= L[3], { s0: m, s1: v, s2: T, s3: A } = Kn(c, m, v, T, A), h[E++] = m, h[E++] = v, h[E++] = T, h[E++] = A;
    }
    return c.fill(0), g;
  }, decrypt: (i, a) => {
    Wd(i);
    const c = Vd(n), d = ct(e), h = Qs(i.length, a), g = ct(i), b = ct(h);
...
Ks({ blockSize: 16, nonceLength: 12, tagLength: 16 }, (function(n, e, t) {
  ...
  function a() {
    const c = fs(n), d = so.slice(), h = so.slice();
    if (wi(c, !1, h, h, d), e.length === 12) h.set(e);
    else {
      const g = so.slice();
      Ja(Lo(g), 8, BigInt(8 * e.length), !1), Wc.create(d).update(e).update(g).digestInto(h);
    }
    return { xk: c, authKey: d, counter: h, tagMask: wi(c, !1, h, so) };
  }
  return { encrypt: (c) => {
    xt(c);
...
Ks({ blockSize: 16, nonceLength: 12, tagLength: 16 }, (function(n, e, t) {
  ...
  function d() {
    ...
    const m = fs(n), v = new Uint8Array(b), T = new Uint8Array(16), A = ct(e);
    let E = 0, L = A[0], U = A[1], P = A[2], J = 0;
    for (const ie of [T, v].map(ct)) {
      const te = ct(ie);
      for (let ee = 0; ee < te.length; ee += 2) {
        const { s0: F, s1: O } = Kn(m, E, L, U, P);
        te[ee + 0] = F, te[ee + 1] = O, E = ++J;
      }
    }
    return m.fill(0), { authKey: T, encKey: fs(v) };
  }
  function h(b, m, v) {
    ...
    return { s0: E, s1: L, s2: U, s3: P } = Kn(b, E, L, U, P), A[0] = E, A[1] = L, A[2] = U, A[3] = P, T;
  }
  function g(b, m, v) {
    let T = m.slice();
    return T[15] |= 128, wi(b, !0, T, v);
  }
...
class Xg {
  constructor(e) {
    this.blockLen = 16, this.outputLen = 16, this.buffer = new Uint8Array(16), this.r = new Uint16Array(10), this.h = new Uint16Array(10), this.pad = new Uint16Array(8), this.pos = 0, this.finished = !1, xt(e = hs(e), 32);
    const t = un(e, 0), r = un(e, 2), i = un(e, 4), a = un(e, 6), c = un(e, 8), d = un(e, 10), h = un(e, 12), g = un(e, 14);
  ...
  process(e, t, r = !1) {
    const i = r ? 0 : 2048, { h: a, r: c } = this, d = c[0], h = c[1], g = c[2], b = c[3], m = c[4], v = c[5], T = c[6], A = c[7], E = c[8], L = c[9], U = un(e, t + 0), P = un(e, t + 2), J = un(e, t + 4), ie = un(e, t + 6), te = un(e, t + 8), ee = un(e, t + 10), F = un(e, t + 12), O = un(e, t + 14);
    let k = a[0] + (8191 & U), $ = a[1] + (8191 & (U >>> 13 | P << 3)), S = a[2] + (8191 & (P >>> 10 | J << 6)), j = a[3] + (8191 & (J >>> 7 | ie << 9)), V = a[4] + (8191 & (ie >>> 4 | te << 12)), Y = a[5] + (te >>> 1 & 8191), W = a[6] + (8191 & (te >>> 14 | ee << 2)), re = a[7] + (8191 & (ee >>> 11 | F << 5)), de = a[8] + (8191 & (F >>> 8 | O << 8)), be = a[9] + (O >>> 5 | i), fe = 0, Ie = fe + k * d + $ * (5 * L) + S * (5 * E) + j * (5 * A) + V * (5 * T);
    fe = Ie >>> 13, Ie &= 8191, Ie += Y * (5 * v) + W * (5 * m) + re * (5 * b) + de * (5 * g) + be * (5 * h), fe += Ie >>> 13, Ie &= 8191;
    let $e = fe + k * h + $ * d + S * (5 * L) + j * (5 * E) + V * (5 * A);
    fe = $e >>> 13, $e &= 8191, $e += Y * (5 * T) + W * (5 * v) + re * (5 * m) + de * (5 * b) + be * (5 * g), fe += $e >>> 13, $e &= 8191;
    let Ce = fe + k * g + $ * h + S * d + j * (5 * L) + V * (5 * E);
    fe = Ce >>> 13, Ce &= 8191, Ce += Y * (5 * A) + W * (5 * T) + re * (5 * v) + de * (5 * m) + be * (5 * b), fe += Ce >>> 13, Ce &= 8191;
    let Ge = fe + k * b + $ * g + S * h + j * d + V * (5 * L);
    fe = Ge >>> 13, Ge &= 8191, Ge += Y * (5 * E) + W * (5 * A) + re * (5 * T) + de * (5 * v) + be * (5 * m), fe += Ge >>> 13, Ge &= 8191;
    let We = fe + k * m + $ * b + S * g + j * h + V * d;
    fe = We >>> 13, We &= 8191, We += Y * (5 * L) + W * (5 * E) + re * (5 * A) + de * (5 * T) + be * (5 * v), fe += We >>> 13, We &= 8191;
    let ke = fe + k * v + $ * m + S * b + j * g + V * h;
    fe = ke >>> 13, ke &= 8191, ke += Y * d + W * (5 * L) + re * (5 * E) + de * (5 * A) + be * (5 * T), fe += ke >>> 13, ke &= 8191;
    let Ze = fe + k * T + $ * v + S * m + j * b + V * g;
    fe = Ze >>> 13, Ze &= 8191, Ze += Y * h + W * d + re * (5 * L) + de * (5 * E) + be * (5 * A), fe += Ze >>> 13, Ze &= 8191;
    let pt = fe + k * A + $ * T + S * v + j * m + V * b;
    fe = pt >>> 13, pt &= 8191, pt += Y * g + W * h + re * d + de * (5 * L) + be * (5 * E), fe += pt >>> 13, pt &= 8191;
    let pe = fe + k * E + $ * A + S * T + j * v + V * m;
    fe = pe >>> 13, pe &= 8191, pe += Y * b + W * g + re * h + de * d + be * (5 * L), fe += pe >>> 13, pe &= 8191;
    let it = fe + k * L + $ * E + S * A + j * T + V * v;
    fe = it >>> 13, it &= 8191, it += Y * m + W * b + re * g + de * h + be * d, fe += it >>> 13, it &= 8191, fe = (fe << 2) + fe | 0, fe = fe + Ie | 0, Ie = 8191 & fe, fe >>>= 13, $e += fe, a[0] = Ie, a[1] = $e, a[2] = Ce, a[3] = Ge, a[4] = We, a[5] = ke, a[6] = Ze, a[7] = pt, a[8] = pe, a[9] = it;
  }
  finalize() {
  ...
  update(e) {
    Zs(this);
    const { buffer: t, blockLen: r } = this, i = (e = hs(e)).length;
    for (let a = 0; a < i; ) {
...
(function(n) {
  const e = (r, i) => n(i).update(hs(r)).digest(), t = n(new Uint8Array(32));
...
function nu(n, e) {
  ...
  return Na(i), Na(c), Gc(a), Gc(t), (d, h, g, b, m = 0) => {
    xt(d), xt(h), xt(g);
    const v = g.length;
    if (b || (b = new Uint8Array(v)), xt(b), Na(m), m < 0 || m >= Kc) throw new Error("arx: counter overflow");
    ...
    for (!(function(ie, te, ee, F, O, k, $, S) {
      const j = O.length, V = new Uint8Array(64), Y = ct(V), W = Ra(O) && Ra(k), re = W ? ct(O) : Qc, de = W ? ct(k) : Qc;
      for (let be = 0; be < j; $++) {
        ...
        if (W && fe === 64) {
          ...
          for (let $e, Ce = 0; Ce < 16; Ce++) $e = Ie + Ce, de[$e] = re[$e] ^ Y[Ce];
          be += 64;
        } else {
          for (let Ie, $e = 0; $e < fe; $e++) Ie = be + $e, k[Ie] = O[Ie] ^ V[$e];
          be += fe;
        }
      }
...
function ru(n, e, t, r, i, a = 20) {
  let c = n[0], d = n[1], h = n[2], g = n[3], b = e[0], m = e[1], v = e[2], T = e[3], A = e[4], E = e[5], L = e[6], U = e[7], P = i, J = t[0], ie = t[1], te = t[2], ee = c, F = d, O = h, k = g, $ = b, S = m, j = v, V = T, Y = A, W = E, re = L, de = U, be = P, fe = J, Ie = ie, $e = te;
  for (let Ge = 0; Ge < a; Ge += 2) ee = ee + $ | 0, be = Te(be ^ ee, 16), Y = Y + be | 0, $ = Te($ ^ Y, 12), ee = ee + $ | 0, be = Te(be ^ ee, 8), Y = Y + be | 0, $ = Te($ ^ Y, 7), F = F + S | 0, fe = Te(fe ^ F, 16), W = W + fe | 0, S = Te(S ^ W, 12), F = F + S | 0, fe = Te(fe ^ F, 8), W = W + fe | 0, S = Te(S ^ W, 7), O = O + j | 0, Ie = Te(Ie ^ O, 16), re = re + Ie | 0, j = Te(j ^ re, 12), O = O + j | 0, Ie = Te(Ie ^ O, 8), re = re + Ie | 0, j = Te(j ^ re, 7), k = k + V | 0, $e = Te($e ^ k, 16), de = de + $e | 0, V = Te(V ^ de, 12), k = k + V | 0, $e = Te($e ^ k, 8), de = de + $e | 0, V = Te(V ^ de, 7), ee = ee + S | 0, $e = Te($e ^ ee, 16), re = re + $e | 0, S = Te(S ^ re, 12), ee = ee + S | 0, $e = Te($e ^ ee, 8), re = re + $e | 0, S = Te(S ^ re, 7), F = F + j | 0, be = Te(be ^ F, 16), de = de + be | 0, j = Te(j ^ de, 12), F = F + j | 0, be = Te(be ^ F, 8), de = de + be | 0, j = Te(j ^ de, 7), O = O + V | 0, fe = Te(fe ^ O, 16), Y = Y + fe | 0, V = Te(V ^ Y, 12), O = O + V | 0, fe = Te(fe ^ O, 8), Y = Y + fe | 0, V = Te(V ^ Y, 7), k = k + $ | 0, Ie = Te(Ie ^ k, 16), W = W + Ie | 0, $ = Te($ ^ W, 12), k = k + $ | 0, Ie = Te(Ie ^ k, 8), W = W + Ie | 0, $ = Te($ ^ W, 7);
  let Ce = 0;
  r[Ce++] = c + ee | 0, r[Ce++] = d + F | 0, r[Ce++] = h + O | 0, r[Ce++] = g + k | 0, r[Ce++] = b + $ | 0, r[Ce++] = m + S | 0, r[Ce++] = v + j | 0, r[Ce++] = T + V | 0, r[Ce++] = A + Y | 0, r[Ce++] = E + W | 0, r[Ce++] = L + re | 0, r[Ce++] = U + de | 0, r[Ce++] = P + be | 0, r[Ce++] = J + fe | 0, r[Ce++] = ie + Ie | 0, r[Ce++] = te + $e | 0;
}
...
class iu extends Nd {
  constructor(e, t) {
    super(), this.finished = !1, this.destroyed = !1, _r.hash(e);
    const r = Ci(t);
    if (this.iHash = e.create(), typeof this.iHash.update != "function") throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
    const i = this.blockLen, a = new Uint8Array(i);
  ...
  update(e) {
    return _r.exists(this), this.iHash.update(e), this;
  }
  digestInto(e) {
    _r.exists(this), _r.bytes(e, this.outputLen), this.finished = !0, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
    const e = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(e), e;
...
function n0(n, e, t) {
  return _r.hash(n), Do(n, Ci(t), Ci(e));
}
Do.create = (n, e) => new iu(n, e);
const Ba = new Uint8Array([0]), Yc = new Uint8Array();
function r0(n, e, t, r = 32) {
  if (_r.hash(n), _r.number(r), r > 255 * n.outputLen) throw new Error("Length should be <= 255*HashLen");
...
var s0 = Object.defineProperty, jt = (n, e) => {
  for (var t in e) s0(n, t, { get: e[t], enumerable: !0 });
}, ss = Symbol("verified"), i0 = (n) => n instanceof Object;
function Oo(n) {
...
var ou = {};
jt(ou, { Queue: () => lu, QueueNode: () => au, binarySearch: () => El, insertEventIntoAscendingList: () => l0, insertEventIntoDescendingList: () => a0, normalizeURL: () => Us, utf8Decoder: () => Or, utf8Encoder: () => nr });
var Or = new TextDecoder("utf-8"), nr = new TextEncoder();
function Us(n) {
  n.indexOf("://") === -1 && (n = "wss://" + n);
  let e = new URL(n);
...
function _i(n) {
  return en($s(nr.encode(cu(n))));
}
var No = new class {
  generateSecretKey() {
    return yr.utils.randomPrivateKey();
  }
  getPublicKey(n) {
    return en(yr.getPublicKey(n));
  }
  finalizeEvent(n, e) {
    const t = n;
    return t.pubkey = en(yr.getPublicKey(e)), t.id = _i(t), t.sig = en(yr.sign(_i(t), e)), t[ss] = !0, t;
  }
  verifyEvent(n) {
    if (typeof n[ss] == "boolean") return n[ss];
    const e = _i(n);
    if (e !== n.id) return n[ss] = !1, !1;
    try {
      const t = yr.verify(n.sig, e, n.pubkey);
      return n[ss] = t, t;
    } catch {
      return n[ss] = !1, !1;
    }
  }
}(), du = No.generateSecretKey, $l = No.getPublicKey, or = No.finalizeEvent, Ys = No.verifyEvent, uu = {};
function hu(n) {
...
jt(ku, { getHex64: () => Mo, getInt: () => Au, getSubscriptionId: () => Su, matchEventId: () => $v, matchEventKind: () => Av, matchEventPubkey: () => kv });
var Cu = {};
function Iu(n, e) {
...
jt(Cu, { makeAuthEvent: () => Iu });
var Tu, Cv = (n) => (n[ss] = !0, !0), Tl = class {
  url;
  _connected = !1;
  onclose = null;
  onnotice = (n) => {
...
var Lu, Du = class extends Tl {
  constructor(n) {
    super(n, { verifyEvent: Ys, websocketImplementation: Tu });
  }
...
var Lv = class extends Tv {
  constructor() {
    super({ verifyEvent: Ys, websocketImplementation: Lu });
  }
}, Ou = {};
jt(Ou, { BECH32_REGEX: () => Nu, Bech32MaxSize: () => Ll, NostrTypeGuard: () => Dv, decode: () => Oi, encodeBytes: () => Bo, naddrEncode: () => Uv, neventEncode: () => Bv, noteEncode: () => Mv, nprofileEncode: () => Rv, npubEncode: () => Nv, nsecEncode: () => Ov });
...
function Oi(n) {
  let { prefix: e, words: t } = Fs.decode(n, Ll), r = new Uint8Array(Fs.fromWords(t));
  switch (e) {
    case "nprofile": {
      let i = Ua(r);
      if (!i[0]?.[0]) throw new Error("missing TLV 0 for nprofile");
      if (i[0][0].length !== 32) throw new Error("TLV 0 should be 32 bytes");
      return { type: "nprofile", data: { pubkey: en(i[0][0]), relays: i[1] ? i[1].map(((a) => Or.decode(a))) : [] } };
    }
    case "nevent": {
      let i = Ua(r);
      ...
      return { type: "nevent", data: { id: en(i[0][0]), relays: i[1] ? i[1].map(((a) => Or.decode(a))) : [], author: i[2]?.[0] ? en(i[2][0]) : void 0, kind: i[3]?.[0] ? parseInt(en(i[3][0]), 16) : void 0 } };
    }
    case "naddr": {
      let i = Ua(r);
      ...
      return { type: "naddr", data: { identifier: Or.decode(i[0][0]), pubkey: en(i[2][0]), kind: parseInt(en(i[3][0]), 16), relays: i[1] ? i[1].map(((a) => Or.decode(a))) : [] } };
    }
    case "nsec":
...
function Ro(n, e) {
  let t = Fs.toWords(e);
  return Fs.encode(n, t, Ll);
}
function Bo(n, e) {
  return Ro(n, e);
}
function Rv(n) {
  return Ro("nprofile", Dl({ 0: [js(n.pubkey)], 1: (n.relays || []).map(((e) => nr.encode(e))) }));
}
function Bv(n) {
  let e;
  ...
  })(n.kind)), Ro("nevent", Dl({ 0: [js(n.id)], 1: (n.relays || []).map(((t) => nr.encode(t))), 2: n.author ? [js(n.author)] : [], 3: e ? [new Uint8Array(e)] : [] }));
}
function Uv(n) {
  let e = new ArrayBuffer(4);
  return new DataView(e).setUint32(0, n.kind, !1), Ro("naddr", Dl({ 0: [nr.encode(n.identifier)], 1: (n.relays || []).map(((t) => nr.encode(t))), 2: [js(n.pubkey)], 3: [new Uint8Array(e)] }));
}
function Dl(n) {
  let e = [];
...
async function Ru(n, e, t) {
  const r = n instanceof Uint8Array ? en(n) : n, i = Bu(Gs.getSharedSecret(r, "02" + e));
  let a = Uint8Array.from(Rd(16)), c = nr.encode(t), d = Xd(i, a).encrypt(c);
  return `${us.encode(new Uint8Array(d))}?iv=${us.encode(new Uint8Array(a.buffer))}`;
}
async function Hv(n, e, t) {
  const r = n instanceof Uint8Array ? en(n) : n;
  let [i, a] = t.split("?iv="), c = Bu(Gs.getSharedSecret(r, "02" + e)), d = us.decode(a), h = us.decode(i), g = Xd(c, d).decrypt(h);
  return Or.decode(g);
}
function Bu(n) {
  return n.slice(1, 33);
}
jt(Mu, { decrypt: () => Hv, encrypt: () => Ru });
var Uu = {};
jt(Uu, { NIP05_REGEX: () => Ol, isNip05: () => qv, isValid: () => Zv, queryProfile: () => Pu, searchDomain: () => Fv, useFetchImplementation: () => jv });
...
jt(zu, { parse: () => Vv });
var Hu = {};
jt(Hu, { fetchRelayInformation: () => Wv, useFetchImplementation: () => Gv });
function Gv(n) {
}
async function Wv(n) {
...
function Fu(n) {
  return en($s(nr.encode(JSON.stringify([0, n.pubkey, n.created_at, n.kind, n.tags, n.content]))));
}
jt(qu, { fastEventHash: () => Fu, getPow: () => ju, minePow: () => Kv });
var Zu = {};
function Qv(n, e, t, r) {
  return or({ kind: Sl, tags: [...n.tags ?? [], ["e", e.id, t], ["p", e.pubkey]], content: n.content === "" ? "" : JSON.stringify(e), created_at: n.created_at }, r);
}
function Vu(n) {
  if (n.kind !== Sl) return;
  let e, t;
...
jt(Zu, { finishRepostEvent: () => Qv, getRepostedEvent: () => Yv, getRepostedEventPointer: () => Vu });
var Gu = {};
jt(Gu, { NOSTR_URI_REGEX: () => Po, parse: () => Jv, test: () => Xv });
...
function Jv(n) {
  ...
  return { uri: e[0], value: e[1], decoded: Oi(e[1]) };
}
var Wu = {};
function eb(n, e, t) {
  const r = e.tags.filter(((i) => i.length >= 2 && (i[0] === "e" || i[0] === "p")));
  return or({ ...n, kind: Cl, tags: [...n.tags ?? [], ...r, ["e", e.id], ["p", e.pubkey]], content: n.content ?? "+" }, t);
}
function tb(n) {
  if (n.kind !== Cl) return;
  let e, t;
...
jt(Wu, { finishReactionEvent: () => eb, getReactedEventPointer: () => tb });
var Ku = {};
jt(Ku, { matchAll: () => nb, regex: () => Nl, replaceAll: () => rb });
var Nl = () => new RegExp(`\\b${Po.source}\\b`, "g");
function* nb(n) {
  const e = n.matchAll(Nl());
  for (const t of e) try {
    const [r, i] = t;
    yield { uri: r, value: i, decoded: Oi(i), start: t.index, end: t.index + r.length };
  } catch {
  }
}
function rb(n, e) {
  return n.replaceAll(Nl(), ((t, r) => e({ uri: t, value: r, decoded: Oi(r) })));
}
var Qu = {};
jt(Qu, { channelCreateEvent: () => sb, channelHideMessageEvent: () => ab, channelMessageEvent: () => ob, channelMetadataEvent: () => ib, channelMuteUserEvent: () => lb });
var sb = (n, e) => {
  let t;
  ...
  return or({ kind: gu, tags: [...n.tags ?? []], content: t, created_at: n.created_at }, e);
}, ib = (n, e) => {
  let t;
  if (typeof n.content == "object") t = JSON.stringify(n.content);
  else {
  ...
  return or({ kind: vu, tags: [["e", n.channel_create_event_id], ...n.tags ?? []], content: t, created_at: n.created_at }, e);
}, ob = (n, e) => {
  const t = [["e", n.channel_create_event_id, n.relay_url, "root"]];
  return n.reply_to_channel_message_event_id && t.push(["e", n.reply_to_channel_message_event_id, n.relay_url, "reply"]), or({ kind: bu, tags: [...t, ...n.tags ?? []], content: n.content, created_at: n.created_at }, e);
}, ab = (n, e) => {
  let t;
  if (typeof n.content == "object") t = JSON.stringify(n.content);
  else {
  ...
  return or({ kind: mu, tags: [["e", n.channel_message_event_id], ...n.tags ?? []], content: t, created_at: n.created_at }, e);
}, lb = (n, e) => {
  let t;
  if (typeof n.content == "object") t = JSON.stringify(n.content);
  else {
  ...
  return or({ kind: yu, tags: [["p", n.pubkey_to_mute], ...n.tags ?? []], content: t, created_at: n.created_at }, e);
}, Yu = {};
jt(Yu, { EMOJI_SHORTCODE_REGEX: () => Xu, matchAll: () => cb, regex: () => Ml, replaceAll: () => db });
...
var Rl, Ju = {};
jt(Ju, { useFetchImplementation: () => ub, validateGithub: () => hb });
try {
  Rl = fetch;
} catch {
}
...
var eh = {};
jt(eh, { decrypt: () => zl, encrypt: () => Pl, getConversationKey: () => Bl, v2: () => pb });
var th = 1, nh = 65535;
function Bl(n, e) {
...
function fb(n) {
  const e = nr.encode(n), t = e.length;
...
function Pl(n, e, t = Rd(32)) {
  ...
  return us.encode(To(new Uint8Array([2]), t, d, h));
}
function zl(n, e) {
...
jt(ih, { makeNwcRequestEvent: () => vb, parseConnectionString: () => gb });
var Hl, oh = {};
jt(oh, { getZapEndpoint: () => mb, makeZapReceipt: () => xb, makeZapRequest: () => yb, useFetchImplementation: () => bb, validateZapRequest: () => wb });
try {
  Hl = fetch;
} catch {
}
...
var ah = {};
jt(ah, { createRumor: () => hh, createSeal: () => fh, createWrap: () => ph, unwrapEvent: () => gh, unwrapManyEvents: () => Eb, wrapEvent: () => tl, wrapManyEvents: () => _b });
...
function fh(n, e, t) {
  return or({ kind: pu, content: uh(n, e, t), created_at: ch(), tags: [] }, e);
}
function ph(n, e) {
  const t = du();
  return or({ kind: wu, content: uh(n, t, e), created_at: ch(), tags: [["p", e]] }, t);
}
function tl(n, e, t) {
...
var vh = {};
jt(vh, { getToken: () => $b, hashPayload: () => ql, unpackEventFromToken: () => mh, validateEvent: () => $h, validateEventKind: () => wh, validateEventMethodTag: () => _h, validateEventPayloadTag: () => Eh, validateEventTimestamp: () => yh, validateEventUrlTag: () => xh, validateToken: () => kb });
var bh = "Nostr ";
async function $b(n, e, t, r = !1, i) {
  ...
  const c = await t(a);
  return (r ? bh : "") + us.encode(nr.encode(JSON.stringify(c)));
}
...
function ql(n) {
  return en($s(nr.encode(JSON.stringify(n))));
}
function Eh(n, e) {
...
class Ii {
  ...
  static fromButton(e) {
    ...
    const t = Ii.determineColorMode(e);
    return new Ii(e.getAttribute("data-nzv-id"), e.getAttribute("data-relay-urls").split(","), t);
  }
}
class Ur {
  constructor(e = 1e3) {
...
class Ei {
  ...
  constructor() {
    if (Ei.#e) return Ei.#e;
    this.profileCache = new jl(), this.zapEventCache = new Ab(), this.referenceCache = new Sb(), this.statsCache = new Cb(), this.decodedCache = new Ib(), this.loadStateCache = new Tb(), this.zapInfoCache = new Lb(), this.imageCache = new Db(), this.nip05Cache = new Ob(), this.nip05PendingCache = new Ur(), this.#n = ["zapInfo", "uiComponent", "decoded", "nip05", "nip05PendingFetches", "zapLoadStates", "imageCache", "isEventIdentifier"].reduce(((e, t) => (e[t] = new Ur(), e)), {}), this.viewStats = /* @__PURE__ */ new Map(), this.viewStates = /* @__PURE__ */ new Map(), Ei.#e = this;
  }
  setProfile(e, t) {
...
function Pa(n) {
  return en($s(Vb.encode((function(e) {
...
var oo = new class {
  ...
  finalizeEvent(n, e) {
    const t = n;
    return t.pubkey = en(yr.getPublicKey(e)), t.id = Pa(t), t.sig = en(yr.sign(Pa(t), e)), t[ws] = !0, t;
  }
  verifyEvent(n) {
...
var Sh, Xb = (n) => (n[ws] = !0, !0), Ch = class {
  ...
  _WebSocket;
  constructor(n, e) {
    this.url = xi(n), this.verifyEvent = e.verifyEvent, this._WebSocket = e.websocketImplementation || WebSocket;
  }
  static async connect(n, e) {
    const t = new Ch(n, e);
    return await t.connect(), t;
  ...
  publish(n, e) {
    return n.map(xi).map((async (t, r, i) => {
      if (i.indexOf(t) !== r) return Promise.reject("duplicate url");
      let a = await this.ensureRelay(t);
      return a.publish(e).then(((c) => {
        if (this.trackRelays) {
...
class $i {
  ...
  #r;
  constructor() {
    return $i.instance ? $i.instance : (this.#s(), $i.instance = this, this);
  }
  #s() {
...
class t1 {
  ...
  #n(e, t, r, i) {
    if (e && t) {
      const a = (c) => {
        ...
        const g = c === "robohash" ? this.#t(t.closest("[data-pubkey]")?.dataset.pubkey, `${Ps(i)}'s icon`) : Object.assign(document.createElement("img"), { src: c, alt: `${Ps(i)}'s icon`, loading: "lazy", className: "profile-icon" }), b = t.closest("[data-pubkey]")?.dataset.pubkey;
        if (b) {
  ...
  #r(e, t) {
    if (e && !e.getAttribute("data-nip05-updated")) {
      const r = Ti.getNip05(t);
      r ? (e.textContent = r, e.setAttribute("data-nip05-updated", "true")) : Ti.verifyNip05Async(t).then(((i) => {
...
class Nn {
  ...
  static ZapInfo = class {
    ...
    static async createFromEvent(e, t = {}) {
      return await new Nn.ZapInfo(e).extractInfo(t);
    }
    ...
    async extractInfo(e = {}) {
      ...
      if (r) return r.colorClass = Nn.ZapInfo.getAmountColorClass(r.satsAmount, e.isColorModeEnabled), r;
      try {
        const { pubkey: a, content: c, satsText: d } = await Pb(this.#u), h = parseInt(d.replace(/,/g, "").split(" ")[0], 10), g = typeof a == "string" ? a : null, b = this.#u.reference || null, m = { satsText: d, satsAmount: h, comment: c || "", pubkey: g || "", created_at: this.#u.created_at, displayIdentifier: g ? Ah(Ub(g)) : "anonymous", senderName: null, senderIcon: null, reference: b, colorClass: Nn.ZapInfo.getAmountColorClass(h, e?.isColorModeEnabled) };
    ...
    static async batchExtractInfo(e, t = !0) {
      ...
      return await Promise.all(e.map((async (i) => {
        const a = new Nn.ZapInfo(i), c = await a.extractInfo({ isColorModeEnabled: t });
        r.set(i.id, c);
      }))), r;
    }
  };
...
class n1 {
  ...
  async createListItem(e) {
    const t = await Nn.ZapInfo.createFromEvent(e, { isColorModeEnabled: this.config?.isColorModeEnabled }), r = document.createElement("li");
    return r.className = `zap-list-item ${t.colorClass}${t.comment ? " with-comment" : ""}`, r.setAttribute("data-pubkey", t.pubkey), e?.id && r.setAttribute("data-event-id", e.id), r.innerHTML = Nn.createZapItemHTML(t, t.colorClass, this.viewId), r.setAttribute("data-timestamp", e.created_at.toString()), { li: r, zapInfo: t };
  }
}
class r1 {
  constructor(e, t, r, i) {
  ...
  #c(e) {
    ...
    e.innerHTML = Nn.createNoZapsMessageHTML(t), e.style.minHeight = Xe.DIALOG_CONFIG.ZAP_LIST.MIN_HEIGHT;
  }
  async batchUpdate(e, t = {}) {
    const r = this.#e(".dialog-zap-list");
    if (r) try {
      const i = new Map(Array.from(r.querySelectorAll(".zap-list-item")).map(((g) => [g.getAttribute("data-event-id"), g]))), a = this.#b(e), c = Vs(this.config.identifier), d = a.filter(((g) => {
        const b = i.get(g.id);
  ...
  updateZapReference(e) {
    if (e?.id && e?.reference) try {
      ...
      if (!t) return;
      Nn.addReferenceToElement(t, e.reference), Ne.setReference(e.id, e.reference);
    } catch {
    }
  }
  #g() {
  ...
  #m(e, t) {
    ...
    r && Nn.addReferenceToElement(t, r);
  }
  #y(e) {
  ...
  #w(e, t, r) {
    ...
    e.className = `zap-list-item ${i}${t.comment ? " with-comment" : ""}`, e.setAttribute("data-pubkey", t.pubkey), e.setAttribute("data-event-id", r), e.innerHTML = Nn.createZapItemHTML(t, i, this.viewId), e.removeAttribute("data-index");
  }
}
...
const Li = new class {
  ...
  setViewConfig(n, e) {
    this.viewConfigs.set(n, e), Nn.viewConfigs.set(n, e), Ne.initializeZapView(n);
  }
  getViewConfig(n) {
  ...
  _handleInitialEvent(n, e, t, r) {
    ...
    if (Ne.addZapEvent(r, n)) {
      if (e.push(n), this.updateEventReference(n, r).then(((a) => {
        ...
        Li.handleZapEvent(n, r, a?.identifier), this.zapListUI && this.zapListUI.prependZap(n).catch(console.error);
      }
  ...
  async _processBatchEvents(n, e) {
    if (n?.length) {
      ...
      try {
        await Promise.all([Ti.processBatchProfiles(n)]);
      } catch {
      }
...
class o1 extends HTMLElement {
  ...
  async #n() {
    return new Promise(((e) => {
      ...
      t.innerHTML = Nn.getDialogTemplate(), this.shadowRoot.appendChild(t.content.cloneNode(!0)), this.#s(), queueMicrotask((() => e()));
    }));
  }
  async #r(e) {
    const t = document.createElement("style");
    t.textContent = i1(), this.shadowRoot.appendChild(t), this.statsUI = new Hb(this.shadowRoot), this.profileUI = new t1(), this.zapListUI = new r1(this.shadowRoot, this.profileUI, this.viewId, e), xr.setZapListUI(this.zapListUI);
    ...
    if (i) {
      ...
      if (a?.stats) this.statsUI.displayStats(a.stats);
        ...
        const c = await Li.getCurrentStats(this.viewId);
  ...
  closeDialog() {
    const e = this.#i(".dialog");
    e?.open && (this.zapListUI?.destroy(), xr.unsubscribe(this.viewId), e.close(), this.remove(), window.removeEventListener("popstate", this.popStateHandler));
  }
  displayZapStats(e) {
...
async function l1(n, e) {
  try {
    const t = Ii.fromButton(n);
    if (!t) throw new Error("Failed to create config from button");
    if (xr.setViewConfig(e, t), !await (async function(i) {
      try {
        const a = xr.getViewConfig(i);
        if (!a) throw new Error(`View configuration not found for viewId: ${i}`);
        return xr.setViewConfig(i, a), await bo.create(i, a);
      } catch {
        return null;
      }
    ...
    await (async function(i) {
      ...
      if (await (async function(i, a) {
        ...
        return d && xr.setupInfiniteScroll(i), d;
      })(e, t), !n.hasAttribute("data-initialized")) {
        const i = n.getAttribute("data-nzv-id");
        await Promise.all([_s.connectToRelays(t.relayUrls), xr.initializeSubscriptions(t, e), i ? Li.initializeStats(i, e, !0) : Promise.resolve()]), n.setAttribute("data-initialized", "true");
      }
    }), 0);
  } catch {
  }
...
function u1() {
  ...
  i == null && (i = function(o) {
    ...
    (function() {
      ...
      q = (function(x, C) {
        ...
        B && (C.setAttribute(x, ""), C = B.element, B.children.forEach(function(bt) {
          bt.setAttribute(x, "");
        }));
        var G, ne, oe, ye, ue, Ae, _e = Object.keys(_);
        for (G = 0; G < _e.length; G++) if (ne = _[_e[G]], oe = this[_e[G]], ne.apply) {
          if (oe instanceof Q) {
            ...
            if (ne.svgAttr !== "stroke" && ne.svgAttr !== "fill" || oe.indexOf("rgba") === -1) {
              ...
              ue = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?\.?\d*)\s*\)/gi, Ae = ue.exec(oe), C.setAttribute(ne.svgAttr, l("rgb({r},{g},{b})", {
                r: Ae[1],
                g: Ae[2],
                b: Ae[3]
              }));
        ...
        var C, B, G, ne, oe, ye, ue = new XMLSerializer().serializeToString(this.__root);
        if (ye = /xmlns="http:\/\/www\.w3\.org\/2000\/svg".+xmlns="http:\/\/www\.w3\.org\/2000\/svg/gi, ye.test(ue) && (ue = ue.replace('xmlns="http://www.w3.org/2000/svg', 'xmlns:xlink="http://www.w3.org/1999/xlink')), x) for (C = Object.keys(q), B = 0; B < C.length; B++) G = C[B], ne = q[G], oe = new RegExp(G, "gi"), oe.test(ue) && (ue = ue.replace(oe, ne));
        return ue;
      ...
      w.prototype.arcTo = function(x, C, B, G, ne) {
        ...
        if (oe !== void 0 && ye !== void 0) {
          ...
          if (ue[0] * Ae[1] == ue[1] * Ae[0]) return void this.lineTo(x, C);
          var _e = ue[0] * Ae[0] + ue[1] * Ae[1], xe = Math.acos(Math.abs(_e)), Se = K([
            ue[0] + Ae[0],
            ue[1] + Ae[1]
          ]), Oe = ne / Math.sin(xe / 2), bt = x + Oe * Se[0], D = C + Oe * Se[1], M = [
            -ue[1],
            ue[0]
          ], I = [
            Ae[1],
          ...
          this.lineTo(bt + M[0] * ne, D + M[1] * ne), this.arc(bt, D, ne, X, le);
        }
        ...
        if (G !== ne) {
          ...
          var ye = x + B * Math.cos(ne), ue = C + B * Math.sin(ne), Ae = x + B * Math.cos(G), _e = C + B * Math.sin(G), xe = oe ? 0 : 1, Se = 0, Oe = ne - G;
        ...
        var x, C, B, G, ne, oe, ye, ue, Ae, _e, xe, Se, Oe, bt, D = Array.prototype.slice.call(arguments), M = D[0], I = 0, Z = 0;
        ...
        var X = "translate(" + x + ", " + C + ")";
        if (M instanceof w) {
          if (ue = M.getSvg().cloneNode(!0), ue.childNodes && ue.childNodes.length > 1) {
            for (Ae = ue.childNodes[0]; Ae.childNodes.length; ) bt = Ae.childNodes[0].getAttribute("id"), this.__ids[bt] = bt, this.__defs.appendChild(Ae.childNodes[0]);
      ...
      l.prototype = {
        ...
        mapData: function(D, M) {
          for (var I = -1, Z = this.moduleCount - 1, X = 7, le = 0, we = this.moduleCount - 1; we > 0; we -= 2) for (we == 6 && we--; ; ) {
            for (var ae = 0; ae < 2; ae++) if (this.modules[Z][we - ae][0] == null) {
              ...
              var wt = _e.getMask(M, Z, we - ae);
              wt && (z = !z), this.modules[Z][we - ae][0] = z, X--, X == -1 && (le++, X = 7);
            }
        ...
        for (var I = 0, Z = 0, X = 0, le = new Array(M.length), we = new Array(M.length), ae = 0; ae < M.length; ae++) {
          var z = M[ae].dataCount, wt = M[ae].totalCount - z;
          Z = Math.max(Z, z), X = Math.max(X, wt), le[ae] = new Array(z);
          for (var et = 0; et < le[ae].length; et++) le[ae][et] = 255 & D.buffer[et + I];
          I += z;
          var Gt = _e.getErrorCorrectPolynomial(wt), qe = new f(le[ae], Gt.getLength() - 1), Tn = qe.mod(Gt);
          we[ae] = new Array(Gt.getLength() - 1);
          for (var et = 0; et < we[ae].length; et++) {
            var En = et + Tn.getLength() - we[ae].length;
            we[ae][et] = En >= 0 ? Tn.get(En) : 0;
          }
        }
        for (var Ar = 0, et = 0; et < M.length; et++) Ar += M[et].totalCount;
        for (var Pn = new Array(Ar), cn = 0, et = 0; et < Z; et++) for (var ae = 0; ae < M.length; ae++) et < le[ae].length && (Pn[cn++] = le[ae][et]);
        for (var et = 0; et < X; et++) for (var ae = 0; ae < M.length; ae++) et < we[ae].length && (Pn[cn++] = we[ae][et]);
        return Pn;
      };
      for (var ye = {
        MODE_NUMBER: 1,
        ...
        getLostPoint: function(D) {
          ...
          for (var Z = 0; Z < M - 1; Z++) for (var X = 0; X < M - 1; X++) {
            var wt = 0;
            D.isDark(Z, X) && wt++, D.isDark(Z + 1, X) && wt++, D.isDark(Z, X + 1) && wt++, D.isDark(Z + 1, X + 1) && wt++, wt != 0 && wt != 4 || (I += 3);
          }
      ...
      f.prototype = {
        ...
        for (var Z = I.length / 3, X = [], le = 0; le < Z; le++) for (var we = I[3 * le + 0], ae = I[3 * le + 1], z = I[3 * le + 2], wt = 0; wt < we; wt++) X.push(new p(ae, z));
        return X;
      ...
      var Oe = [
        ...
        function M(le, we) {
          ...
          if (ae._fFail = we, ae._fSuccess = le, ae._bSupportDataURI === null) {
            var z = document.createElement("img"), wt = function() {
              ae._bSupportDataURI = !1, ae._fFail && ae._fFail.call(ae);
            }, et = function() {
              ae._bSupportDataURI = !0, ae._fSuccess && ae._fSuccess.call(ae);
            };
            return z.onabort = wt, z.onerror = wt, z.onload = et, void (z.src = "data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==");
          }
        ...
        if (B._android && B._android <= 2.1) {
          ...
          CanvasRenderingContext2D.prototype.drawImage = function(le, we, ae, z, wt, et, Gt, qe, Tn) {
            if ("nodeName" in le && /img/i.test(le.nodeName)) for (var En = arguments.length - 1; En >= 1; En--) arguments[En] = arguments[En] * I;
            else qe === void 0 && (arguments[1] *= I, arguments[2] *= I, arguments[3] *= I, arguments[4] *= I);
        ...
        return X.prototype.draw = function(le) {
          function we() {
            z.quietZone > 0 && z.quietZoneColor && (qe.lineWidth = 0, qe.fillStyle = z.quietZoneColor, qe.fillRect(0, 0, Tn._elCanvas.width, z.quietZone), qe.fillRect(0, z.quietZone, z.quietZone, Tn._elCanvas.height - 2 * z.quietZone), qe.fillRect(Tn._elCanvas.width - z.quietZone, z.quietZone, z.quietZone, Tn._elCanvas.height - 2 * z.quietZone), qe.fillRect(0, Tn._elCanvas.height - z.quietZone, Tn._elCanvas.width, z.quietZone));
          }
          function ae(Ar) {
            function Pn(er) {
              var dn = Math.round(z.width / 3.5), Dn = Math.round(z.height / 3.5);
              dn !== Dn && (dn = Dn), z.logoMaxWidth ? dn = Math.round(z.logoMaxWidth) : z.logoWidth && (dn = Math.round(z.logoWidth)), z.logoMaxHeight ? Dn = Math.round(z.logoMaxHeight) : z.logoHeight && (Dn = Math.round(z.logoHeight));
              var Kr, Qr;
              er.naturalWidth === void 0 ? (Kr = er.width, Qr = er.height) : (Kr = er.naturalWidth, Qr = er.naturalHeight), (z.logoMaxWidth || z.logoMaxHeight) && (z.logoMaxWidth && Kr <= dn && (dn = Kr), z.logoMaxHeight && Qr <= Dn && (Dn = Qr), Kr <= dn && Qr <= Dn && (dn = Kr, Dn = Qr));
              var ba = (z.width + 2 * z.quietZone - dn) / 2, ma = (z.height + z.titleHeight + 2 * z.quietZone - Dn) / 2, xc = Math.min(dn / Kr, Dn / Qr), ya = Kr * xc, wa = Qr * xc;
              (z.logoMaxWidth || z.logoMaxHeight) && (dn = ya, Dn = wa, ba = (z.width + 2 * z.quietZone - dn) / 2, ma = (z.height + z.titleHeight + 2 * z.quietZone - Dn) / 2), z.logoBackgroundTransparent || (qe.fillStyle = z.logoBackgroundColor, qe.fillRect(ba, ma, dn, Dn));
              var Tp = qe.imageSmoothingQuality, Lp = qe.imageSmoothingEnabled;
              qe.imageSmoothingEnabled = !0, qe.imageSmoothingQuality = "high", qe.drawImage(er, ba + (dn - ya) / 2, ma + (Dn - wa) / 2, ya, wa), qe.imageSmoothingEnabled = Lp, qe.imageSmoothingQuality = Tp, we(), Ms._bIsPainted = !0, Ms.makeImage();
            }
            z.onRenderingStart && z.onRenderingStart(z);
            for (var cn = 0; cn < wt; cn++) for (var Ln = 0; Ln < wt; Ln++) {
              var Wr = Ln * et + z.quietZone, ms = cn * Gt + z.quietZone, vi = Ar.isDark(cn, Ln), bn = Ar.getEye(cn, Ln), zt = z.dotScale;
              qe.lineWidth = 0;
              var Xt, mn;
              bn ? (Xt = z[bn.type] || z[bn.type.substring(0, 2)] || z.colorDark, mn = z.colorLight) : z.backgroundImage ? (mn = "rgba(0,0,0,0)", cn == 6 ? z.autoColor ? (Xt = z.timing_H || z.timing || z.autoColorDark, mn = z.autoColorLight) : Xt = z.timing_H || z.timing || z.colorDark : Ln == 6 ? z.autoColor ? (Xt = z.timing_V || z.timing || z.autoColorDark, mn = z.autoColorLight) : Xt = z.timing_V || z.timing || z.colorDark : z.autoColor ? (Xt = z.autoColorDark, mn = z.autoColorLight) : Xt = z.colorDark) : (Xt = cn == 6 ? z.timing_H || z.timing || z.colorDark : Ln == 6 && (z.timing_V || z.timing) || z.colorDark, mn = z.colorLight), qe.strokeStyle = vi ? Xt : mn, qe.fillStyle = vi ? Xt : mn, bn ? (zt = bn.type == "AO" ? z.dotScaleAO : bn.type == "AI" ? z.dotScaleAI : 1, z.backgroundImage && z.autoColor ? (Xt = (bn.type == "AO" ? z.AI : z.AO) || z.autoColorDark, mn = z.autoColorLight) : Xt = (bn.type == "AO" ? z.AI : z.AO) || Xt, vi = bn.isDark, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)) : cn == 6 ? (zt = z.dotScaleTiming_H, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)) : Ln == 6 ? (zt = z.dotScaleTiming_V, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)) : (z.backgroundImage, qe.fillRect(Wr + et * (1 - zt) / 2, z.titleHeight + ms + Gt * (1 - zt) / 2, et * zt, Gt * zt)), z.dotScale == 1 || bn || (qe.strokeStyle = z.colorLight);
            }
            if (z.title && (qe.fillStyle = z.titleBackgroundColor, qe.fillRect(z.quietZone, z.quietZone, z.width, z.titleHeight), qe.font = z.titleFont, qe.fillStyle = z.titleColor, qe.textAlign = "center", qe.fillText(z.title, this._elCanvas.width / 2, +z.quietZone + z.titleTop)), z.subTitle && (qe.font = z.subTitleFont, qe.fillStyle = z.subTitleColor, qe.fillText(z.subTitle, this._elCanvas.width / 2, +z.quietZone + z.subTitleTop)), z.logo) {
              var Sr = new Image(), Ms = this;
              Sr.onload = function() {
                Pn(Sr);
              }, Sr.onerror = function(er) {
                console.error(er);
              }, z.crossOrigin != null && (Sr.crossOrigin = z.crossOrigin), Sr.originalSrc = z.logo, Sr.src = z.logo;
            } else we(), this._bIsPainted = !0, this.makeImage();
          }
          var z = this._htOption, wt = le.getModuleCount(), et = Math.round(z.width / wt), Gt = Math.round((z.height - z.titleHeight) / wt);
          et <= 1 && (et = 1), Gt <= 1 && (Gt = 1), z.width = et * wt, z.height = Gt * wt + z.titleHeight, z.quietZone = Math.round(z.quietZone), this._elCanvas.width = z.width + 2 * z.quietZone, this._elCanvas.height = z.height + 2 * z.quietZone, this._htOption.drawer != "canvas" && (this._oContext = new C2S(this._elCanvas.width, this._elCanvas.height)), this.clear();
          var qe = this._oContext;
          qe.lineWidth = 0, qe.fillStyle = z.colorLight, qe.fillRect(0, 0, this._elCanvas.width, this._elCanvas.height), qe.clearRect(z.quietZone, z.quietZone, z.width, z.titleHeight);
          var Tn = this;
          if (z.backgroundImage) {
            var En = new Image();
            En.onload = function() {
              qe.globalAlpha = 1, qe.globalAlpha = z.backgroundImageAlpha;
              var Ar = qe.imageSmoothingQuality, Pn = qe.imageSmoothingEnabled;
              qe.imageSmoothingEnabled = !0, qe.imageSmoothingQuality = "high", qe.drawImage(En, 0, z.titleHeight, z.width + 2 * z.quietZone, z.height + 2 * z.quietZone - z.titleHeight), qe.imageSmoothingEnabled = Pn, qe.imageSmoothingQuality = Ar, qe.globalAlpha = 1, ae.call(Tn, le);
            }, z.crossOrigin != null && (En.crossOrigin = z.crossOrigin), En.originalSrc = z.backgroundImage, En.src = z.backgroundImage;
          } else ae.call(Tn, le);
        ...
        return D.prototype.draw = function(M) {
          ...
          var ae = [], z = "", wt = Math.round(le * I.dotScale), et = Math.round(we * I.dotScale);
          wt < 4 && (wt = 4, et = 4);
          var Gt = I.colorDark, qe = I.colorLight;
          if (I.backgroundImage) {
            ...
            var Tn = '<div style="display:inline-block; z-index:-10;position:absolute;"><img src="' + I.backgroundImage + '" widht="' + (I.width + 2 * I.quietZone) + '" height="' + (I.height + 2 * I.quietZone) + '" style="opacity:' + I.backgroundImageAlpha + ";filter:alpha(opacity=" + 100 * I.backgroundImageAlpha + '); "/></div>';
            ae.push(Tn);
          }
          if (I.quietZone && (z = "display:inline-block; width:" + (I.width + 2 * I.quietZone) + "px; height:" + (I.width + 2 * I.quietZone) + "px;background:" + I.quietZoneColor + "; text-align:center;"), ae.push('<div style="font-size:0;' + z + '">'), ae.push('<table  style="font-size:0;border:0;border-collapse:collapse; margin-top:' + I.quietZone + 'px;" border="0" cellspacing="0" cellspadding="0" align="center" valign="middle">'), ae.push('<tr height="' + I.titleHeight + '" align="center"><td style="border:0;border-collapse:collapse;margin:0;padding:0" colspan="' + X + '">'), I.title) {
            var En = I.titleColor, Ar = I.titleFont;
            ae.push('<div style="width:100%;margin-top:' + I.titleTop + "px;color:" + En + ";font:" + Ar + ";background:" + I.titleBackgroundColor + '">' + I.title + "</div>");
          }
          ...
          for (var Pn = 0; Pn < X; Pn++) {
            ae.push('<tr style="border:0; padding:0; margin:0;" height="7">');
            for (var cn = 0; cn < X; cn++) {
              var Ln = M.isDark(Pn, cn), Wr = M.getEye(Pn, cn);
              if (Wr) {
                Ln = Wr.isDark;
                var ms = Wr.type, vi = I[ms] || I[ms.substring(0, 2)] || Gt;
                ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + 'px;"><span style="width:' + le + "px;height:" + we + "px;background-color:" + (Ln ? vi : qe) + ';display:inline-block"></span></td>');
              } else {
                var bn = I.colorDark;
                Pn == 6 ? (bn = I.timing_H || I.timing || Gt, ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + "px;background-color:" + (Ln ? bn : qe) + ';"></td>')) : cn == 6 ? (bn = I.timing_V || I.timing || Gt, ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + "px;background-color:" + (Ln ? bn : qe) + ';"></td>')) : ae.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + le + "px;height:" + we + 'px;"><div style="display:inline-block;width:' + wt + "px;height:" + et + "px;background-color:" + (Ln ? bn : I.colorLight) + ';"></div></td>');
              }
            }
            ae.push("</tr>");
          }
          if (ae.push("</table>"), ae.push("</div>"), I.logo) {
            ...
            var Xt = I.width / 3.5, mn = I.height / 3.5;
            Xt != mn && (Xt = mn), I.logoWidth && (Xt = I.logoWidth), I.logoHeight && (mn = I.logoHeight);
            var Sr = "position:relative; z-index:1;display:table-cell;top:-" + ((I.height - I.titleHeight) / 2 + mn / 2 + I.quietZone) + "px;text-align:center; width:" + Xt + "px; height:" + mn + "px;line-height:" + Xt + "px; vertical-align: middle;";
            I.logoBackgroundTransparent || (Sr += "background:" + I.logoBackgroundColor), ae.push('<div style="' + Sr + '"><img  src="' + I.logo + '"  style="max-width: ' + Xt + "px; max-height: " + mn + 'px;" /> <div style=" display: none; width:1px;margin-left: -1px;"></div></div>');
          }
          I.onRenderingStart && I.onRenderingStart(I), Z.innerHTML = ae.join("");
          var Ms = Z.childNodes[0], er = (I.width - Ms.offsetWidth) / 2, dn = (I.height - Ms.offsetHeight) / 2;
          er > 0 && dn > 0 && (Ms.style.margin = dn + "px " + er + "px"), this._htOption.onRenderingEnd && this._htOption.onRenderingEnd(this._htOption, null);
      ...
      K = function(D, M) {
        ...
        this._oDrawing = new bt(this._el, Z), this._htOption.text && this.makeCode(this._htOption.text);
  ...
  class O {
    ...
    equals(s) {
      F(s);
      const { x: l, y: u, z: f } = this, { x: p, y: _, z: w } = s, H = pe(f * f), Q = pe(w * w), q = pe(l * Q), K = pe(p * H), x = pe(pe(u * w) * Q), C = pe(pe(_ * f) * H);
      return q === K && x === C;
    }
    negate() {
      return new O(this.x, pe(-this.y), this.z);
    }
    double() {
      const { x: s, y: l, z: u } = this, f = pe(s * s), p = pe(l * l), _ = pe(p * p), w = s + p, H = pe(g * (pe(w * w) - f - _)), Q = pe(b * f), q = pe(Q * Q), K = pe(q - g * H), x = pe(Q * (H - K) - m * _), C = pe(g * l * u);
      return new O(K, x, C);
    }
    add(s) {
      F(s);
      ...
      if (l === d || u === d) return s;
      const H = pe(f * f), Q = pe(w * w), q = pe(l * Q), K = pe(p * H), x = pe(pe(u * w) * Q), C = pe(pe(_ * f) * H), B = pe(K - q), G = pe(C - x);
      if (B === d)
        return G === d ? this.double() : O.ZERO;
      const ne = pe(B * B), oe = pe(B * ne), ye = pe(q * ne), ue = pe(G * G - oe - g * ye), Ae = pe(G * (ye - ue) - x * oe), _e = pe(f * w * B);
      return new O(ue, Ae, _e);
    }
    subtract(s) {
    ...
    multiplyUnsafe(s) {
      ...
      return f && (H = H.negate()), _ && (Q = Q.negate()), Q = new O(pe(Q.x * A.beta), Q.y, Q.z), H.add(Q);
    }
    precomputeWindow(s) {
    ...
    multiply(s, l) {
      ...
      if (te) {
        ...
        q = k(_, q), x = k(H, x), x = new O(pe(x.x * A.beta), x.y, x.z), f = q.add(x), p = K.add(C);
      } else {
  ...
  class S {
    ...
    static fromSignature(s, l, u) {
      ...
      const _ = nn(Ze(s)), { n: w } = v, H = u === 2 || u === 3 ? f + w : f, Q = Kt(H, w), q = pe(-_ * Q, w), K = pe(p * Q, w), x = u & 1 ? "03" : "02", C = S.fromHex(x + Ie(H)), B = S.BASE.multiplyAndAddUnsafe(C, q, K);
      if (!B) throw new Error("Cannot recover signature: point at infinify");
      return B.assertValidity(), B;
    }
    toRawBytes(s = !1) {
      return We(this.toHex(s));
    }
    toHex(s = !1) {
      const l = Ie(this.x);
  ...
  function Ze(o) {
    return o instanceof Uint8Array ? Uint8Array.from(o) : We(o);
  }
  function pt(o) {
  ...
  function fn(o) {
    const { P: s } = v, l = BigInt(6), u = BigInt(11), f = BigInt(22), p = BigInt(23), _ = BigInt(44), w = BigInt(88), H = o * o * o % s, Q = H * H * o % s, q = it(Q, b) * Q % s, K = it(q, b) * Q % s, x = it(K, g) * H % s, C = it(x, u) * x % s, B = it(C, f) * C % s, G = it(B, _) * B % s, ne = it(G, w) * G % s, oe = it(ne, _) * B % s, ye = it(oe, b) * Q % s, ue = it(ye, p) * C % s, Ae = it(ue, l) * H % s, _e = it(Ae, g);
  ...
  function tt(o, s, l, u = !0) {
    ...
    if (!Ye(p)) return;
    const _ = Kt(p, f), w = S.BASE.multiply(p), H = pe(w.x, f);
    if (H === d) return;
  ...
  function Qt(o, s, l = !1) {
    if (Ut(o)) throw new TypeError("getSharedSecret: first arg must be private key");
    if (!Ut(s)) throw new TypeError("getSharedSecret: second arg must be public key");
    const u = ht(s);
  ...
  function At(o, s, l = {}) {
    const { seed: u, m: f, d: p } = kn(o, s, l.extraEntropy), _ = new Be(U, L);
    _.reseedSync(u);
    let w;
  ...
  function Nt(o, s, l, u = Yt) {
    ...
    const { n: Q } = v, q = Kt(_, Q), K = pe(w * q, Q), x = pe(p * q, Q), C = S.BASE.multiplyAndAddUnsafe(H, K, x);
    return C ? pe(C.x, Q) === p : !1;
  }
  function $t(o) {
    return pe(ke(o), v.n);
  }
  ...
  class gn {
    constructor(s, l, u = Ke.randomBytes()) {
      ...
      if (this.px = f, this.d = p, this.rand = Ze(u), this.rand.length !== 32) throw new TypeError("sign: Expected 32 bytes of aux randomness");
    }
    getScalar(s) {
    ...
    async calc() {
      const { m: s, d: l, px: u, rand: f } = this, p = Ke.taggedHash, _ = this.initNonce(l, await p(ln.aux, f)), { R: w, rx: H, k: Q } = this.finalizeNonce(await p(ln.nonce, _, u, s)), q = $t(await p(ln.challenge, H, u, s)), K = this.finalizeSig(w, Q, q, l);
      return await Sn(K, s, u) || this.error(), K;
    }
    calcSync() {
      const { m: s, d: l, px: u, rand: f } = this, p = Ke.taggedHashSync, _ = this.initNonce(l, p(ln.aux, f)), { R: w, rx: H, k: Q } = this.finalizeNonce(p(ln.nonce, _, u, s)), q = $t(p(ln.challenge, H, u, s)), K = this.finalizeSig(w, Q, q, l);
      return qn(K, s, u) || this.error(), K;
    }
  }
  async function Qn(o, s, l) {
    return new gn(o, s, l).calc();
  }
  function ar(o, s, l) {
    return new gn(o, s, l).calcSync();
  }
  function Hn(o, s, l) {
  ...
  function Bn(o, s, l, u) {
    const f = S.BASE.multiplyAndAddUnsafe(s, Je(l), pe(-u, v.n));
    return !(!f || !f.hasEvenY() || f.x !== o);
  }
  async function Sn(o, s, l) {
    try {
      const { r: u, s: f, m: p, P: _ } = Hn(o, s, l), w = $t(await Ke.taggedHash(ln.challenge, $e(u), _.toRawX(), p));
      return Bn(u, _, f, w);
    } catch {
      return !1;
    }
  ...
  function qn(o, s, l) {
    try {
      const { r: u, s: f, m: p, P: _ } = Hn(o, s, l), w = $t(Ke.taggedHashSync(ln.challenge, $e(u), _.toRawX(), p));
      return Bn(u, _, f, w);
    } catch (u) {
  ...
  const It = {
    ...
    randomBytes: (o = 32) => {
      if (It.web) return It.web.getRandomValues(new Uint8Array(o));
      if (It.node) {
        const { randomBytes: s } = It.node;
    ...
    sha256: async (...o) => {
      if (It.web) {
        const s = await It.web.subtle.digest("SHA-256", re(...o));
        return new Uint8Array(s);
      } else if (It.node) {
        const { createHash: s } = It.node, l = s("sha256");
    ...
    hmacSha256: async (o, ...s) => {
      if (It.web) {
        const l = await It.web.subtle.importKey("raw", o, {
          name: "HMAC",
          hash: {
            name: "SHA-256"
          }
          ...
          "sign"
        ]), u = re(...s), f = await It.web.subtle.sign("HMAC", l, u);
        return new Uint8Array(f);
      } else if (It.node) {
        const { createHmac: l } = It.node, u = l("sha256", o);
    ...
    taggedHashSync: (o, ...s) => {
      if (typeof pn != "function") throw new ee("sha256Sync is undefined, you need to set it");
      let l = Fn[o];
      if (l === void 0) {
        const u = pn(Uint8Array.from(o, (f) => f.charCodeAt(0)));
        l = re(u, u), Fn[o] = l;
      }
      return pn(l, ...s);
    },
  ...
  Object.defineProperty(ce, "__esModule", {
    value: !0
  }), ce.randomBytes = ce.wrapConstructorWithOpts = ce.wrapConstructor = ce.checkOpts = ce.Hash = ce.concatBytes = ce.toBytes = ce.utf8ToBytes = ce.asyncLoop = ce.nextTick = ce.hexToBytes = ce.bytesToHex = ce.isLE = ce.rotr = ce.createView = ce.u32 = ce.u8 = void 0;
  var Tt = {};
  Object.defineProperty(Tt, "__esModule", {
    value: !0
  }), Tt.crypto = void 0, Tt.crypto = {
    node: void 0,
    web: typeof self == "object" && "crypto" in self ? self.crypto : void 0
  };
  const kr = (o) => new Uint8Array(o.buffer, o.byteOffset, o.byteLength);
  ce.u8 = kr;
  const Xs = (o) => new Uint32Array(o.buffer, o.byteOffset, Math.floor(o.byteLength / 4));
  ce.u32 = Xs;
  const ks = (o) => new DataView(o.buffer, o.byteOffset, o.byteLength);
  ce.createView = ks;
  const As = (o, s) => o << 32 - s | o >>> s;
  if (ce.rotr = As, ce.isLE = new Uint8Array(new Uint32Array([
    287454020
  ]).buffer)[0] === 68, !ce.isLE) throw new Error("Non little-endian hardware is not supported");
  const Js = Array.from({
    length: 256
  }, (o, s) => s.toString(16).padStart(2, "0"));
  function Ss(o) {
    ...
    let s = "";
    for (let l = 0; l < o.length; l++) s += Js[o[l]];
    return s;
  }
  ce.bytesToHex = Ss;
  function Ni(o) {
  ...
  async function Mi(o, s, l) {
    ...
    for (let f = 0; f < o; f++) {
      l(f);
      const p = Date.now() - u;
      p >= 0 && p < s || (await (0, ce.nextTick)(), u += p);
    }
  }
  ce.asyncLoop = Mi;
  function Cs(o) {
  ...
  ce.checkOpts = qo;
  function jo(o) {
    const s = (u) => o().update(ti(u)).digest(), l = o();
    return s.outputLen = l.outputLen, s.blockLen = l.blockLen, s.create = () => o(), s;
  }
  ce.wrapConstructor = jo;
  function ni(o) {
    const s = (u, f) => o(f).update(ti(u)).digest(), l = o({});
    return s.outputLen = l.outputLen, s.blockLen = l.blockLen, s.create = (u) => o(u), s;
  }
  ce.wrapConstructorWithOpts = ni;
  function ri(o = 32) {
    if (Tt.crypto.web) return Tt.crypto.web.getRandomValues(new Uint8Array(o));
    if (Tt.crypto.node) return new Uint8Array(Tt.crypto.node.randomBytes(o).buffer);
  ...
  class si extends ce.Hash {
    constructor(s, l, u, f) {
      super(), this.blockLen = s, this.outputLen = l, this.padOffset = u, this.isLE = f, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(s), this.view = (0, ce.createView)(this.buffer);
    }
    update(s) {
    ...
    digestInto(s) {
      ...
      const w = (0, ce.createView)(s), H = this.outputLen;
      if (H % 4) throw new Error("_sha2: outputLen should be aligned to 32bit");
  ...
  xn.SHA2 = si;
  const Ui = (o, s, l) => o & s ^ ~o & l, ii = (o, s, l) => o & s ^ o & l ^ s & l, Fo = new Uint32Array([
    1116352408,
    1899447441,
    3049323471,
    3921009573,
  ...
  class Pi extends xn.SHA2 {
    constructor() {
      super(64, 32, 8, !1), this.A = lr[0] | 0, this.B = lr[1] | 0, this.C = lr[2] | 0, this.D = lr[3] | 0, this.E = lr[4] | 0, this.F = lr[5] | 0, this.G = lr[6] | 0, this.H = lr[7] | 0;
    }
    get() {
    ...
    process(s, l) {
      for (let K = 0; K < 16; K++, l += 4) Yn[K] = s.getUint32(l, !1);
      for (let K = 16; K < 64; K++) {
        const x = Yn[K - 15], C = Yn[K - 2], B = (0, ce.rotr)(x, 7) ^ (0, ce.rotr)(x, 18) ^ x >>> 3, G = (0, ce.rotr)(C, 17) ^ (0, ce.rotr)(C, 19) ^ C >>> 10;
        Yn[K] = G + Yn[K - 7] + B + Yn[K - 16] | 0;
      }
      let { A: u, B: f, C: p, D: _, E: w, F: H, G: Q, H: q } = this;
      for (let K = 0; K < 64; K++) {
        const x = (0, ce.rotr)(w, 6) ^ (0, ce.rotr)(w, 11) ^ (0, ce.rotr)(w, 25), C = q + x + Ui(w, H, Q) + Fo[K] + Yn[K] | 0, G = ((0, ce.rotr)(u, 2) ^ (0, ce.rotr)(u, 13) ^ (0, ce.rotr)(u, 22)) + ii(u, f, p) | 0;
  ...
  Pt.sha256 = (0, ce.wrapConstructor)(() => new Pi()), Pt.sha224 = (0, ce.wrapConstructor)(() => new zi());
  function cr(o) {
  ...
  function Un(o) {
    return {
      encode: (s) => {
        ...
        return s.map((l) => {
          if (cr(l), l < 0 || l >= o.length) throw new Error(`Digit index outside alphabet: ${l} (alphabet: ${o.length})`);
          return o[l];
        });
      },
      decode: (s) => {
  ...
  function ps(o, s = "=") {
    if (cr(o), typeof s != "string") throw new Error("padding chr should be string");
    return {
      encode(l) {
  ...
  function oi(o, s, l) {
    ...
    for (p.forEach((_) => {
      if (cr(_), _ < 0 || _ >= s) throw new Error(`Wrong integer: ${_}`);
    }); ; ) {
      let _ = 0, w = !0;
  ...
  const qi = (o, s) => s ? qi(s, o % s) : o, Pr = (o, s) => o + (s - qi(o, s));
  function Is(o, s, l, u) {
    ...
    if (Pr(s, l) > 32) throw new Error(`convertRadix2: carry overflow from=${s} to=${l} carryBits=${Pr(s, l)}`);
    let f = 0, p = 0;
    const _ = 2 ** l - 1, w = [];
    for (const H of o) {
      if (cr(H), H >= 2 ** s) throw new Error(`convertRadix2: invalid data word=${H} from=${s}`);
  ...
  function Ts(o) {
    return cr(o), {
      encode: (s) => {
        ...
        return oi(Array.from(s), 256, o);
      },
      decode: (s) => {
        if (!Array.isArray(s) || s.length && typeof s[0] != "number") throw new Error("radix.decode input should be array of strings");
        return Uint8Array.from(oi(s, o, 256));
      }
    };
  }
  function Xn(o, s = !1) {
    if (cr(o), o <= 0 || o > 32) throw new Error("radix2: bits should be in (0..32]");
    if (Pr(8, o) > 32 || Pr(o, 8) > 32) throw new Error("radix2: carry overflow");
    return {
      encode: (l) => {
  ...
  function ji(o, s) {
    if (cr(o), typeof s != "function") throw new Error("checksum fn should be function");
    return {
      encode(l) {
  ...
  const zr = {
    ...
    join: Cn,
    padding: ps
  }, li = _n(Xn(4), Un("0123456789ABCDEF"), Cn("")), ci = _n(Xn(5), Un("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), ps(5), Cn(""));
  _n(Xn(5), Un("0123456789ABCDEFGHIJKLMNOPQRSTUV"), ps(5), Cn("")), _n(Xn(5), Un("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), Cn(""), Hi((o) => o.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1")));
  const Hr = _n(Xn(6), Un("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), ps(6), Cn("")), di = _n(Xn(6), Un("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), ps(6), Cn("")), ui = (o) => _n(Ts(58), Un(o), Cn("")), Ls = ui("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz");
  ui("123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"), ui("rpshnaf39wBUDNEGHJKLM4PQRST7VWXYZ2bcdeCg65jkm8oFqi1tuvAxyz");
  const dr = [
    0,
    2,
    3,
    ...
    encode(o) {
      ...
      for (let l = 0; l < o.length; l += 8) {
        ...
        s += Ls.encode(u).padStart(dr[u.length], "1");
      }
      return s;
    },
    decode(o) {
      ...
      for (let l = 0; l < o.length; l += 11) {
        const u = o.slice(l, l + 11), f = dr.indexOf(u.length), p = Ls.decode(u);
  ...
  }, Zo = (o) => _n(ji(4, (s) => o(o(s))), Ls), hi = _n(Un("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), Cn("")), Zi = [
    996825010,
    642813549,
    513874426,
    1027748829,
  ...
  function Pe(o, s, l = 1) {
    ...
    return f ^= l, hi.encode(Is([
      f % 2 ** 30
    ], 30, 5, !1));
  }
  function De(o) {
    const s = o === "bech32" ? 1 : 734539939, l = Xn(5), u = l.decode, f = l.encode, p = ai(u);
    function _(q, K, x = 90) {
      ...
      return q = q.toLowerCase(), `${q}1${hi.encode(K)}${Pe(q, K, s)}`;
    }
    function w(q, K = 90) {
      ...
      const ne = hi.decode(G).slice(0, -6), oe = Pe(B, ne, s);
  ...
  }, ut = _n(Xn(4), Un("0123456789abcdef"), Cn(""), Hi((o) => {
  ...
  Object.defineProperty(ft, "__esModule", {
    value: !0
  }), ft.wordlist = void 0, ft.wordlist = `abandon
ability
able
about
above
...
`);
  ...
  Object.defineProperty(vt, "__esModule", {
    value: !0
  }), vt.pbkdf2Async = vt.pbkdf2 = void 0;
  var _t = {};
  Object.defineProperty(_t, "__esModule", {
    value: !0
  }), _t.hmac = void 0;
  class Ft extends ce.Hash {
    constructor(s, l) {
      super(), this.finished = !1, this.destroyed = !1, st.default.hash(s);
      const u = (0, ce.toBytes)(l);
  ...
  const vn = (o, s, l) => new Ft(o, s).update(l).digest();
  _t.hmac = vn, _t.hmac.create = (o, s) => new Ft(o, s);
  function gs(o, s, l, u) {
    st.default.hash(o);
    const f = (0, ce.checkOpts)({
      dkLen: 32,
      asyncTick: 10
    ...
    const H = (0, ce.toBytes)(s), Q = (0, ce.toBytes)(l), q = new Uint8Array(_), K = _t.hmac.create(o, H), x = K._cloneInto().update(Q);
    return {
      c: p,
      dkLen: _,
      asyncTick: w,
  ...
  function Jn(o, s, l, u, f) {
    return o.destroy(), s.destroy(), u && u.destroy(), f.fill(0), l;
  }
  function ur(o, s, l, u) {
    const { c: f, dkLen: p, DK: _, PRF: w, PRFSalt: H } = gs(o, s, l, u);
    let Q;
    const q = new Uint8Array(4), K = (0, ce.createView)(q), x = new Uint8Array(w.outputLen);
  ...
  vt.pbkdf2 = ur;
  async function qr(o, s, l, u) {
    const { c: f, dkLen: p, asyncTick: _, DK: w, PRF: H, PRFSalt: Q } = gs(o, s, l, u);
    let q;
    const K = new Uint8Array(4), x = (0, ce.createView)(K), C = new Uint8Array(H.outputLen);
    for (let B = 1, G = 0; G < p; B++, G += H.outputLen) {
      const ne = w.subarray(G, G + H.outputLen);
      x.setInt32(0, B, !1), (q = Q._cloneInto(q)).update(K).digestInto(C), ne.set(C.subarray(0, ne.length)), await (0, ce.asyncLoop)(f - 1, _, (oe) => {
  ...
  const vs = BigInt(2 ** 32 - 1), fi = BigInt(32);
  function Ds(o, s = !1) {
    return s ? {
      h: Number(o & vs),
      l: Number(o >> fi & vs)
  ...
  ze.split = jr;
  const Fr = (o, s) => BigInt(o >>> 0) << fi | BigInt(s >>> 0);
  ze.toBig = Fr;
  const Vi = (o, s, l) => o >>> l, Vo = (o, s, l) => o << 32 - l | s >>> l, Go = (o, s, l) => o >>> l | s << 32 - l, Vt = (o, s, l) => o << 32 - l | s >>> l, Zn = (o, s, l) => o << 64 - l | s >>> l - 32, hr = (o, s, l) => o >>> l - 32 | s << 64 - l, pi = (o, s) => s, Wo = (o, s) => o, Ko = (o, s, l) => o << l | s >>> 32 - l, Qo = (o, s, l) => s << l | o >>> 32 - l, Yo = (o, s, l) => s << l - 32 | o >>> 64 - l, Xo = (o, s, l) => o << l - 32 | s >>> 64 - l;
  function Gi(o, s, l, u) {
    const f = (s >>> 0) + (u >>> 0);
    return {
      h: o + l + (f / 2 ** 32 | 0) | 0,
  ...
  const [Hh, qh] = ze.default.split([
    ...
    "0x5fcb6fab3ad6faec",
    "0x6c44198c4a475817"
  ].map((o) => BigInt(o))), Zr = new Uint32Array(80), Vr = new Uint32Array(80);
  class gi extends xn.SHA2 {
    constructor() {
    ...
    process(s, l) {
      for (let ue = 0; ue < 16; ue++, l += 4)
        Zr[ue] = s.getUint32(l), Vr[ue] = s.getUint32(l += 4);
      for (let ue = 16; ue < 80; ue++) {
        const Ae = Zr[ue - 15] | 0, _e = Vr[ue - 15] | 0, xe = ze.default.rotrSH(Ae, _e, 1) ^ ze.default.rotrSH(Ae, _e, 8) ^ ze.default.shrSH(Ae, _e, 7), Se = ze.default.rotrSL(Ae, _e, 1) ^ ze.default.rotrSL(Ae, _e, 8) ^ ze.default.shrSL(Ae, _e, 7), Oe = Zr[ue - 2] | 0, bt = Vr[ue - 2] | 0, D = ze.default.rotrSH(Oe, bt, 19) ^ ze.default.rotrBH(Oe, bt, 61) ^ ze.default.shrSH(Oe, bt, 6), M = ze.default.rotrSL(Oe, bt, 19) ^ ze.default.rotrBL(Oe, bt, 61) ^ ze.default.shrSL(Oe, bt, 6), I = ze.default.add4L(Se, M, Vr[ue - 7], Vr[ue - 16]), Z = ze.default.add4H(I, xe, D, Zr[ue - 7], Zr[ue - 16]);
        Zr[ue] = Z | 0, Vr[ue] = I | 0;
      }
      let { Ah: u, Al: f, Bh: p, Bl: _, Ch: w, Cl: H, Dh: Q, Dl: q, Eh: K, El: x, Fh: C, Fl: B, Gh: G, Gl: ne, Hh: oe, Hl: ye } = this;
      for (let ue = 0; ue < 80; ue++) {
        const Ae = ze.default.rotrSH(K, x, 14) ^ ze.default.rotrSH(K, x, 18) ^ ze.default.rotrBH(K, x, 41), _e = ze.default.rotrSL(K, x, 14) ^ ze.default.rotrSL(K, x, 18) ^ ze.default.rotrBL(K, x, 41), xe = K & C ^ ~K & G, Se = x & B ^ ~x & ne, Oe = ze.default.add5L(ye, _e, Se, qh[ue], Vr[ue]), bt = ze.default.add5H(Oe, oe, Ae, xe, Hh[ue], Zr[ue]), D = Oe | 0, M = ze.default.rotrSH(u, f, 28) ^ ze.default.rotrBH(u, f, 34) ^ ze.default.rotrBH(u, f, 39), I = ze.default.rotrSL(u, f, 28) ^ ze.default.rotrBL(u, f, 34) ^ ze.default.rotrBL(u, f, 39), Z = u & p ^ u & w ^ p & w, X = f & _ ^ f & H ^ _ & H;
        oe = G | 0, ye = ne | 0, G = C | 0, ne = B | 0, C = K | 0, B = x | 0, { h: K, l: x } = ze.default.add(Q | 0, q | 0, bt | 0, D | 0), Q = w | 0, q = H | 0, w = p | 0, H = _ | 0, p = u | 0, _ = f | 0;
        const le = ze.default.add3L(D, I, X);
        u = ze.default.add3H(le, bt, M, Z), f = le | 0;
      }
      ({ h: u, l: f } = ze.default.add(this.Ah | 0, this.Al | 0, u | 0, f | 0)), { h: p, l: _ } = ze.default.add(this.Bh | 0, this.Bl | 0, p | 0, _ | 0), { h: w, l: H } = ze.default.add(this.Ch | 0, this.Cl | 0, w | 0, H | 0), { h: Q, l: q } = ze.default.add(this.Dh | 0, this.Dl | 0, Q | 0, q | 0), { h: K, l: x } = ze.default.add(this.Eh | 0, this.El | 0, K | 0, x | 0), { h: C, l: B } = ze.default.add(this.Fh | 0, this.Fl | 0, C | 0, B | 0), { h: G, l: ne } = ze.default.add(this.Gh | 0, this.Gl | 0, G | 0, ne | 0), { h: oe, l: ye } = ze.default.add(this.Hh | 0, this.Hl | 0, oe | 0, ye | 0), this.set(u, f, p, _, w, H, Q, q, K, x, C, B, G, ne, oe, ye);
    }
    roundClean() {
      Zr.fill(0), Vr.fill(0);
    }
  ...
  Zt.sha512 = (0, ce.wrapConstructor)(() => new gi()), Zt.sha512_224 = (0, ce.wrapConstructor)(() => new jh()), Zt.sha512_256 = (0, ce.wrapConstructor)(() => new Fh()), Zt.sha384 = (0, ce.wrapConstructor)(() => new Zh());
  ...
  function Gh(o, s = 128) {
    ...
    return Kl((0, ce.randomBytes)(s / 8), o);
  }
  ...
  function Gl(o) {
    ...
    }), zr.chain(zr.checksum(1, Wh), zr.radix2(11, !0), zr.alphabet(o));
  }
  function Wl(o, s) {
  ...
  function Qh(o, s = "") {
    return (0, vt.pbkdf2Async)(Zt.sha512, ea(o).nfkd, Ql(s), {
      c: 2048,
      dkLen: 64
    });
  }
  ...
  function Yh(o, s = "") {
    return (0, vt.pbkdf2)(Zt.sha512, ea(o).nfkd, Ql(s), {
      c: 2048,
      dkLen: 64
    });
  }
  ...
  class ec extends xn.SHA2 {
    ...
    process(s, l) {
      ...
      for (let C = 0; C < 5; C++) {
        const B = 4 - C, G = nf[C], ne = rf[C], oe = ta[C], ye = na[C], ue = ef[C], Ae = tf[C];
        for (let _e = 0; _e < 16; _e++) {
          const xe = Wi(u + Jl(C, p, w, Q) + Ki[oe[_e]] + G, ue[_e]) + K | 0;
  ...
  Os.RIPEMD160 = ec, Os.ripemd160 = (0, ce.wrapConstructor)(() => new ec()), Ke.hmacSha256Sync = (o, ...s) => (0, _t.hmac)(Pt.sha256, o, Ke.concatBytes(...s));
  const ra = Zo(Pt.sha256);
  function tc(o) {
    return BigInt(`0x${(0, ce.bytesToHex)(o)}`);
  }
  function sf(o) {
    return (0, ce.hexToBytes)(o.toString(16).padStart(64, "0"));
  }
  const of = (0, ce.utf8ToBytes)("Bitcoin seed"), sa = {
    private: 76066276,
    public: 76067358
  }, ia = 2147483648, af = (o) => (0, Os.ripemd160)((0, Pt.sha256)(o)), lf = (o) => (0, ce.createView)(o).getUint32(0, !1), Qi = (o) => {
    if (!Number.isSafeInteger(o) || o < 0 || o > 2 ** 32 - 1) throw new Error(`Invalid number=${o}. Should be from 0 to 2 ** 32 - 1`);
    const s = new Uint8Array(4);
    return (0, ce.createView)(s).setUint32(0, o, !1), s;
  };
  class bs {
    constructor(s) {
      ...
      if (s.privateKey) {
        ...
        this.privKey = typeof s.privateKey == "bigint" ? s.privateKey : tc(s.privateKey), this.privKeyBytes = sf(this.privKey), this.pubKey = Et(s.privateKey, !0);
    ...
    get privateExtendedKey() {
      ...
      return ra.encode(this.serialize(this.versions.private, (0, ce.concatBytes)(new Uint8Array([
        0
      ]), s)));
    }
    ...
    static fromMasterSeed(s, l = sa) {
      ...
      const u = (0, _t.hmac)(Zt.sha512, of, s);
      return new bs({
        versions: l,
    ...
    static fromExtendedKey(s, l = sa) {
      const u = ra.decode(s), f = (0, ce.createView)(u), p = f.getUint32(0, !1), _ = {
        versions: l,
        depth: u[4],
    ...
    deriveChild(s) {
      ...
      if (s >= ia) {
        ...
        l = (0, ce.concatBytes)(new Uint8Array([
          0
        ]), w, l);
      } else l = (0, ce.concatBytes)(this.pubKey, l);
      const u = (0, _t.hmac)(Zt.sha512, this.chainCode, l), f = tc(u.slice(0, 32)), p = u.slice(32);
    ...
    sign(s) {
      ...
      return (0, st.bytes)(s, 32), At(s, this.privKey, {
        canonical: !0,
        der: !1
      });
    }
    ...
    serialize(s, l) {
      ...
      return (0, st.bytes)(l, 33), (0, ce.concatBytes)(Qi(s), new Uint8Array([
        this.depth
      ]), Qi(this.parentFingerprint), Qi(this.index), this.chainCode, l);
    }
  }
  var cf = Object.defineProperty, In = (o, s) => {
  ...
  function nc(o) {
    return Ke.bytesToHex(jn.getPublicKey(o));
  }
  var uf = {};
  In(uf, {
  ...
  var Gr = new TextDecoder("utf-8"), fr = new TextEncoder();
  function oa(o) {
    let s = new URL(o);
  ...
  function aa(o) {
    let s = (0, Pt.sha256)(fr.encode(gf(o)));
  ...
  function rc(o) {
    return jn.verifySync(o.sig, aa(o), o.pubkey);
  }
  function bf(o, s) {
    return Ke.bytesToHex(jn.signSync(aa(o), s));
  }
  function mf(o, s) {
  ...
  function $f(o, s = {}) {
    ...
    const G = (oe, { verb: ye = "REQ", skipVerification: ue = !1, alreadyHaveEvent: Ae = null, id: _e = Math.random().toString().slice(2) } = {}) => {
      let xe = _e;
      return _[xe] = {
        id: xe,
        filters: oe,
        ...
        sub: (Se, Oe = {}) => G(Se || oe, {
          skipVerification: Oe.skipVerification || ue,
        ...
        off: (Se, Oe) => {
          let bt = H[xe], D = bt[Se].indexOf(Oe);
          D >= 0 && bt[Se].splice(D, 1);
        }
      };
    };
    function ne(oe, ye) {
    ...
    return {
      ...
      off: (oe, ye) => {
        let ue = w[oe].indexOf(ye);
        ue !== -1 && w[oe].splice(ue, 1);
      },
      list: (oe, ye) => new Promise((ue) => {
      ...
      count: (oe) => new Promise((ye) => {
        ...
        ue.on("count", (_e) => {
          ue.unsub(), clearTimeout(Ae), ye(_e);
        });
      }),
      publish(oe) {
        return ne(oe, "EVENT");
  ...
  var Ns = 5e3;
  function Xi(o) {
    let { prefix: s, words: l } = Fe.decode(o, Ns), u = new Uint8Array(Fe.fromWords(l));
    switch (s) {
      case "nprofile": {
        let f = Ji(u);
        ...
        return {
          ...
          data: {
            ...
            relays: f[1] ? f[1].map((p) => Gr.decode(p)) : []
          }
        };
      }
      case "nevent": {
  ...
  function da(o, s) {
    let l = Ke.hexToBytes(s), u = Fe.toWords(l);
    return Fe.encode(o, u, Ns);
  }
  function Cf(o) {
    let s = eo({
      0: [
      ...
      1: (o.relays || []).map((u) => fr.encode(u))
    }), l = Fe.toWords(s);
    return Fe.encode("nprofile", l, Ns);
  }
  function If(o) {
    let s = eo({
      0: [
  ...
  function Tf(o) {
    ...
    let l = eo({
      0: [
        fr.encode(o.identifier)
      ],
      1: (o.relays || []).map((f) => fr.encode(f)),
      2: [
        Ke.hexToBytes(o.pubkey)
      ],
      3: [
  ...
  async function Of(o, s, l) {
    const u = Qt(o, "02" + s), f = lc(u);
    let p = Uint8Array.from((0, ce.randomBytes)(16)), _ = fr.encode(l), w = await crypto.subtle.importKey("raw", f, {
      name: "AES-CBC"
    }, !1, [
      "encrypt"
      ...
      name: "AES-CBC",
      iv: p
    }, w, _), Q = Hr.encode(new Uint8Array(H)), q = Hr.encode(new Uint8Array(p.buffer));
    return `${Q}?iv=${q}`;
  }
  async function Nf(o, s, l) {
    let [u, f] = l.split("?iv="), p = Qt(o, "02" + s), _ = lc(p), w = await crypto.subtle.importKey("raw", _, {
      name: "AES-CBC"
    }, !1, [
      "decrypt"
    ]), H = Hr.decode(u), Q = Hr.decode(f), q = await crypto.subtle.decrypt({
      name: "AES-CBC",
      iv: Q
    }, w, H);
    return Gr.decode(q);
  ...
  function Hf() {
    return (0, dt.generateMnemonic)(ft.wordlist);
  }
  function qf(o) {
    return (0, dt.validateMnemonic)(o, ft.wordlist);
  }
  var jf = {};
  In(jf, {
    parse: () => Ff
  ...
  function Jf(o, s) {
    ...
    let f = (0, Pt.sha256)(fr.encode(`nostr:delegation:${s.pubkey}:${u}`)), p = Ke.bytesToHex(jn.signSync(f, o));
    return {
      from: nc(o),
      to: s.pubkey,
      cond: u,
  ...
  function ep(o) {
    ...
    let _ = (0, Pt.sha256)(fr.encode(`nostr:delegation:${o.pubkey}:${u}`));
    return jn.verifySync(f, _, l) ? l : null;
  }
  var tp = {};
  In(tp, {
    matchAll: () => np,
  ...
  async function dp(o) {
    try {
      ...
      if (l) {
        let { words: _ } = Fe.decode(l, 1e3), w = Fe.fromWords(_);
        s = Gr.decode(w);
      } else if (u) {
        let [_, w] = u.split("@");
  ...
  Ke.hmacSha256Sync = (o, ...s) => (0, _t.hmac)(Pt.sha256, o, Ke.concatBytes(...s)), Ke.sha256Sync = (...o) => (0, Pt.sha256)(Ke.concatBytes(...o));
  ...
  const Ap = (o) => {
    ...
    const p = (Se) => `${Se.substring(0, 12)}...${Se.substring(Se.length - 12)}`, _ = l ? l.split(",") : [
      ...
      const { picture: Se, display_name: Oe, name: bt } = vp(await H);
      return `
      <h2>${Oe || bt}</h2>
        <img
          src="${Se || Q}"
    ...
    return C.addEventListener("submit", async function(Se) {
      ...
      const Oe = Number(B.value) * 1e3, bt = G.value;
      try {
        const D = await wp({
...
u1();
var h1 = je('<div class="rotate-right-icon svg-icon svelte-1x7qm6n"></div> <span class="btn-text"> </span>', 1), f1 = je('<span class="relay-toggle-icon svelte-1x7qm6n" aria-label="toggle"><!></span> ', 1), p1 = je('<span class="relay-check-icon svg-icon svelte-1x7qm6n" aria-hidden="true"></span>'), g1 = je('<span class="relay-check-icon svg-icon svelte-1x7qm6n" aria-hidden="true"></span>'), v1 = je('<div class="relay-copy-icon svg-icon svelte-1x7qm6n" aria-hidden="true"></div>'), b1 = je('<li class="svelte-1x7qm6n"><span class="relay-url svelte-1x7qm6n"> </span> <span><!></span> <span><!></span> <div class="relay-copy-cell svelte-1x7qm6n"><!></div></li>'), m1 = je('<div class="relay-list-header svelte-1x7qm6n" aria-hidden="true"><span> </span> <span> </span> <span> </span> <span class="relay-copy-column" aria-hidden="true"></span></div> <ul class="svelte-1x7qm6n"></ul>', 1), y1 = je('<span style="color: #888;"> </span>'), w1 = je('<div class="relay-list svelte-1x7qm6n"><!></div>'), x1 = je('<div class="setting-section"><div class="setting-row"><span class="setting-label"> </span> <div class="setting-control"><!></div></div> <div class="setting-info svelte-1x7qm6n"><!> <!></div></div>');
const _1 = {
  hash: "svelte-1x7qm6n",
...
function Dh(n, e) {
  ...
  var J = se(A, 2), ie = R(J);
  {
    ...
    Mt(ie, {
      ...
      children: (k, $) => {
        ...
        N(j);
        var re = se(j);
        Ve((de) => ge(re, ` ${de ?? ""}`), [() => t()("settingsDialog.relay_list") || "リレーリスト"]), he(k, S);
      },
      $$slots: { default: !0 }
    });
  }
  var te = se(ie, 2);
  {
    var ee = (O) => {
      ...
      {
        var S = (V) => {
          var Y = m1(), W = at(Y), re = R(W), de = R(re, !0);
          N(re);
          ...
          N(Ie), Ht(2), N(W);
          var Ce = se(W, 2);
          Lr(Ce, 21, () => y(b), Dr, (Ge, We) => {
            var ke = b1(), Ze = R(ke), pt = R(Ze, !0);
            N(Ze);
            var pe = se(Ze, 2);
            let it;
            var fn = R(pe);
            ...
            var pn = R(tn);
            {
              ...
              mt(pn, (tt) => {
                y(We).write ? tt(ve) : tt(Be, -1);
              });
            }
            N(tn);
            var Ye = se(tn, 2), lt = R(Ye);
            {
              let tt = Ee(() => `${t()("settingsDialog.copy_relay_url") || "リレーURLをコピー"}: ${y(We).url}`), Je = Ee(() => t()("common.copySuccess"));
              Mt(lt, {
                variant: "copy",
                shape: "circle",
            ...
            N(Ye), N(ke), Ve(
              (tt, Je) => {
                ge(pt, y(We).url), it = Ha(pe, 1, "relay-capability svelte-1x7qm6n", null, it, { enabled: y(We).read }), br(pe, "aria-label", tt), nn = Ha(tn, 1, "relay-capability svelte-1x7qm6n", null, nn, { enabled: y(We).write }), br(tn, "aria-label", Je);
              },
              [
                () => y(We).read ? t()("settingsDialog.relay_read_enabled") || "Read enabled" : t()("settingsDialog.relay_read_disabled") || "Read disabled",
                () => y(We).write ? t()("settingsDialog.relay_write_enabled") || "Write enabled" : t()("settingsDialog.relay_write_disabled") || "Write disabled"
              ]
            ), he(Ge, ke);
          }), N(Ce), Ve(
            (Ge, We, ke) => {
              ge(de, Ge), ge(fe, We), ge($e, ke);
            },
            [
          ...
          var Y = y1(), W = R(Y, !0);
          N(Y), Ve((re) => ge(W, re), [() => t()("settingsDialog.no_relay_info") || "リレー情報なし"]), he(V, Y);
        };
        mt($, (V) => {
...
function Oh(n, e) {
  ...
  var P = se(L, 2);
  {
    ...
    Ir(P, {
      ...
      children: (V, Y) => {
        var W = E1(), re = at(W), de = R(re), be = R(de), fe = R(be), Ie = R(fe, !0);
        N(fe);
        var $e = se(fe), Ce = R($e, !0);
        N($e);
        var Ge = se($e), We = R(Ge, !0);
        N(Ge), N(be), N(de);
        var ke = se(de), Ze = R(ke), pt = R(Ze), pe = R(pt, !0);
        N(pt);
        var it = se(pt), fn = R(it);
        N(it);
        var Kt = se(it), zn = R(Kt);
        N(Kt), N(Ze);
        var tn = se(Ze), nn = R(tn), pn = R(nn, !0);
        N(nn);
        var ve = se(nn), Be = R(ve);
        N(ve);
        var Ye = se(ve), lt = R(Ye);
        N(Ye), N(tn);
        var tt = se(tn), Je = R(tt), ht = R(Je, !0);
        N(Je);
        var Ue = se(Je), Et = R(Ue);
        N(Ue);
        var Ut = se(Ue), Qt = R(Ut);
        N(Ut), N(tt), N(ke), N(re);
        var Dt = se(re, 2), rn = R(Dt, !0);
        N(Dt), Ve(
          (Ot, kn, Ct, At, Yt, Nt, $t, an, An, gn) => {
            ge(Ie, Ot), ge(Ce, kn), ge(We, Ct), ge(pe, At), ge(fn, `${Rs.high.maxWidthOrHeight}px`), ge(zn, `${Yt ?? ""}%`), ge(pn, Nt), ge(Be, `${Rs.medium.maxWidthOrHeight}px`), ge(lt, `${$t ?? ""}%`), ge(ht, an), ge(Et, `${Rs.low.maxWidthOrHeight}px`), ge(Qt, `${An ?? ""}%`), ge(rn, gn);
          },
          [
            ...
            () => Math.round(Rs.high.initialQuality * 100),
            () => t()("settingsDialog.quality_medium"),
            () => Math.round(Rs.medium.initialQuality * 100),
            () => t()("settingsDialog.quality_low"),
            () => Math.round(Rs.low.initialQuality * 100),
  ...
  var k = se(F, 2);
  {
    ...
    Ir(k, {
      ...
      children: (V, Y) => {
        var W = k1(), re = R(W), de = R(re), be = R(de), fe = R(be, !0);
        N(be);
        var Ie = se(be), $e = R(Ie, !0);
        N(Ie), N(de), N(re);
        var Ce = se(re), Ge = R(Ce), We = R(Ge), ke = R(We, !0);
        N(We);
        var Ze = se(We), pt = R(Ze);
        N(Ze), N(Ge);
        var pe = se(Ge), it = R(pe), fn = R(it, !0);
        N(it);
        var Kt = se(it), zn = R(Kt);
        N(Kt), N(pe);
        var tn = se(pe), nn = R(tn), pn = R(nn, !0);
        N(nn);
        var ve = se(nn), Be = R(ve);
        N(ve), N(tn), N(Ce), N(W), Ve(
          (Ye, lt, tt, Je, ht) => {
            ge(fe, Ye), ge($e, lt), ge(ke, tt), ge(pt, `${_a.high.maxSize ?? ""}px`), ge(fn, Je), ge(zn, `${_a.medium.maxSize ?? ""}px`), ge(pn, ht), ge(Be, `${_a.low.maxSize ?? ""}px`);
          },
          [
            () => t()("settingsDialog.info_header_setting"),
            () => t()("settingsDialog.info_header_pixels"),
...
var I1 = je("<option> </option>"), T1 = je("<option> </option>"), L1 = je('<div class="url-clear-input-icon svg-icon svelte-odrb59" aria-hidden="true"></div>'), D1 = je('<span class="form-error svelte-odrb59" role="alert"> </span>'), O1 = je('<div class="destination-form svelte-odrb59"><label class="svelte-odrb59"><span> </span> <select class="svelte-odrb59"><option>custom</option><optgroup label="Blossom"></optgroup><optgroup label="NIP-96"></optgroup></select></label> <label class="svelte-odrb59"><span> </span> <select class="svelte-odrb59"><option>Blossom</option><option>NIP-96 legacy</option><option>Custom HTTP</option></select></label> <div class="url-field svelte-odrb59"><label for="upload-destination-url-input" class="svelte-odrb59"><span>URL</span></label> <div class="url-input-shell svelte-odrb59"><input id="upload-destination-url-input" class="upload-destination-url-input svelte-odrb59" inputmode="url"/> <!></div> <!></div> <div class="checkbox-group svelte-odrb59"><label class="checkbox-row svelte-odrb59"><input type="checkbox" class="svelte-odrb59"/> <span> </span></label> <label class="checkbox-row svelte-odrb59"><input type="checkbox" class="svelte-odrb59"/> <span> </span></label></div> <div class="form-actions svelte-odrb59"><!> <!></div></div>'), N1 = je('<div class="server-cog-icon svg-icon svelte-odrb59" aria-hidden="true"></div> <span class="btn-text"> </span>', 1), M1 = je('<span class="badge default-badge svelte-odrb59"> </span>'), R1 = je('<span class="badge muted svelte-odrb59"> </span>'), B1 = je('<button type="button" class="mime-toggle svelte-odrb59"> </button>'), U1 = je('<span class="arrow-up-icon svg-icon svelte-odrb59"></span>'), P1 = je('<span class="arrow-down-icon svg-icon svelte-odrb59"></span>'), z1 = je('<div class="blossom-test-popover svelte-odrb59"><p class="svelte-odrb59"> </p> <p class="svelte-odrb59"> </p></div>'), H1 = je("<div> </div>"), q1 = je('<div class="destination-row svelte-odrb59"><div class="destination-main svelte-odrb59"><div class="destination-content svelte-odrb59"><div class="destination-title svelte-odrb59"><span> </span> <!> <!></div> <div class="destination-meta svelte-odrb59"> </div> <div class="destination-meta mime-meta svelte-odrb59"><span> </span> <!></div></div> <div class="destination-order-actions svelte-odrb59"><!> <!></div></div> <div class="destination-actions svelte-odrb59"><!> <!> <!> <!> <!></div> <!></div> <!>', 1), j1 = je('<div class="bud03-popover svelte-odrb59"><p class="svelte-odrb59"> </p> <p class="svelte-odrb59"> </p> <p class="svelte-odrb59"> </p></div>'), F1 = je('<div class="test-result svelte-odrb59"> </div>'), Z1 = je('<div class="panel-actions svelte-odrb59"><!> <!> <!> <!></div> <!>', 1), V1 = je('<div class="upload-panel svelte-odrb59"><!> <!></div>'), G1 = je('<div class="setting-section upload-destination-section svelte-odrb59"><div class="setting-row"><div class="setting-label-group"><span class="setting-label"> </span> <span class="upload-summary svelte-odrb59"> </span></div> <div class="setting-control"><!></div></div> <!></div>');
const W1 = {
  hash: "svelte-odrb59",
...
function Nh(n, e) {
  rr(e, !0), Eo(n, W1);
  const t = () => is(ko, "$_", r), [r, i] = $o(), a = (ve) => {
    var Be = O1(), Ye = R(Be), lt = R(Ye), tt = R(lt, !0);
    N(lt);
    var Je = se(lt, 2), ht = R(Je);
    ht.value = ht.__value = "custom";
    var Ue = se(ht);
    Lr(Ue, 21, () => F, Dr, (nt, St) => {
      var gt = I1(), sn = R(gt, !0);
      N(gt);
      var He = {};
      Ve(() => {
        ge(sn, y(St).name), He !== (He = y(St).id) && (gt.value = (gt.__value = y(St).id) ?? "");
      }), he(nt, gt);
    }), N(Ue);
    var Et = se(Ue);
    Lr(Et, 21, () => O, Dr, (nt, St) => {
    ...
    var Ut;
    cd(Je), N(Ye);
    var Qt = se(Ye, 2), Dt = R(Qt), rn = R(Dt, !0);
    N(Dt);
    var Ot = se(Dt, 2), kn = R(Ot);
    kn.value = kn.__value = "blossom";
    var Ct = se(kn);
    Ct.value = Ct.__value = "nip96";
    var At = se(Ct);
    At.value = At.__value = "custom-http", N(Ot), N(Qt);
    var Yt = se(Qt, 2), Nt = se(R(Yt), 2), $t = R(Nt);
    os($t), Up($t, (nt) => me(m, nt), () => y(m));
    var an = se($t, 2);
    {
      var An = (nt) => {
        {
          let St = Ee(() => t()("clearInput") || "入力内容を消去");
          Mt(nt, {
            type: "button",
      ...
      }, gn = Ee(() => y(v).serverUrl.trim().length > 0);
      mt(an, (nt) => {
        y(gn) && nt(An);
      });
    }
    ...
    N(Yt);
    var Hn = se(Yt, 2), Bn = R(Hn), Sn = R(Bn);
    os(Sn);
    var qn = se(Sn, 2), jn = R(qn, !0);
    N(qn), N(Bn);
    var It = se(Bn, 2), ln = R(It);
    os(ln);
    var Fn = se(ln, 2), Ke = R(Fn, !0);
    N(Fn), N(It), N(Hn);
    var Pt = se(Hn, 2), xn = R(Pt);
    {
      ...
      Mt(xn, {
        ...
        children: (St, gt) => {
          Ht();
          var sn = Lt();
          Ve((He) => ge(sn, He), [() => t()("settingsDialog.uploadDestinationSave") || "保存"]), he(St, sn);
        },
        $$slots: { default: !0 }
      });
    }
    ...
    Mt(st, {
      ...
      children: (nt, St) => {
        Ht();
        var gt = Lt();
        Ve((sn) => ge(gt, sn), [() => t()("postComponent.cancel") || "キャンセル"]), he(nt, gt);
      },
      $$slots: { default: !0 }
    }), N(Pt), N(Be), Ve(
      (nt, St, gt, sn) => {
        ge(tt, nt), Ut !== (Ut = y(v).presetId) && (Je.value = (Je.__value = y(v).presetId) ?? "", dd(Je, y(v).presetId)), ge(rn, St), ge(jn, gt), ge(Ke, sn);
      },
      [
    ...
    ), mr("change", Je, (nt) => re(nt.currentTarget.value)), mr("change", Ot, () => me(A, null)), Pp(Ot, () => y(v).protocol, (nt) => y(v).protocol = nt), mr("input", $t, () => me(A, null)), lg($t, () => y(v).serverUrl, (nt) => y(v).serverUrl = nt), Dc(Sn, () => y(v).enabled, (nt) => y(v).enabled = nt), Dc(ln, () => y(v).isDefault, (nt) => y(v).isDefault = nt), he(ve, Be);
  };
  ...
  let h = Rt(!1), g = Rt(!1), b = Rt(null), m = Rt(null), v = Rt(vr({ ...d })), T = Rt(null), A = Rt(null), E = Rt(vr({})), L = Ee(() => tr.value), U = Rt(null), P = Ee(() => rs.value.isAuthenticated && rs.value.pubkey || null), J = Ee(() => !!(c() && y(P)));
  ...
  ld(() => {
    me(U, y(P), !0), tr.load(y(U));
  }), On(() => {
    y(U) !== y(P) && (me(U, y(P), !0), tr.load(y(U)));
  });
  function k(ve) {
    if (!ve) return t()("settingsDialog.uploadDestinationUnknown") || "未確認";
    const Be = ["B", "KB", "MB", "GB"];
    let Ye = ve, lt = 0;
    for (; Ye >= 1024 && lt < Be.length - 1; )
      Ye /= 1024, lt += 1;
    return `${Ye.toFixed(Ye >= 10 || lt === 0 ? 0 : 1)} ${Be[lt]}`;
  }
  function $(ve) {
    const Be = ve.capabilities.supportedMimeTypes;
    return Be.length ? y(E)[ve.id] || Be.length <= 3 ? Be.join(", ") : `${Be.slice(0, 3).join(", ")} +${Be.length - 3}` : t()("settingsDialog.uploadDestinationUnknown") || "未確認";
  }
  function S(ve) {
  ...
  function re(ve) {
    ...
    const Be = Ea.find((Ye) => Ye.id === ve);
    Be && (y(v).protocol = Be.protocol, y(v).serverUrl = Be.serverUrl);
  }
  function de() {
  ...
  async function be() {
    const ve = Date.now(), Be = Ea.find((Ot) => Ot.id === y(v).presetId), Ye = y(L).destinations.find((Ot) => Ot.id === y(v).id), lt = y(v).serverUrl || Be?.serverUrl || "", tt = y(v).protocol;
    let Je = zp(lt);
    if (tt === "nip96")
      try {
        Je = Hp(lt).url;
    ...
    me(A, null);
    const ht = qp({ protocol: tt, presetId: y(v).presetId, serverUrl: Je }), Ue = tt === "nip96" ? ht?.resolvedUploadUrl ?? null : null, Et = jp({
      serverUrl: Je,
      resolvedUploadUrl: Ue,
      fallbackName: Be?.name ?? Ye?.name ?? "Custom NIP-96",
      protocol: tt,
      ...
      updatedAt: ve,
      ...Ue ? { resolvedUploadUrl: Ue } : {}
    };
    await tr.save(rn), me(g, !1), me(b, null);
  }
  async function fe(ve) {
    me(T, ve.id, !0);
    try {
      await tr.test(ve);
    } finally {
  ...
  async function Ie(ve) {
    y(b) === ve.id && (me(g, !1), me(b, null)), await tr.delete(ve.id, y(P));
  }
  async function $e() {
    !c() || !y(P) || await tr.fetchBud03(c(), y(P));
  }
  async function Ce() {
    !c() || !y(P) || await tr.publishBud03(c(), y(P));
  }
  var Ge = {
    get rxNostr() {
      return c();
  ...
  }, We = G1(), ke = R(We), Ze = R(ke), pt = R(Ze), pe = R(pt, !0);
  N(pt);
  var it = se(pt, 2), fn = R(it, !0);
  N(it), N(Ze);
  var Kt = se(Ze, 2), zn = R(Kt);
  Mt(zn, {
    variant: "default",
    shape: "rounded",
    contentLayout: "iconText",
  ...
  var tn = se(ke, 2);
  {
    var nn = (ve) => {
      var Be = V1(), Ye = R(Be);
      Lr(Ye, 17, () => y(L).destinations, Dr, (ht, Ue) => {
        var Et = q1(), Ut = at(Et), Qt = R(Ut), Dt = R(Qt), rn = R(Dt), Ot = R(rn), kn = R(Ot, !0);
        N(Ot);
        var Ct = se(Ot, 2);
        {
          var At = (He) => {
        ...
        N(rn);
        var $t = se(rn, 2), an = R($t);
        N($t);
        var An = se($t, 2), gn = R(An), Qn = R(gn, !0);
        N(gn);
        var ar = se(gn, 2);
        {
          var Hn = (He) => {
            var ot = B1(), kt = R(ot, !0);
            N(ot), Ve((ce) => ge(kt, ce), [
              () => y(E)[y(Ue).id] ? t()("settingsDialog.uploadDestinationMimeCollapse") || "折りたたむ" : t()("settingsDialog.uploadDestinationMimeExpand") || "すべて表示"
            ]), mr("click", ot, () => j(y(Ue).id)), he(He, ot);
          }, Bn = Ee(() => S(y(Ue)));
          mt(ar, (He) => {
            y(Bn) && He(Hn);
          });
        ...
        N(An), N(Dt);
        var Sn = se(Dt, 2), qn = R(Sn);
        {
          let He = Ee(() => t()("settingsDialog.uploadDestinationMoveUp") || "Up"), ot = Ee(() => y(L).destinations[0]?.id === y(Ue).id);
          Mt(qn, {
            variant: "default",
            shape: "rounded",
            ...
            onClick: () => tr.move(y(Ue).id, "up", y(P)),
            get disabled() {
              return y(ot);
            },
            children: (kt, ce) => {
        ...
        var jn = se(qn, 2);
        {
          let He = Ee(() => t()("settingsDialog.uploadDestinationMoveDown") || "Down"), ot = Ee(() => y(L).destinations[y(L).destinations.length - 1]?.id === y(Ue).id);
          Mt(jn, {
            variant: "default",
            shape: "rounded",
            className: "destination-order-button",
            ...
            onClick: () => tr.move(y(Ue).id, "down", y(P)),
            get disabled() {
              return y(ot);
            },
            children: (kt, ce) => {
        ...
        N(Sn), N(Qt);
        var It = se(Qt, 2), ln = R(It);
        Mt(ln, {
          variant: "default",
          shape: "rounded",
          onClick: () => tr.setDefault(y(Ue).id, y(P)),
          get disabled() {
            return y(Ue).isDefault;
          },
          children: (He, ot) => {
            Ht();
            var kt = Lt();
        ...
        Mt(Fn, {
          ...
          children: (He, ot) => {
            ...
            var kt = Lt();
            Ve((ce) => ge(kt, ce), [
              () => y(g) && y(b) === y(Ue).id ? t()("settingsDialog.uploadDestinationClose") || "閉じる" : t()("settingsDialog.uploadDestinationEdit") || "編集"
            ]), he(He, kt);
          },
          $$slots: { default: !0 }
        });
        var Ke = se(Fn, 2);
        {
          ...
          Mt(Ke, {
            ...
            children: (ot, kt) => {
              ...
              var ce = Lt();
              Ve((Tt) => ge(ce, Tt), [
                () => y(T) === y(Ue).id ? t()("settingsDialog.uploadDestinationTesting") || "確認中" : t()("settingsDialog.uploadDestinationTest") || "接続テスト"
              ]), he(ot, ce);
            },
            $$slots: { default: !0 }
          });
        ...
        var Pt = se(Ke, 2);
        {
          let He = Ee(() => y(L).destinations.length <= 1);
          Mt(Pt, {
            variant: "default",
            shape: "rounded",
            onClick: () => Ie(y(Ue)),
            ...
            children: (ot, kt) => {
              Ht();
              var ce = Lt();
              Ve((Tt) => ge(ce, Tt), [() => t()("settingsDialog.uploadDestinationDelete") || "削除"]), he(ot, ce);
            },
            $$slots: { default: !0 }
          });
        }
          ...
          var st = (He) => {
            {
              ...
              Ir(He, {
                ...
                children: (kt, ce) => {
                  var Tt = z1(), kr = R(Tt), Xs = R(kr, !0);
                  N(kr);
                  var ks = se(kr, 2), As = R(ks, !0);
                  N(ks), N(Tt), Ve(
                    (Js, Ss) => {
                      ge(Xs, Js), ge(As, Ss);
                    },
        ...
        var nt = se(It, 2);
        {
          var St = (He) => {
            ...
            N(ot), Ve(
              (Tt) => {
                kt = Ha(ot, 1, "test-result svelte-odrb59", null, kt, {
                  error: !y(L).testResults[y(Ue).id].success
                }), ge(ce, Tt);
              },
              [
                () => y(L).testResults[y(Ue).id].message || (y(L).testResults[y(Ue).id].success ? t()("settingsDialog.uploadDestinationTestSuccess") || "接続テストに成功しました" : "")
              ]
            ), he(He, ot);
          };
          mt(nt, (He) => {
            (y(L).testResults[y(Ue).id]?.message || y(L).testResults[y(Ue).id]?.success) && He(St);
          });
        }
        N(Ut);
        var gt = se(Ut, 2);
        {
          ...
          mt(gt, (He) => {
            y(g) && y(b) === y(Ue).id && He(sn);
          });
        }
        Ve(
          (He, ot) => {
            ge(kn, y(Ue).name), ge(an, `${y(Ue).protocol ?? ""} / ${He ?? ""}`), ge(Qn, ot);
          },
          [
            () => k(y(Ue).capabilities.maxUploadSize),
            () => $(y(Ue))
          ]
        ), he(ht, Et);
      });
        ...
        var tt = (ht) => {
          ...
          Mt(Ut, {
            ...
            children: (Ct, At) => {
              Ht();
              var Yt = Lt();
              Ve((Nt) => ge(Yt, Nt), [() => t()("settingsDialog.uploadDestinationAdd") || "追加"]), he(Ct, Yt);
            },
            $$slots: { default: !0 }
          });
          var Qt = se(Ut, 2);
          {
            let Ct = Ee(() => !y(J) || y(L).bud03Fetching);
            Mt(Qt, {
              variant: "default",
              shape: "rounded",
              onClick: $e,
          ...
          var Dt = se(Qt, 2);
          {
            let Ct = Ee(() => !y(J) || y(L).bud03Publishing || !y(L).destinations.some((At) => At.protocol === "blossom" && At.enabled));
            Mt(Dt, {
              variant: "default",
              shape: "rounded",
              onClick: Ce,
          ...
          var rn = se(Dt, 2);
          {
            let Ct = Ee(() => t()("settingsDialog.uploadDestinationBud03InfoLabel") || "BUD-03 の説明");
            Ir(rn, {
              side: "top",
              get ariaLabel() {
                return y(Ct);
              ...
              children: (At, Yt) => {
                var Nt = j1(), $t = R(Nt), an = R($t, !0);
                N($t);
                var An = se($t, 2), gn = R(An, !0);
                N(An);
                var Qn = se(An, 2), ar = R(Qn, !0);
                N(Qn), N(Nt), Ve(
                  (Hn, Bn, Sn) => {
                    ge(an, Hn), ge(gn, Bn), ge(ar, Sn);
                  },
                  [
          ...
          var Ot = se(Et, 2);
          {
            var kn = (Ct) => {
              var At = F1(), Yt = R(At, !0);
              N(At), Ve(() => ge(Yt, y(L).bud03Status)), he(Ct, At);
            };
            mt(Ot, (Ct) => {
              y(L).bud03Status && Ct(kn);
            });
          }
          he(ht, Ue);
        };
        mt(lt, (ht) => {
          y(g) && !y(b) ? ht(tt) : y(g) || ht(Je, 1);
        });
      }
      N(Be), he(ve, Be);
    };
...
function dm(n, e) {
  rr(e, !0), Eo(n, cm);
  const t = () => is(ko, "$_", d), r = () => is(ng, "$swUpdateStatus", d), i = () => is(rg, "$dbUpgradeBlocked", d), a = () => is(Wp, "$locale", d), c = () => is(Xp, "$swNeedRefresh", d), [d, h] = $o();
  ...
  Zp(() => g(), A, !0);
  let E = Ee(() => Ic(t())), L = Ee(() => Ic(t())), U = Ee(() => Cc(y(E), 2)), P = Ee(() => Cc(y(L), 2)), J = Rt(vr(rt.clientTagEnabled)), ie = Rt(vr(rt.externalNostrClient)), te = Rt(vr(rt.externalNostrClientCustomUrl)), ee = Rt(null), F = Rt(vr(rt.quoteNotificationEnabled)), O = Rt(vr(rt.replyNotificationEnabled)), k = Rt(vr(ro.value));
  const $ = "#1dbf73", S = "#808080";
  let j = Rt(vr($n.accentColor ?? $)), V = Rt(vr($n.baseColor ?? "")), Y = Rt(null), W = Rt(null), re = Rt(!rt.showMascot), de = Rt(!rt.showFlavorText), be = Ee(() => y(re) || y(de)), fe = Ee(() => Gp.value), Ie = Ee(() => Kp.value), $e = Ee(() => $a.value), Ce = Ee(() => Tc.value), Ge = Ee(() => r() === "installing"), We = Ee(i), ke = Ee(() => Jp.required), Ze = Ee(() => y(ke) || r() === "ready" && !y(We));
  On(() => {
  ...
  ld(() => {
    rt.reload(), me(J, rt.clientTagEnabled, !0), me(ie, rt.externalNostrClient, !0), me(te, rt.externalNostrClientCustomUrl, !0), me(F, rt.quoteNotificationEnabled, !0), me(O, rt.replyNotificationEnabled, !0), me(k, ro.value, !0), $n.reload(), me(j, $n.accentColor ?? $, !0), me(V, $n.baseColor ?? "", !0), me(re, !rt.showMascot), me(de, !rt.showFlavorText), Vp(), rs.value?.pubkey && rs.value?.isAuthenticated && Sc(rs.value.pubkey);
  }), On(() => {
    ...
    !y(de) !== rt.showFlavorText && (rt.showFlavorText = !y(de));
  }), On(() => {
    if (!g()) {
      $a.set(!1);
      return;
    }
    rs.value?.pubkey && rs.value?.isAuthenticated && Sc(rs.value.pubkey), (async () => (await ig(), d1(), window.nostrZap?.initTargets()))();
  });
  function pe() {
  ...
  function it(ve) {
    ...
    me(
      ee,
      Be ? null : t()("settingsDialog.external_nostr_client_invalid_url"),
      !0
    ), Be && (rt.externalNostrClientCustomUrl = Be);
  }
  function fn(ve, Be) {
    ve === "accent" ? me(j, Be, !0) : me(V, Be, !0);
    const Ye = bi(Be);
    Ye && (ve === "accent" ? (me(j, $n.setAccentColor(Ye) ?? Be, !0), me(Y, null)) : (me(V, $n.setBaseColor(Ye) ?? Be, !0), me(W, null)));
  }
  function Kt(ve) {
    const Be = ve === "accent" ? y(j) : y(V), Ye = ve === "accent" ? $n.accentColor : $n.baseColor, tt = ve === "base" && !Be && !Ye || bi(Be) ? null : t()("settingsDialog.invalid_hex_color");
    ve === "accent" ? me(Y, tt, !0) : me(W, tt, !0);
  }
  function zn(ve, Be) {
    const Ye = bi(Be);
    Ye && (ve === "accent" ? (me(j, $n.setAccentColor(Ye) ?? Ye, !0), me(Y, null)) : (me(V, $n.setBaseColor(Ye) ?? Ye, !0), me(W, null)));
  }
  function tn() {
    $n.reset(), me(j, $), me(V, ""), me(Y, null), me(W, null);
  }
  var nn = {
    get show() {
      return g();
  ...
  };
  {
    const ve = (lt) => {
      var tt = Bt(), Je = at(tt);
      {
        ...
        Jt(Je, () => ag, (Ue, Et) => {
          Et(Ue, { child: ht, $$slots: { child: !0 } });
        });
      }
      he(lt, tt);
    };
    let Be = Ee(() => t()("settings") || "設定"), Ye = Ee(() => t()("settingsDialog.image_quality_setting"));
    og(n, {
      ...
      footer: ve,
      children: (lt, tt) => {
        var Je = lm(), ht = at(Je), Ue = R(ht), Et = R(Ue), Ut = se(R(Et), 2), Qt = R(Ut, !0);
        N(Ut), N(Et);
        var Dt = se(Et, 2), rn = R(Dt), Ot = R(rn, !0);
        N(rn);
        var kn = se(rn), Ct = R(kn, !0);
        N(kn), N(Dt), N(Ue);
        var At = se(Ue, 2), Yt = R(At);
        Mt(Yt, {
          shape: "circle",
          variant: "default",
          className: "help-btn",
        ...
        var $t = se(ht, 2), an = R($t);
        {
          var An = (Le) => {
            var Pe = J1(), De = R(Pe), Fe = R(De), Qe = R(Fe);
            {
              let ut = Ee(() => y(Ce) || y(Ge) && !y(ke) ? "loading" : ""), yt = Ee(() => y(Ce) || !y(Ze)), ft = Ee(() => y(ke) ? t()("staleAsset.reload") : t()("settingsDialog.update_app") || "アプリを更新");
              Mt(Qe, {
                variant: "primary",
                shape: "rounded",
                contentLayout: "iconText",
                get className() {
                  return `sw-update-btn ${y(ut) ?? ""}`;
                },
                onClick: pt,
                get disabled() {
                  return y(yt);
                ...
                children: (dt, vt) => {
                  var _t = Bt(), Ft = at(_t);
                  {
                    var vn = (Jn) => {
                      {
                        let ur = Ee(() => y(Ge) ? t()("settingsDialog.sw_update_installing_short") || "インストール中..." : t()("settingsDialog.updating") || "更新中...");
                        Yp(Jn, {
                          showLoader: !0,
                          loaderSize: 32,
                          get text() {
                      ...
                      var ur = X1(), qr = se(at(ur), 2), Zt = R(qr, !0);
                      N(qr), Ve((ze) => ge(Zt, ze), [
                        () => y(ke) ? t()("staleAsset.reload") : t()("settingsDialog.update_app") || "更新"
                      ]), he(Jn, ur);
                    };
                    mt(Ft, (Jn) => {
                      y(Ce) || y(Ge) && !y(ke) ? Jn(vn) : Jn(gs, -1);
                    });
                  }
                  he(dt, _t);
                },
            ...
            N(Fe), N(De), N(Pe), he(Le, Pe);
          };
          mt(an, (Le) => {
            (c() || y(ke)) && Le(An);
          });
        }
        var gn = se(an, 2), Qn = R(gn), ar = se(R(Qn), 2), Hn = R(ar);
        Mt(Hn, {
          variant: "default",
          shape: "rounded",
          contentLayout: "iconText",
          ...
          onClick: pe,
          children: (Le, Pe) => {
            var De = em(), Fe = se(at(De), 2), Qe = R(Fe, !0);
            N(Fe), Ve((ut) => ge(Qe, ut), [() => t()("settingsDialog.change") || "変更"]), he(Le, De);
          },
          $$slots: { default: !0 }
        }), N(ar), N(Qn), N(gn);
        var Bn = se(gn, 2);
        ...
        var qn = se(Sn, 2), jn = R(qn), It = R(jn), ln = R(It, !0);
        N(It);
        var Fn = se(It, 2);
        Jt(Fn, () => co, (Le, Pe) => {
          Pe(Le, {
              ...
              var Qe = tm(), ut = at(Qe);
              {
                ...
                zs(ut, {
                  ...
                  children: (vt, _t) => {
                    Ht();
                    var Ft = Lt();
                    Ve((vn) => ge(Ft, vn), [() => t()("settingsDialog.theme_system") || "システム"]), he(vt, Ft);
                  },
                  $$slots: { default: !0 }
                });
              }
              var yt = se(ut, 2);
              {
                ...
                zs(yt, {
                  ...
                  children: (vt, _t) => {
                    Ht();
                    var Ft = Lt();
                    Ve((vn) => ge(Ft, vn), [() => t()("settingsDialog.theme_light") || "ライト"]), he(vt, Ft);
                  },
                  $$slots: { default: !0 }
                });
              }
              var ft = se(yt, 2);
              {
                ...
                zs(ft, {
                  ...
                  children: (vt, _t) => {
                    Ht();
                    var Ft = Lt();
                    Ve((vn) => ge(Ft, vn), [() => t()("settingsDialog.theme_dark") || "ダーク"]), he(vt, Ft);
                  },
                  $$slots: { default: !0 }
                });
              }
        ...
        {
          var Pt = (Le) => {
            var Pe = sm(), De = R(Pe), Fe = R(De, !0);
            N(De);
            var Qe = se(De, 2), ut = R(Qe), yt = R(ut), ft = R(yt, !0);
            N(yt);
            var dt = se(yt, 2), vt = R(dt, !0);
            N(dt), N(ut);
            var _t = se(ut, 2), Ft = R(_t);
            os(Ft);
            var vn = se(Ft, 2);
            os(vn), N(_t), N(Qe);
            var gs = se(Qe, 2);
            {
              var Jn = (Vt) => {
                var Zn = nm(), hr = R(Zn, !0);
                N(Zn), Ve(() => ge(hr, y(Y))), he(Vt, Zn);
              };
              mt(gs, (Vt) => {
                y(Y) && Vt(Jn);
              });
            }
            var ur = se(gs, 2), qr = R(ur), Zt = R(qr), ze = R(Zt, !0);
            N(Zt);
            var vs = se(Zt, 2), fi = R(vs, !0);
            N(vs), N(qr);
            var Ds = se(qr, 2), jr = R(Ds);
            os(jr);
            var Fr = se(jr, 2);
            os(Fr), N(Ds), N(ur);
            var Vi = se(ur, 2);
            ...
            Mt(Go, {
              ...
              children: (Vt, Zn) => {
                Ht();
                var hr = Lt();
                Ve((pi) => ge(hr, pi), [() => t()("settingsDialog.reset_colors")]), he(Vt, hr);
              },
              $$slots: { default: !0 }
            }), N(Pe), Ve(
              (Vt, Zn, hr, pi, Wo, Ko, Qo, Yo, Xo, Gi, Jo) => {
                ge(Fe, Vt), ge(ft, Zn), ge(vt, hr), br(Ft, "aria-label", pi), mi(Ft, Wo), br(vn, "aria-label", Ko), mi(vn, y(j)), br(vn, "aria-invalid", y(Y) ? "true" : "false"), ge(ze, Qo), ge(fi, Yo), br(jr, "aria-label", Xo), mi(jr, Gi), br(Fr, "aria-label", Jo), mi(Fr, y(V)), br(Fr, "aria-invalid", y(W) ? "true" : "false");
              },
              [
            ...
            ), mr("input", Ft, (Vt) => zn("accent", Vt.currentTarget.value)), mr("input", vn, (Vt) => fn("accent", Vt.currentTarget.value)), Lc("blur", vn, () => Kt("accent")), mr("input", jr, (Vt) => zn("base", Vt.currentTarget.value)), mr("input", Fr, (Vt) => fn("base", Vt.currentTarget.value)), Lc("blur", Fr, () => Kt("base")), he(Le, Pe);
          };
          mt(Ke, (Le) => {
            $n.isAvailable && Le(Pt);
          });
        }
        var xn = se(Ke, 2), st = R(xn), nt = R(st), St = R(nt, !0);
        N(nt);
        var gt = se(nt, 2), sn = R(gt);
        Jt(sn, () => ts, (Le, Pe) => {
          Pe(Le, {
            class: "bui-switch",
            ...
            children: (De, Fe) => {
              var Qe = Bt(), ut = at(Qe);
              Jt(ut, () => ns, (yt, ft) => {
                ft(yt, { class: "bui-switch-thumb" });
              }), he(De, Qe);
            },
            $$slots: { default: !0 }
          });
        }), N(gt), N(st), N(xn);
        var He = se(xn, 2), ot = R(He), kt = R(ot), ce = R(kt), Tt = R(ce), kr = R(Tt), Xs = R(kr, !0);
        N(kr);
        var ks = se(kr, 2);
        {
        ...
        var Ss = se(ot, 2), Ni = R(Ss), ei = R(Ni), Mi = R(ei), Cs = R(Mi), ti = R(Cs, !0);
        N(Cs);
        var zo = se(Cs, 2);
        {
        ...
        N(Ri), N(Ni), N(Ss), N(He);
        var ni = se(He, 2), ri = R(ni), Bi = R(ri), si = R(Bi), Ui = R(si), ii = R(Ui), Fo = R(ii, !0);
        N(ii);
        var lr = se(ii, 2);
        {
        ...
        var zi = se(ri, 2), cr = R(zi), _n = R(cr), Un = R(_n), Cn = R(Un), ps = R(Cn, !0);
        N(Cn);
        var Hi = se(Cn, 2);
        {
        ...
        var Pr = se(ni, 2), Is = R(Pr), Ts = R(Is), Xn = R(Ts, !0);
        N(Ts);
        var ai = se(Ts, 2), ji = R(ai);
        Jt(ji, () => ts, (Le, Pe) => {
          Pe(Le, {
            class: "bui-switch",
        ...
        var zr = se(Pr, 2), li = R(zr), ci = R(li), Hr = R(ci), di = R(Hr), ui = R(di, !0);
        N(di);
        var Ls = se(di, 2);
        {
        ...
        N(Hr), N(ci);
        var dr = se(ci, 2);
        Lr(dr, 21, () => Qp, Dr, (Le, Pe) => {
          var De = im(), Fe = R(De, !0);
          N(De);
          var Qe = {};
          Ve(
            (ut) => {
              ge(Fe, ut), Qe !== (Qe = y(Pe)) && (De.value = (De.__value = y(Pe)) ?? "");
            },
            [
        ...
        var Zo = se(li, 2);
        {
          var hi = (Le) => {
            ...
            N(Pe), Ve(
              (vt, _t) => {
                ge(Fe, vt), ge(ut, _t), mi(yt, y(te)), br(yt, "aria-invalid", y(ee) ? "true" : "false");
              },
              [
                () => t()("settingsDialog.external_nostr_client_custom_url"),
                () => t()("settingsDialog.external_nostr_client_custom_url_description")
              ]
            ), mr("input", yt, (vt) => it(vt.currentTarget.value)), he(Le, Pe);
          };
          mt(Zo, (Le) => {
            y(ie) === "custom" && Le(hi);
          });
        ...
        Dh(Zi, {
          ...
          (Le, Pe, De, Fe, Qe, ut, yt, ft, dt, vt) => {
            ge(Qt, y(fe) ? `v${y(fe)}` : ""), ge(Ot, Le), ge(Ct, Pe), ge(ln, De), ge(St, Fe), ge(Xs, Qe), ge(ti, ut), ge(Fo, yt), ge(ps, ft), ge(Xn, dt), ge(ui, vt), Fi !== (Fi = y(ie)) && (dr.value = (dr.__value = y(ie)) ?? "", dd(dr, y(ie)));
          },
          [
