import { I as l, aQ as Z, e8 as Hr, aO as S, K as ne, aR as ee, aS as qe, aT as Ge, aU as We, e9 as zr, ea as Or, aD as Tr, aE as Zt, aM as Nr, aJ as Ur, aF as Fr, aN as Dr, H as Ar, eb as Vr, ai as Kr, ec as Wt, a_ as C, L as Br, Q as qr, ed as wt, ee as Gr, ef as Wr, eg as Jr, eh as Yr, ei as Zr, b6 as G, S as Qr, W as xt, ej as kt, N as H, ek as jt, O as Ae, el as we, em as Xr, en as Ve, V as eo, $ as to, eo as ro, ep as oo, eq as ao, er as io, es as so, et as no, eu as lo } from "./App-2yO7FIhW.js";
import { a9 as uo, u as Qt, b5 as Je, a_ as xe, a$ as y, b0 as p, b1 as n, b2 as ke, b3 as d, a as e, b6 as T, n as at, b7 as I, b4 as je, aP as i, b8 as w, b as M, aN as Ke, aQ as se, aJ as co, Z as ve, ap as Jt, aO as mo, bd as W, bf as vo, bg as Et, bj as $t, aq as ho, bh as go, be as Ct } from "./entry-tn6az_XN.js";
import { b as fo } from "./input-MkVV3LeH.js";
class Mt {
  /** */
                                ...
                                var Sr = (Q) => {
                                  ...
                                  var ie = Mo(), ye = p(ie);
                                  {
                                    var He = (O) => {
                                      ...
                                      I(Te);
                                      var Ne = W(Te, 2);
                                      xt(Ne, 21, () => e(ir), (q) => q.identityKey, (q, $) => {
                                        var me = y(), De = p(me);
                                        {
                                          let ft = i(() => `recent:${e($).identityKey}`), pt = i(() => [e($).shortcode]);
                                          C(De, () => kt, (bt, _t) => {
                                            _t(bt, {
                                              get value() {
                                                return e(ft);
                                              ...
                                              children: (yt, Rr) => {
                                                var F = ko();
                                                ve(() => {
                                                  H(F, "src", e($).src), H(F, "alt", `:${e($).shortcode}:`), H(F, "title", `:${e($).shortcode}:`);
                                                }), $t("load", F, () => ut(e($).src)), Ct(F), n(yt, F);
                                              },
                                              $$slots: { default: !0 }
                                            });
                                          });
                                      ...
                                      I(Fe);
                                      var Y = W(Fe, 2);
                                      xt(Y, 21, () => e(sr), (q) => q.identityKey, (q, $) => {
                                        var me = y(), De = p(me);
                                        {
                                          let ft = i(() => `frequent:${e($).identityKey}`), pt = i(() => [e($).shortcode]);
                                          C(De, () => kt, (bt, _t) => {
                                            _t(bt, {
                                              get value() {
                                                return e(ft);
                                        ...
                                        (q, $, me, De) => {
                                          H(X, "aria-label", q), Et(gt, $), Ae(Ne, `grid-template-columns: repeat(${e(de)}, minmax(0, 1fr));`), H(Ue, "aria-label", me), Et(Gt, De), Ae(Y, `grid-template-columns: repeat(${e(de)}, minmax(0, 1fr));`);
                                        },
                                        [
                                      ...
                                      C(Te, () => kt, (Ne, Ue) => {
                                        Ue(Ne, {
                                          ...
                                          children: (Fe, Gt) => {
                                            ...
                                            }), $t("load", Y, () => ut(e(E).src)), Ct(Y), n(Fe, Y);
                                          },
                                          $$slots: { default: !0 }
                                        });
                                      });
