import { J as Yn, d5 as Zn, cS as er, dX as tr, R as rt, ec as nr, cf as Ot, a7 as rr, a8 as me, dY as ar, cg as or, ab as nn, aa as x, aJ as ir, aK as sr, aZ as lr, ac as cr, bm as tt, ae as ft, bl as At, bp as ur, aj as rn, ak as dr, cP as St, cc as an, bs as pr, bv as on, ad as sn, aX as vr, cO as fr, cQ as gr, bA as Lt, ag as hr, d2 as mr, ed as yr, bZ as br, d7 as ln } from "./App-1qWol-Cs.js";
import { a_ as _r, aQ as w, aJ as xr, a as e, aN as cn, b as n, b0 as L, Z as T, b1 as s, b6 as v, b2 as wr, aP as a, b3 as ye, a$ as nt, bh as R, bd as l, b8 as p, b4 as Cr, b7 as f, bf as Nt, bg as kr } from "./entry-De5pG27L.js";
import { b as Pr } from "./input-C3JkTJyC.js";
import { D as $r, a as Tr } from "./DialogWrapper-DhZEVMtT.js";
import { u as Rr, c as Er, d as Ir, p as Hr, P as Ar, h as Sr, b as Lr, j as Dt, M as Mt, a as Nr, r as Dr, g as un, i as Mr } from "./postBroadcastService-CGqK_9N1.js";
function pn(d) {
  ...
  function J(m) {
    ...
    return {
      promise: (async () => {
        ...
        let V = null, fe = null, X = null, y = !1;
        if (C.kind === 40 || C.kind === 42) {
          const W = C.kind === 42 ? nr(C) : null, ie = C.kind === 40 ? C.id : W?.channelEventId ?? null;
          if (!ie || C.kind === 42 && W && Fr(W.issues)) {
            const se = await ve;
            return {
              status: "error",
          ...
          V = S.context, y = S.cache?.resolutionQuality === "verified-metadata", X = S.cache?.creatorPubkey ?? null, fe = {
            eventId: ie,
        ...
        if (m.profileService) {
          if (m.onPhase?.("profile-loading"), [h, o] = await Promise.all([
            ve,
            X && X !== C.pubkey ? m.profileService.fetchProfileRealtime(
              X,
              {
...
function Ca(d, u) {
  ...
  let N = me(u, "show", 7), be = me(u, "onClose", 7), j = me(u, "onApply", 7), _e = me(u, "rxNostr", 7, void 0), q = me(u, "relayConfig", 7, null), C = me(u, "profileService", 7, void 0), oe = me(u, "resolver", 23, dn), ve = me(u, "pubkeyHex", 7, null), V = w(""), fe = w(null), X = w(null), y = w("empty"), h = w(null), o = w(null), W = w(null), ie = w(null), Le = w(0), U = 0, S, se = null, Ne = w(xr([])), xe = w(-1), De = w(!1), at = w(null);
  const Q = Rr();
  let ot = w(!1), gt = w(null), qe = w(void 0), Y = w(void 0), it = w(!1), Ft = w(0), Ut = w(0), Bt = w("postHistory.broadcastSent"), Qe, Ke = w(void 0), ht = a(() => e(o) ? Kr(e(o).event.kind, e(o).event.kind === 1 || !!e(o).channelQuery) : []), P = a(() => e(o)?.event ?? e(W)), vn = a(() => e(P) ? e(P).created_at * 1e3 : 0), Me = a(() => e(o) ? Pn(e(o)) : null), fn = a(() => e(Me) ? Dr(e(Me)) !== null : !1), gn = a(() => e(Me) ? un(e(Me), ve()) : !1), mt = a(() => e(o)?.authorProfile ?? e(ie)), hn = a(() => {
    const t = e(P)?.pubkey;
  ...
  function Gt() {
    U += 1, kt(), n(V, ""), n(y, "empty"), n(h, null), n(o, null), n(W, null), n(ie, null), n(Le, 0), zt(), Ct.resetState(), n(Ne, [], !0), n(xe, -1), n(De, !1), n(at, null);
  }
  function wn() {
  ...
  async function Cn(t, i) {
    ...
    if (!(U !== i || c.status === "cancelled")) {
      if (se = null, c.status === "resolved") {
        n(o, c.target, !0), n(W, null), n(ie, null), n(y, "ready"), n(h, null);
        return;
      }
      n(W, c.event ?? null, !0), n(ie, c.authorProfile ?? null, !0), n(y, "error"), n(h, c.reason, !0);
    }
  }
  function kn() {
    n(Le, e(Le) + 1);
  ...
  cn(() => {
    ...
    e(Le);
    const i = ++U;
    kt(), zt(), n(o, null), n(W, null), n(ie, null), n(h, null), n(y, "parsing");
    const c = Qr(t);
    if (c.status === "empty") {
      n(y, "empty");
      return;
          ...
          var en = l(Zt, 2);
          {
            var Gn = (b) => {
              ...
              var Te = l($, 2);
              {
                var Ve = (k) => {
                  var Re = aa(), Xe = v(Re, !0);
                  f(Re), T((he) => R(Xe, he), [() => r()("postHistory.deleteFailed")]), s(k, Re);
                };
                x(Te, (k) => {
                  e(Y) === "failed" && e(o) && k(Ve);
                });
