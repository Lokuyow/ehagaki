import { I as o, dP as Ye, aP as j, K as ie, aQ as X, aR as ae, aS as q, aT as ue, aU as he, aV as we, dQ as et, dR as tt, dS as rt, bZ as nt, dT as ot, dK as st, b1 as _e, dL as it, dM as He, dU as at, H as Pe, a_ as z, b_ as Re, cx as je, cu as ze, cv as Le, cw as Ke, cy as lt, M as dt, Q as qe, aA as $e, N as ct, V as Ue, $ as Be, bT as ut, cs as pt, w as Je, i as vt, k as gt, a as ft, ag as ht, ah as mt, y as yt, z as bt, A as _t, P as Ve, x as wt, G as xt } from "./App-CGgJsLME.js";
import { b7 as ke, b0 as te, b1 as $, b2 as O, b3 as b, b4 as re, b5 as s, b6 as ne, a as x, b8 as I, n as ee, b9 as H, aR as K, ba as U, bl as We, bf as oe, bh as De, Z as pe, bi as ve, bj as Te, aS as be, aJ as Fe, b as Q, aN as Ee, a$ as Ne, bk as Ae } from "./entry-B5mUKSYb.js";
import { F as St } from "./floating-layer-anchor-_kJS2jVr.js";
import { D as Ct, a as Pt } from "./DialogWrapper-2ZPf0OiI.js";
var kt = U("<div><!></div>");
function Ot(l, e) {
  const t = ke();
  te(e, !0);
...
var $t = U('<div class="more-icon svg-icon"></div>'), Dt = U("<!> <!>", 1), Tt = U('<div class="more-icon svg-icon"></div>'), At = U('<div class="post-history-menu-timestamp"> </div> <!>', 1), It = U('<div class="post-history-menu-body"><!> <!></div>'), Ht = U("<!> <!>", 1);
const Nt = {
  hash: "svelte-ea4c9b",
...
function Jt(l, e) {
  ...
  };
  {
    ...
    Ct(l, {
      ...
      footer: v,
      children: (d, m) => {
        var M = Ut(), c = O(M), E = I(c), R = I(E, !0);
        H(E), H(c);
        var N = oe(c, 2), W = I(N), Y = I(W, !0);
        H(W), H(N), pe(
          (u) => {
            ve(R, u), ve(Y, x(_));
          },
