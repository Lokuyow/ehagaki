import { I as l, aW as Y, e2 as Rr, aU as I, K as se, aX as X, aY as Ge, aZ as qe, a_ as We, e3 as Hr, e4 as zr, aJ as Tr, aK as Zt, aS as Or, aP as Ur, aL as Dr, aT as Nr, H as Ar, e5 as Fr, ai as Kr, e6 as Wt, b3 as $, L as Br, Q as Vr, e7 as Gr, e8 as wt, e9 as qr, ea as Wr, eb as Jr, ec as Yr, ed as Zr, bb as q, S as Qr, W as xt, ee as kt, N as R, ef as jt, O as Fe, eg as we, eh as Xr, ei as Ke, V as eo, $ as to, ej as ro, ek as oo, el as ao, em as io, en as so, eo as no, ep as lo } from "./App-BBD-wmht.js";
import { a9 as co, u as Qt, b7 as Je, b0 as xe, b1 as y, b2 as p, b3 as n, b4 as ke, b5 as d, a as e, b8 as O, n as at, b9 as M, b6 as je, aR as i, ba as w, b as C, aN as Be, aS as ie, aJ as uo, Z as ve, ap as Jt, aQ as mo, bf as W, bh as vo, bi as Et, bD as $t, aq as ho, bj as go, bg as Ct } from "./entry-BhDgNuDQ.js";
import { b as fo } from "./input-C0desN7K.js";
class Mt {
  /** */
...
class It {
  ...
  attachment;
  constructor(t) {
    this.opts = t, this.attachment = Zt(this.opts.ref), this.rovingFocusGroup = new Or({
...
class St {
  ...
  attachment;
  constructor(t, s) {
    this.opts = t, this.root = s, this.attachment = Zt(this.opts.ref), Be(() => {
  ...
  #r = i(() => ({
    ...
    role: e(this.#t),
    tabindex: e(this.#e),
    "data-disabled": Dr(this.opts.disabled.current),
...
function Uo(S, t) {
  xe(t, !0), Ar(S, Oo);
  const s = () => eo(to, "$_", c), [c, h] = Vr(), g = 3, f = 8, v = mo();
  let _ = l(t, "rxNostr", 7), x = l(t, "pubkey", 7), b = l(t, "open", 7, !1), P = l(t, "maxHeight", 7, null), k = l(t, "customEmojiUsageItems", 23, () => []), H = l(t, "onSelect", 7), U = l(t, "onMoveCaretLeft", 7), m = l(t, "onMoveCaretRight", 7), a = l(t, "onDeleteBackward", 7), r = l(t, "onInsertLineBreak", 7), u = l(t, "hostCustomEmojiItems", 7), L = ie(""), A = ie(uo(Fr)), F = ie(!1), ee = ie(!1), it = ie(0), Pt = ie(800), te = null, ne = null, st = null, nt = ie(0), Ye, Ze, Lt = !1, Rt, Ht, zt = !1, Tt, Ot;
  const Ut = /* @__PURE__ */ new Set();
  let Dt = i(() => u() ?? wt.items), ar = i(() => u() === void 0 && wt.loading), Qe = i(() => {
    const o = e(L).trim().toLowerCase();
    return o ? e(Dt).filter((z) => z.shortcodeLower.includes(o)) : e(Dt);
  }), Nt = i(() => e(L).trim().length === 0 && k().length > 0), le = i(() => Math.max(1, Math.floor(e(Pt) / we))), At = i(() => lo(e(le))), ir = i(() => k().slice(0, e(At))), sr = i(() => [...k()].sort(no).slice(0, e(At))), lt = i(() => Math.ceil(e(Qe).length / e(le))), he = i(() => Math.max(Ke, e(A))), Ft = i(() => Math.ceil(e(he) / we) + g * 2), dt = i(() => Math.max(0, Math.min(Math.max(0, e(lt) - e(Ft)), Math.floor(Math.max(0, e(it) - e(nt)) / we) - g))), nr = i(() => Math.min(e(lt), e(dt) + e(Ft))), lr = i(() => e(dt) * e(le)), dr = i(() => Math.min(e(Qe).length, e(nr) * e(le))), cr = i(() => e(Qe).slice(e(lr), e(dr))), ur = i(() => e(lt) * we + f), mr = i(() => e(dt) * we), Kt = i(() => Number.isFinite(P()) ? Math.max(Ke, Math.floor(P())) : void 0), ge = i(() => e(Kt) === void 0 ? void 0 : e(Kt)), vr = i(() => `--custom-emoji-picker-resize-handle-height: ${oo}px; --custom-emoji-picker-resize-handle-overlap: ${ao}px; --custom-emoji-picker-search-row-height: ${io}px;`);
  function hr() {
  ...
  Kr(() => (C(A, Wt(v, Xe(), e(ge)), !0), ut(), window.addEventListener("resize", re), window.visualViewport?.addEventListener("resize", re), window.visualViewport?.addEventListener("scroll", re), () => {
    ...
    zt = b(), Tt = e(L), Ot = x(), o && (C(it, 0), st?.querySelector(".custom-emoji-scroll-viewport")?.scrollTo({ top: 0 }));
  }), Be(() => {
    e(ge), C(A, Wt(v, Xe(), e(ge)), !0);
  });
  function vt(o) {
    H()?.(o);
  }
  ...
  function wr(o) {
    ...
    const et = ($e) => {
      ...
      C(F, !1), window.removeEventListener("pointermove", et), window.removeEventListener("pointerup", Ee), window.removeEventListener("pointercancel", Ee);
    };
    window.addEventListener("pointermove", et), window.addEventListener("pointerup", Ee), window.addEventListener("pointercancel", Ee);
  }
  function xr(o) {
    C(it, o.currentTarget.scrollTop, !0);
  }
  var kr = {
    get rxNostr() {
      return _();
    ...
    $(jr, () => Xr, (z, ce) => {
      ce(z, {
        ...
        children: (et, Ee) => {
                                ...
                                var Ir = (Z) => {
                                  ...
                                  $(ye, () => Xt, (He, ze) => {
                                    ze(He, {
                                      ...
                                      children: (ue, Te) => {
                                        go();
                                        var T = vo();
                                        ve((j) => Et(T, j), [() => s()("customEmoji.empty")]), n(ue, T);
                                      },
                                      $$slots: { default: !0 }
                                    });
                                  }), n(Z, ae);
                                  ...
                                  var ae = Mo(), ye = p(ae);
                                  {
                                    var He = (T) => {
                                          ...
                                          $(Ae, () => kt, (bt, _t) => {
                                            _t(bt, {
                                              ...
                                              children: (yt, Lr) => {
                                                var N = ko();
                                                ve(() => {
                                                  R(N, "src", e(E).src), R(N, "alt", `:${e(E).shortcode}:`), R(N, "title", `:${e(E).shortcode}:`);
                                                }), $t("load", N, () => ct(e(E).src)), Ct(N), n(yt, N);
                                              },
                                              $$slots: { default: !0 }
                                            });
                                          });
                                      ...
                                      var De = W(Q, 2), Ne = O(De), qt = O(Ne, !0);
                                      M(Ne);
                                      var J = W(Ne, 2);
                                      xt(J, 21, () => e(sr), (G) => G.identityKey, (G, E) => {
                                        ...
                                        (G, E, me, Ae) => {
                                          R(Q, "aria-label", G), Et(gt, E), Fe(Ue, `grid-template-columns: repeat(${e(le)}, minmax(0, 1fr));`), R(De, "aria-label", me), Et(qt, Ae), Fe(J, `grid-template-columns: repeat(${e(le)}, minmax(0, 1fr));`);
                                        },
                                        [
                                  ...
                                  xt(Te, 21, () => e(cr), (T) => T.identityKey, (T, j) => {
                                      ...
                                      $(Oe, () => kt, (Ue, De) => {
                                        De(Ue, {
                                          ...
                                          children: (Ne, qt) => {
                                            ...
                                            }), $t("load", J, () => ct(e(j).src)), Ct(J), n(Ne, J);
                                          },
                                          $$slots: { default: !0 }
                                        });
                                      });
                                    ...
                                    Fe(ue, `height: ${e(ur)}px;`), Fe(Te, `transform: translateY(${e(mr)}px); grid-template-columns: repeat(${e(le)}, minmax(0, 1fr)); grid-auto-rows: ${we}px;`);
                                  }), n(Z, ae);
                                };
                                se(Mr, (Z) => {
                                  e(ar) || !e(ee) ? Z(Ir) : e(Qe).length === 0 && !e(Nt) ? Z(Sr, 1) : Z(Pr, -1);
                                });
                              }
                              n(Re, Gt);
                            },
          ...
          {
            let Ce = i(() => s()("customEmoji.search_placeholder"));
            $(Vt, () => er, (Me, Ie) => {
              Ie(Me, {
          ...
          var $r = W(Vt, 2);
          {
            let Ce = i(() => s()("customEmoji.editor_toolbar"));
            $($r, () => or, (Me, Ie) => {
              Ie(Me, {
                ...
                children: (Se, Cr) => {
                  ...
                  {
                    let D = i(() => s()("customEmoji.move_left"));
                    $(rt, () => Ve, (K, B) => {
                      B(K, {
                  ...
                  var Le = W(rt, 2);
                  {
                    let D = i(() => s()("customEmoji.move_right"));
                    $(Le, () => Ve, (K, B) => {
                      B(K, {
                  ...
                  {
                    let D = i(() => s()("customEmoji.insert_line_break"));
                    $(_e, () => Ve, (K, B) => {
                      B(K, {
                  ...
                  var ht = W(_e, 2);
                  {
                    let D = i(() => s()("customEmoji.delete_backward"));
                    $(ht, () => Ve, (K, B) => {
                      B(K, {
  ...
  M(fe), Br(fe, (o) => st = o, () => st), ve(
    (o, z) => {
      R(fe, "data-resizing", e(F)), Fe(fe, e(vr)), R(de, "aria-label", o), R(de, "aria-valuemin", Ke), R(de, "aria-valuenow", e(he)), R(de, "aria-valuemax", z);
    },
    [
