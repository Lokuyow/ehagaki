...
function po(we, m) {
  ...
  let B = y(m, "show", 15, !1), re = y(m, "onClose", 7), le = y(m, "onLogout", 7), U = y(m, "fallbackRecoveryPubkeyHex", 7, ""), se = y(m, "onSwitchAccount", 7), ce = y(m, "onAddAccount", 7), ve = y(m, "onCheckNip46Connection", 7), F = y(m, "accounts", 23, () => []), de = y(m, "accountProfiles", 23, () => /* @__PURE__ */ new Map()), V = y(m, "isLoggingOut", 7, !1), O = y(m, "isSwitchingAccount", 7, !1), J = y(m, "nip46ConnectionOperationState", 7, "idle"), Y = y(m, "nip46ConnectionStatus", 7, "idle");
  function pe() {
    B(!1), re()?.();
  }
  wt(() => B(), pe, !0);
  let ye = r(() => Oe.value), ue = r(() => Lt.value), k = Ot(Rt(Oe.value)), ee = r(() => e(ue)?.pubkey || U() || ""), fe = r(() => e(k).npub || (e(ee) ? We(e(ee)) : "")), Ze = r(() => e(k).displayName || e(k).name ? e(k).displayName || e(k).name : a()("profileDialog.profile_image_alt")), qe = r(() => a()("profileDialog.profile_image_fallback")), Fe = r(() => F().length === 0 && !!e(ee));
  Mt(() => {
    !V() && e(ye) && jt(k, e(ye), !0);
  });
  function ke(t) {
  ...
  };
  {
    const t = (R) => {
      var ge = Bt(), K = ne(ge);
      {
        ...
        qt(K, () => Kt, (M, W) => {
          W(M, { child: Q, $$slots: { child: !0 } });
        });
      }
      c(R, ge);
    };
    let P = r(() => a()("profileDialog.title")), Xe = r(() => a()("profileDialog.npub"));
    Jt(we, {
      onOpenChange: (R) => !R && pe(),
      get title() {
        return e(P);
            ...
            Nt(N, 21, F, (w) => w.pubkeyHex, (w, d) => {
              ...
              var dt = l(X, 2);
              {
                var pt = (n) => {
                  ...
                  var Le = l(z, 2);
                  {
                    let b = r(() => V() || O() || J() !== "idle"), x = r(() => a()("profileDialog.nip46_connection_check"));
                    Z(Le, {
                      ...
                      children: (L, S) => {
                        ...
                        o(He), p((mt) => v(xt, mt), [
                          () => J() === "manual-check" ? a()("profileDialog.nip46_connection_checking") : a()("profileDialog.nip46_connection_check")
                        ]), c(L, ae);
                      },
                      $$slots: { default: !0 }
                    });
                  ...
                  var gt = l(Le, 2);
                  {
                    ...
                    H(gt, (b) => {
                      J() === "auto-recovery" ? b(ht) : Y() === "success" ? b(zt, 1) : Y() === "failure" && b(bt, 2);
                    });
                  }
              ...
              o(A), p(
                (n, s, z) => {
                  T = At(A, 1, "account-item svelte-1qzltz2", null, T, { active: e(h) }), I.disabled = e(h) || O(), v(ot, n), v(it, s), _e.disabled = V() || O(), St(_e, "aria-label", z);
                },
                [
