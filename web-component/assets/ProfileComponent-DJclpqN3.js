...
function po(we, m) {
  ...
  let B = y(m, "show", 15, !1), re = y(m, "onClose", 7), le = y(m, "onLogout", 7), X = y(m, "fallbackRecoveryPubkeyHex", 7, ""), se = y(m, "onSwitchAccount", 7), ce = y(m, "onAddAccount", 7), ve = y(m, "onCheckNip46Connection", 7), J = y(m, "accounts", 23, () => []), de = y(m, "accountProfiles", 23, () => /* @__PURE__ */ new Map()), F = y(m, "isLoggingOut", 7, !1), O = y(m, "isSwitchingAccount", 7, !1), K = y(m, "nip46ConnectionOperationState", 7, "idle"), Y = y(m, "nip46ConnectionStatus", 7, "idle");
  function pe() {
    B(!1), re()?.();
  }
  wt(() => B(), pe, !0);
  let ye = r(() => Oe.value), ue = r(() => Lt.value), k = Ot(Rt(Oe.value)), ee = r(() => e(ue)?.pubkey || X() || ""), fe = r(() => e(k).npub || (e(ee) ? Ve(e(ee)) : "")), We = r(() => e(k).displayName || e(k).name ? e(k).displayName || e(k).name : a()("profileDialog.profile_image_alt")), qe = r(() => a()("profileDialog.profile_image_fallback")), Je = r(() => J().length === 0 && !!e(ee));
  Mt(() => {
    !F() && e(ye) && jt(k, e(ye), !0);
  });
  function ke(t) {
    const P = t || e(ue)?.pubkey || X() || "";
    P && le()?.(P);
  }
  function Ke(t) {
    se()?.(t), pe();
  ...
  };
  {
    const t = (R) => {
      var ge = Bt(), Q = ne(ge);
      {
        ...
        qt(Q, () => Qt, (M, V) => {
          V(M, { child: T, $$slots: { child: !0 } });
        });
      }
      c(R, ge);
    };
    let P = r(() => a()("profileDialog.title")), Ee = r(() => a()("profileDialog.npub"));
    Kt(we, {
      onOpenChange: (R) => !R && pe(),
      get title() {
        return e(P);
          ...
          var Ye = (u) => {
            ...
            var w = l(N, 2);
            {
              ...
              W(w, {
                ...
                children: ($, C) => {
                  var A = Xt(), Z = l(ne(A), 2), E = i(Z, !0);
                  o(Z), p((I) => v(E, I), [() => a()("profileDialog.recovery_logout_current")]), c($, A);
                },
                $$slots: { default: !0 }
              });
            }
          ...
          var tt = (u) => {
            ...
            Nt(N, 21, J, (w) => w.pubkeyHex, (w, d) => {
              ...
              var ct = l(be, 2);
              {
                var vt = (n) => {
                  var s = eo(), z = i(s, !0);
                  o(s), p((G) => v(z, G), [() => a()("profileDialog.active")]), c(n, s);
                };
                H(ct, (n) => {
                  e(h) && n(vt);
                });
              ...
              var dt = l(E, 2);
              {
                var pt = (n) => {
                  ...
                  var Le = l(z, 2);
                  {
                    let b = r(() => F() || O() || K() !== "idle"), x = r(() => a()("profileDialog.nip46_connection_check"));
                    W(Le, {
                  ...
                  var gt = l(Le, 2);
                  {
                    ...
                    H(gt, (b) => {
                      K() === "auto-recovery" ? b(ht) : Y() === "success" ? b(zt, 1) : Y() === "failure" && b(bt, 2);
                    });
                  }
              ...
              o(A), p(
                (n, s, z) => {
                  Z = At(A, 1, "account-item svelte-1qzltz2", null, Z, { active: e(h) }), I.disabled = e(h) || O(), v(ot, n), v(it, s), _e.disabled = F() || O(), St(_e, "aria-label", z);
                },
                [
