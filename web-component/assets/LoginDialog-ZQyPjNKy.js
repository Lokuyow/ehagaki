import { aD as mr, aE as Nt, aF as Cn, aG as Nn, aH as Cr, aI as Nr, aJ as wn, aK as wr, aL as pn, aM as kr, aN as Dr, I as d, aO as Z, K as V, aP as fn, aQ as Ke, aR as Oe, aS as wt, aT as kt, aU as Dt, H as kn, aV as Pr, N as Fe, aW as Lr, aX as Sr, aY as Tr, aZ as ve, a_ as Be, aB as Rr, Q as qr, a$ as hn, b0 as Er, b1 as $r, b2 as _n, V as Vr, $ as Ir, b3 as Ar, S as Re, W as Mr, b4 as jt, b5 as Kr, L as bn, M as yn, b6 as mt, b7 as Or, b8 as xn, b9 as Ur, ba as Ct } from "./App-BXRUDZkJ.js";
import { aR as l, a as e, b as s, aS as Q, aN as qe, aJ as Dn, b7 as Pt, b0 as et, b1 as ne, b2 as q, b3 as i, b4 as tt, b5 as c, b6 as nt, b8 as o, n as Lt, b9 as a, ba as _, Z as D, bf as u, bh as Pe, bi as w, ap as Bt, bC as mn, aq as zr, bj as Ze } from "./entry-P10b_OwJ.js";
import { b as Hr } from "./input-DAT85sFW.js";
import { D as Wr, a as jr } from "./DialogWrapper-BaHSHEQR.js";
import { I as Br } from "./InfoPopoverButton-BwwVNiOn.js";
const ct = Dr({
  component: "tabs",
...
function Si(ee, t) {
  ...
  let en = l(f), Rn = l(ue);
  const gt = new Tr();
  let qn = l(() => gt.isValid), Tt = l(() => gt.npub), Rt = l(() => gt.nprofile), tn = l(() => n()("clearInput") === "clearInput" ? "入力内容を消去" : n()("clearInput")), A = Q(null), $e = Q(""), ge = Q("qr"), qt = Q(!1), pt = Q(null), xe = Q(Dn([""])), B = Q(null), Ge = Q(""), Ue = Q(""), pe = Q(""), ft = Q(!1), ht = Q(!1), Ve = Q(!1), ze, Et = Q(null);
  const En = 1200, $n = 6e3;
  function Qe() {
  ...
  qe(() => {
    if (b() && !e(qt)) {
      s(qt, !0), y(""), s($e, ""), s(Ge, ""), s(Ue, ""), s(pe, ""), s(ft, !1), In(), queueMicrotask(() => {
        !b() || e(ge) !== "qr" || nn();
      });
      return;
    }
      ...
      children: (Ce, je) => {
            ...
            children: (F, Ne) => {
              var le = ne(), he = q(le);
              {
                var _e = (ie) => {
                  ...
                  var I = si(), z = u(q(I), 2), T = o(z, !0);
                  a(z), D((R) => w(T, R), [() => n()("loginDialog.login_with_extension")]), i(ie, I);
                };
                V(he, (ie) => {
                  $() ? ie(_e) : ie(we, -1);
                });
        ...
        var ur = u(At, 2);
        {
          var gr = (O) => {
            ...
            a(we), a(_e);
            var I = u(_e, 2), z = o(I), T = o(z), R = o(T);
            Ct(R), bn(R, (k) => s(A, k), () => e(A));
            var de = u(R, 2);
            {
              var be = (k) => {
                ve(k, {
            ...
            ), mn("submit", I, ir), Bt("input", R, () => e(A)?.setCustomValidity("")), Hr(R, y), i(O, U);
          };
          V(ur, (O) => {
            rt() && O(gr);
          });
