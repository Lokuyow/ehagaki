import { a8 as s, eg as Xe, b6 as I, aa as ae, b7 as Q, b8 as ie, b9 as z, ba as ue, bb as he, bc as we, eh as Ye, ei as et, ej as tt, co as rt, ek as nt, eb as ot, bl as _e, ec as st, ed as He, el as at, a7 as Pe, bi as N, cp as Fe, cZ as Ie, cW as Ne, cX as je, cY as ze, c_ as it, ad as lt, ac as Le, bh as De, ae as dt, aj as qe, ak as Ke, ci as ct, cT as ut, w as Be, q as pt, k as vt, b as gt, aE as ft, aF as ht, E as mt, F as yt, G as bt, P as Je, D as _t, R as Ue } from "./App-qNXS1jWJ.js";
import { b5 as ke, a_ as Y, a$ as O, b0 as k, b1 as y, b2 as ee, b3 as a, b4 as te, a as C, b6 as M, n as X, b7 as T, aP as j, b8 as L, bi as We, bd as oe, bf as Me, bg as Te, Z as pe, bh as ve, aQ as be, aJ as Re, b as B, aN as Ee, aZ as wt } from "./entry-COvMLKyo.js";
import { F as xt } from "./floating-layer-anchor-BMcYq7gR.js";
import { D as Ct, a as St } from "./DialogWrapper-C8w-3LAY.js";
var Pt = L("<div><!></div>");
function kt(d, e) {
  const t = ke();
  Y(e, !0);
  ...
  }, P = O(), A = k(P);
  {
    var W = (v) => {
      ot(v, _e(() => C(f), () => c.popperProps, {
        ...
        popper: ($, J) => {
          let q = () => J?.().props, F = () => J?.().wrapperProps;
...
te(Jt, { open: {}, rawEvent: {}, onOpenChange: {} }, [], [], { mode: "open" });
var Ut = L("<!> <!>", 1);
function Wt(d, e) {
  Y(e, !0);
...
function ur() {
  ...
  function i() {
    Object.keys(C(d)).length > 0 && B(d, {}, !0);
  }
  function p(u) {
    B(e, u, !0), u || B(t, null);
  }
...
function tr(d, e) {
  return Ue.sanitizeExternalRelayUrls([
    ...d.acceptedRelays ?? [],
    ...d.fetchedRelays ?? [],
    ...d.relayHints ?? [],
...
class rr {
  ...
  createEventSender(e) {
    return this.deps.eventSenderFactory ? this.deps.eventSenderFactory(e, this.deps.console) : new Je(e, this.deps.console);
  }
  resolveSigner(e, t) {
    if (e.type === "nip07") {
...
class sr {
  ...
  async broadcast(e) {
    ...
    const o = Ue.sanitizeExternalRelayUrls(
      this.deps.writeRelaysStore.value
    );
    return o.length === 0 ? { success: !1, error: "no_write_relays" } : new Je(t, this.deps.console).sendEvent(l, {
      targetRelays: o,
