import { bU as Qe, bV as vt, bW as pt, bX as pe, bh as Re, H as ut, I as V, b1 as gt, ai as ht, bY as mt, aF as ee, K as ue, aH as yt, Q as bt, bZ as xt, b3 as _t, b6 as qt, V as wt, N as Dt, X as Ae, $ as $t, b_ as kt, W as Ee, b$ as St, ba as Ct, M as Pt, c0 as Lt, c1 as Tt } from "./App-BBD-wmht.js";
import { aO as Ht, b0 as Nt, aS as de, aJ as It, aN as At, b as d, b2 as te, bh as Me, Z as y, b3 as i, a as e, bf as x, aR as g, b4 as Et, b5 as F, bi as _, b8 as o, ba as v, ap as Mt, aq as jt, b6 as zt, b9 as r, bj as je } from "./entry-BhDgNuDQ.js";
import { D as Qt, a as Rt } from "./DialogWrapper-EHZBMRpS.js";
import { I as Vt } from "./InfoPopoverButton-uy2uFRRe.js";
function $e(t) {
  return t ? vt(t).trim() : "";
}
function ke(t) {
...
function ze(t) {
  return t.authorDisplayName?.trim() || Ft(t.authorPubkey) || ke(t.eventId);
}
function Wt(t) {
  const s = Qe(t);
...
function ga(t, s) {
  ...
  let c = V(s, "show", 15, !1), C = V(s, "onClose", 7), b = V(s, "onApplyDraft", 7), W = V(s, "onSaveDraft", 7), ge = V(s, "subscribeToDraftSaveCompleted", 7), he = V(s, "canSaveDraft", 7), p = V(s, "pubkeyHex", 7, null), B = de(It([])), I = de("idle"), L = de("loading"), q = de(void 0), me = de(!1), ae, ne = 0, A = 0, M = !1;
  function Fe() {
    return {
  ...
  let We = g(() => Ae.postStatus), Be = g(() => Ae.isUploading), Se = g(() => e(L) === "ready" && e(q) !== void 0 && e(q) === p()), Ce = g(() => !he() || e(We).sending || e(Be) || e(I) !== "idle" || !e(Se)), G = g(() => e(I) !== "idle" || !e(Se));
  function ye() {
    c(!1), C()?.();
  }
  gt(() => c(), ye, !0);
  ...
  async function ce(a, h = !1) {
    if (!c() || a !== p()) return;
    const P = ++ne;
    d(L, "loading"), h && (d(B, [], !0), d(q, void 0));
    try {
      const m = await xt({ pubkeyHex: a });
      !M && c() && a === p() && P === ne && (d(B, m, !0), d(q, a, !0), d(L, "ready"));
    } catch (m) {
      !M && c() && a === p() && P === ne && (d(B, [], !0), d(q, void 0), d(L, "failed")), console.error("下書き一覧の読み込みに失敗:", m);
    }
  }
  function Oe(a) {
  ...
  ht(() => ge()(Oe)), mt(() => {
    ...
    const a = p();
    if (!c()) {
      ne += 1, A += 1, d(B, [], !0), d(q, void 0), d(L, "loading"), d(I, "idle");
      return;
    }
    A += 1, d(I, "idle"), ce(a, !0);
  });
  ...
  }, Le = pa(), Te = te(Le);
  {
    const a = (m) => {
      var re = Jt(), O = te(re), se = o(O);
      {
        ...
        ee(se, {
          ...
          onClick: Xe,
          children: (z, U) => {
            var X = Xt(), Q = x(te(X), 2), oe = o(Q, !0);
            r(Q), y((fe) => _(oe, fe), [() => n()("draft.save") || "下書き保存"]), i(z, X);
          },
          $$slots: { default: !0 }
        });
      }
    ...
    Qt(Te, {
      ...
      footer: a,
      children: (m, re) => {
        var O = fa(), se = te(O), ie = o(se), j = o(ie), z = o(j, !0);
        r(j);
        var U = x(j, 2);
        {
        ...
        var Q = x(se, 2), oe = o(Q);
        {
          var fe = (u) => {
            ...
            var k = x(w, 2);
            {
              ...
              ee(k, {
                ...
                children: (Z, J) => {
                  je();
                  var K = Me();
                  y((_e) => _(K, _e), [() => n()("draft.retry_load") || "再試行"]), i(Z, K);
                },
                $$slots: { default: !0 }
              });
            }
            ...
            var f = ca();
            Ee(f, 21, () => e(B), (w) => w.id, (w, l) => {
              const k = g(() => Ut(e(l), Fe(), document));
              var N = da(), Z = o(N);
              {
              ...
              var J = x(Z, 2), K = o(J), _e = o(K);
              {
                var rt = (S) => {
                  ...
                  Ee(E, 21, () => e(k).contexts, Ct, (R, H) => {
                    ...
                    r(Y), y(() => {
                      Ie = Pt(Y, 1, "draft-context-row svelte-1gnpyqn", null, Ie, {
          ...
          ue(oe, (u) => {
            e(L) === "failed" ? u(fe) : e(L) === "loading" || e(q) !== p() ? u(ve, 1) : e(L) === "ready" && e(q) === p() && e(B).length === 0 ? u(xe, 2) : e(L) === "ready" && e(q) === p() && u(nt, 3);
          });
        }
        r(Q), y((u) => _(z, u), [() => n()("draft.title") || "下書き"]), i(m, O);
      },
