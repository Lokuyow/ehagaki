...
eHagaki のアプリケーション本体のソースコードは MIT License で公開しています。

ただし、このプロジェクトの配布物には第三者のソフトウェアおよび素材が含まれます。
それらには各権利者のライセンス、著作権表示、商標、利用条件が適用されます。
...
eHagaki のアプリアイコンおよび OGP 画像は、このプロジェクト用に作成したオリジナル素材です。
